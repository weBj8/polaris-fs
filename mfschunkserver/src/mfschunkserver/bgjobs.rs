...
unsafe extern "C" {
    ...
    unsafe fn queue_isempty(que: *mut ::core::ffi::c_void) -> ::core::ffi::c_int;
    unsafe fn queue_elements(que: *mut ::core::ffi::c_void) -> uint32_t;
    unsafe fn queue_sizeleft(que: *mut ::core::ffi::c_void) -> uint32_t;
    unsafe fn queue_put(
    ...
    unsafe fn mainserv_read(
        sock: ::core::ffi::c_int,
        packet: *const uint8_t,
        length: uint32_t,
    ) -> uint8_t;
    unsafe fn mainserv_write(
        sock: ::core::ffi::c_int,
        packet: *const uint8_t,
        length: uint32_t,
    ) -> uint8_t;
    unsafe fn hdd_get_chunk_info(
        chunkid: uint64_t,
        version: uint32_t,
    ...
    unsafe fn masterconn_reportload();
}
    ...
    unsafe {
        ...
        loop {
                    ...
                    if jstate as ::core::ffi::c_int == JSTATE_DISABLED as ::core::ffi::c_int {
                        ...
                        status = replicate(
                            ...
                            &raw mut (*((*jptr).args as *mut chunk_rp_args)).srcip as *mut uint32_t
                                as *const uint32_t,
                            &raw mut (*((*jptr).args as *mut chunk_rp_args)).srcport
                                as *mut uint16_t as *const uint16_t,
                            &raw mut (*((*jptr).args as *mut chunk_rp_args)).srcchunkid
                                as *mut uint64_t as *const uint64_t,
                        );
                    }
                }
                6 => {
            ...
            if !jptr.is_null() {
                ...
                (*jp).jobs_count[((*jptr).tasktype as ::core::ffi::c_int
                    & 0x7 as ::core::ffi::c_int) as usize] = (*jp).jobs_count
                    [((*jptr).tasktype as ::core::ffi::c_int & 0x7 as ::core::ffi::c_int) as usize]
                    .wrapping_add(1);
                (*jp).jobs_time[((*jptr).tasktype as ::core::ffi::c_int & 0x7 as ::core::ffi::c_int)
                    as usize] = (*jp).jobs_time
                    [((*jptr).tasktype as ::core::ffi::c_int & 0x7 as ::core::ffi::c_int) as usize]
                ...
                (*jptr).tasktype = ((*jptr).tasktype as ::core::ffi::c_int
...
pub unsafe extern "C" fn job_pool_delete(mut jp: *mut jobpool) {
    unsafe {
        ...
        let mut _mfs_assert_ret_3: ::core::ffi::c_int =
            pthread_mutex_destroy(&raw mut (*jp).pipelock);
        if _mfs_assert_ret_3 != 0 as ::core::ffi::c_int {
            if _mfs_assert_ret_3 < 0 as ::core::ffi::c_int
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"pthread_mutex_destroy(&(jp->pipelock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret_3,
                    *__errno_location(),
                    _mfs_errorstring_7,
        ...
        let mut _mfs_assert_ret_4: ::core::ffi::c_int =
            pthread_mutex_destroy(&raw mut (*jp).jobslock);
        if _mfs_assert_ret_4 != 0 as ::core::ffi::c_int {
            if _mfs_assert_ret_4 < 0 as ::core::ffi::c_int
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"pthread_mutex_destroy(&(jp->jobslock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret_4,
                    *__errno_location(),
                    _mfs_errorstring_9,
...
pub unsafe extern "C" fn job_serve(mut pdesc: *mut pollfd) {
    unsafe {
        ...
        if (*jp).fdpdescpos >= 0 as int32_t
            && (*pdesc.offset((*jp).fdpdescpos as isize)).revents as ::core::ffi::c_int & POLLIN
                != 0
        {
...
pub unsafe extern "C" fn job_heavyload_test() {
    unsafe {
        ...
        let mut _mfs_assert_ret: ::core::ffi::c_int =
            pthread_mutex_lock(&raw mut (*hp_pool).jobslock);
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
            if _mfs_assert_ret < 0 as ::core::ffi::c_int
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                        ...
                        match (*j).jstate as ::core::ffi::c_int {
                            2 => {
                                tasks_in_progress[((*j).tasktype as ::core::ffi::c_int
                                    & 0x7 as ::core::ffi::c_int)
                                    as usize] = tasks_in_progress[((*j).tasktype
                                    as ::core::ffi::c_int
                                    & 0x7 as ::core::ffi::c_int)
                                    as usize]
                                    .wrapping_add(1);
        ...
        while i < 2 as uint32_t {
            ...
            while h < JHASHSIZE as uint32_t {
                ...
                while !j.is_null() {
                    ...
                    {
                        if t > (*j).starttime
                            && t.wrapping_sub((*j).starttime) > 600000000 as uint64_t
                        {
                            if (*j).chunkid != 0 {
                                mfs_log(
                                    MFSLOG_SYSLOG,
