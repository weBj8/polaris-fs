...
extern "C" {
    ...
    fn hdd_rep_setversion(chunkid: uint64_t, version: uint32_t) -> ::core::ffi::c_int;
    fn hdd_chunkop(
        chunkid: uint64_t,
        version: uint32_t,
        newversion: uint32_t,
    ...
    fn mycrc32_combine(crc1: uint32_t, crc2: uint32_t, leng2: uint32_t) -> uint32_t;
    fn mfs_log(
        mode: ::core::ffi::c_int,
...
unsafe extern "C" fn xordata(mut dst: *mut uint8_t, mut src: *const uint8_t, mut leng: uint32_t) {
    ...
    if dst.expose_addr() as ::core::ffi::c_ulong & 3 as ::core::ffi::c_ulong
        == src.expose_addr() as ::core::ffi::c_ulong & 3 as ::core::ffi::c_ulong
    {
        while leng != 0
            && src.expose_addr() as ::core::ffi::c_ulong & 3 as ::core::ffi::c_ulong != 0
        {
            ...
            *c2rust_lvalue_ptr = (*c2rust_lvalue_ptr as ::core::ffi::c_int
                ^ *c2rust_fresh0 as ::core::ffi::c_int) as uint8_t;
...
unsafe extern "C" fn rep_read(mut rs: *mut repsrc) -> ::core::ffi::c_int {
    ...
    while (*rs).bytesleft > 0 as uint32_t {
        ...
        if (*rs).mode as ::core::ffi::c_uint == HEADER as ::core::ffi::c_int as ::core::ffi::c_uint
        {
...
pub unsafe extern "C" fn replicate(
        ...
        if pstatus as ::core::ffi::c_int != MFS_STATUS_OK {
            if pstatus as ::core::ffi::c_int == MFS_ERROR_NOTDONE {
                ...
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_WARNING,
                    b"replicator,get # of blocks: got status: %s from (%u.%u.%u.%u:%hu)\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    mfsstrerr(pstatus),
                    ip >> 24 as ::core::ffi::c_int & 0xff as uint32_t,
                    ip >> 16 as ::core::ffi::c_int & 0xff as uint32_t,
    ...
    while (b as ::core::ffi::c_int) < blocks as ::core::ffi::c_int {
            ...
            0 => {
                if r.needsreadrequest != 0 {
                    rep_create_read_request(
                        ...
                        ((blocks as ::core::ffi::c_int - b as ::core::ffi::c_int) * MFSBLOCKSIZE)
                            as uint32_t,
                    );
                }
            }
        ...
        if rep_send_all_packets(&raw mut r, SENDMSECTO as uint32_t) < 0 as ::core::ffi::c_int {
            ...
            if rmode as ::core::ffi::c_uint != SIMPLE as ::core::ffi::c_int as ::core::ffi::c_uint
                || b as ::core::ffi::c_int + 1 as ::core::ffi::c_int == blocks as ::core::ffi::c_int
            {
                i = 0 as uint8_t;
                while (i as ::core::ffi::c_int) < readsrccnt as ::core::ffi::c_int {
                    (*r.repsources.offset(i as isize)).mode = HEADER;
                    ...
                    while (bg as ::core::ffi::c_int) < blockgroup as ::core::ffi::c_int {
                        ...
                        status = hdd_write(
                            ...
                            (b as ::core::ffi::c_int * blockgroup as ::core::ffi::c_int
                                + bg as ::core::ffi::c_int) as uint16_t,
                            rptr.offset(20 as ::core::ffi::c_int as isize),
                            0 as uint32_t,
                            MFSBLOCKSIZE as uint32_t,
                            rptr.offset(16 as ::core::ffi::c_int as isize),
                ...
                2 => {
                    ...
                    while (bg as ::core::ffi::c_int) < blockgroup as ::core::ffi::c_int {
                            ...
                            && xcrc == zcrc
                        {
                            ...
                            rptr = r.xorbuff;
                            oraux = 0 as uint32_t;
                            if rptr.expose_addr() as ::core::ffi::c_ulong
                            ...
                            {
                                aptr =
                                    rptr.offset(4 as ::core::ffi::c_int as isize) as *mut uint32_t;
                                bind = 0 as uint32_t;
                                while bind < (MFSBLOCKSIZE / 4 as ::core::ffi::c_int) as uint32_t {
                                    oraux |= *aptr;
                                    aptr = aptr.offset(1);
