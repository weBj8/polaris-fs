...
extern "C" {
    ...
    fn hdd_precache_data(chunkid: uint64_t, offset: uint32_t, size: uint32_t);
    fn hdd_open(chunkid: uint64_t, version: uint32_t) -> ::core::ffi::c_int;
    fn hdd_close(chunkid: uint64_t, forcefsync: uint8_t) -> ::core::ffi::c_int;
    fn hdd_read(
        chunkid: uint64_t,
        version: uint32_t,
        blocknum: uint16_t,
...
pub unsafe extern "C" fn mainserv_stats(
    ...
    *bin = ::core::intrinsics::atomic_and_seqcst(&raw mut stats_bytesin, 0 as uint64_t);
    *bout = ::core::intrinsics::atomic_and_seqcst(&raw mut stats_bytesout, 0 as uint64_t);
    *hlopr = ::core::intrinsics::atomic_and_seqcst(&raw mut stats_hlopr, 0 as uint32_t);
    *hlopw = ::core::intrinsics::atomic_and_seqcst(&raw mut stats_hlopw, 0 as uint32_t);
}
#[inline]
unsafe extern "C" fn mainserv_bytesin(mut bytes: uint64_t) {
    ::core::intrinsics::atomic_xadd_seqcst(&raw mut stats_bytesin, bytes);
}
#[inline]
unsafe extern "C" fn mainserv_bytesout(mut bytes: uint64_t) {
    ::core::intrinsics::atomic_xadd_seqcst(&raw mut stats_bytesout, bytes);
}
#[inline]
...
pub unsafe extern "C" fn mainserv_create_packet(
    ...
    if ptr.is_null() {
        fprintf(
            ...
            b"/tmp/moosefs-ref/mfschunkserver/mainserv.c\0".as_ptr() as *const ::core::ffi::c_char,
    ...
    if r as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
        if d != 0 {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_NOTICE,
                b"send_and_free: 'send(%s)' disconnected\0".as_ptr() as *const ::core::ffi::c_char,
                packetname,
            );
        } else {
            mfs_log(
...
pub unsafe extern "C" fn mainserv_sock_nop_sender(
    ...
    loop {
        ...
        if sock_nops_head.is_null() {
                    ...
                    if (*sock_nops_head).bytesleft != 0 {
                        i = write(
                            ...
                            (&raw mut sock_nop_buff as *mut uint8_t)
                                .offset((8 as uint32_t).wrapping_sub((*sock_nops_head).bytesleft)
                                    as isize)
                        ...
                        i = write(
                            (*sock_nops_head).sock,
                            &raw mut sock_nop_buff as *mut uint8_t as *const ::core::ffi::c_void,
                            8 as size_t,
                        ) as int32_t;
                    }
                    if i < 0 as int32_t {
            ...
            {
                sleep_utime = (NOPS_INTERVAL as uint64_t)
                    .wrapping_sub(monotonic_utime.wrapping_sub((*sock_nops_head).monotonic_utime));
            } else {
...
unsafe extern "C" fn mainserv_sock_nop_add(mut sn: *mut sock_nops) {
    ...
    mainserv_sock_nop_append(sn);
    let mut _mfs_assert_ret_0: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut sock_nops_lock);
    if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_0 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"pthread_mutex_unlock(&sock_nops_lock)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_0,
                *__errno_location(),
                _mfs_errorstring_1,
            );
...
pub unsafe extern "C" fn mainserv_read(
    ...
    if offset >= MFSCHUNKSIZE as uint32_t || offset.wrapping_add(size) > MFSCHUNKSIZE as uint32_t {
        packet = mainserv_create_packet(
            &raw mut wptr,
            CSTOCL_READ_STATUS as uint32_t,
            (8 as ::core::ffi::c_int + 1 as ::core::ffi::c_int) as uint32_t,
    ...
    while size > 0 as uint32_t {
        ...
        if status as ::core::ffi::c_int != MFS_STATUS_OK {
            ...
            ::core::intrinsics::atomic_xadd_seqcst(&raw mut stats_hlopr, 1 as uint32_t);
            return ret;
        }
...
pub unsafe extern "C" fn mainserv_write_thread(
    ...
    let mut status: uint8_t = 0;
    loop {
        let mut _mfs_assert_ret: ::core::ffi::c_int = pthread_mutex_lock(&raw mut (*wrdata).lock);
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
            if _mfs_assert_ret < 0 as ::core::ffi::c_int
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
        ...
        let mut _mfs_assert_ret_3: ::core::ffi::c_int = pthread_mutex_lock(&raw mut (*wrdata).lock);
        ...
        (*wrjob).ack = ((*wrjob).ack as ::core::ffi::c_int | 1 as ::core::ffi::c_int) as uint8_t;
...
pub unsafe extern "C" fn mainserv_write_middle(
    ...
    if _mfs_assert_ret != 0 as ::core::ffi::c_int {
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"pthread_mutex_init(&(wrdata.lock),NULL)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret,
                *__errno_location(),
                _mfs_errorstring,
            );
    ...
    if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"pthread_cond_init(&(wrdata.cond),NULL)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_0,
                *__errno_location(),
                _mfs_errorstring_1,
            );
    ...
    loop {
        if poll(&raw mut pfd as *mut pollfd, 3 as nfds_t, SERV_TIMEOUT) < 0 as ::core::ffi::c_int {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_NOTICE,
                ...
                || pfd[2 as usize].revents as ::core::ffi::c_int & (POLLIN | POLLHUP) == POLLHUP
            {
                            ...
                            if leng > MaxPacketSize {
                                ...
                                ) != leng.wrapping_add(8 as uint32_t) as int32_t
                                {
                                    ...
                                    mfs_log(
                                        MFSLOG_SYSLOG,
                                        MFSLOG_NOTICE,
                                        b"write_middle: 'forward(write data)' timed out\0".as_ptr()
                                            as *const ::core::ffi::c_char,
                                    );
                                    break;
                                }
                        ...
                        if cmd == CLTOCS_WRITE_FINISH as uint32_t {
                                    ...
                                    as uint32_t
                            {
                                        ...
                                        .wrapping_add((*wrjob).size)
                                {
                                    ...
                                    (*wrjob).crcptr = rptr;
                                    (*wrjob).buff = rptr.offset(4 as ::core::ffi::c_int as isize);
                        ...
                        != 8 as int32_t
                    {
                        ...
                        if leng > 0 as uint32_t {
                            if leng > MaxPacketSize {
                                ...
                                if mainserv_toread(fwdsock, pdata, leng, SERV_TIMEOUT as uint32_t)
                                    != leng as int32_t
                                {
                                    mfs_log(
                                        MFSLOG_SYSLOG,
                                        ...
                                        if wrjob.is_null() {
                                            fprintf(
                                                ...
                                                b"/tmp/moosefs-ref/mfschunkserver/mainserv.c\0"
                                                    .as_ptr()
                                                    as *const ::core::ffi::c_char,
                                                838 as ::core::ffi::c_int as ::core::ffi::c_uint,
                                                b"wrjob\0".as_ptr() as *const ::core::ffi::c_char,
                                            );
                                            mfs_log(
                                                MFSLOG_SYSLOG,
                ...
                while status as ::core::ffi::c_int == MFS_STATUS_OK {
                    ...
                    if wrdata.head.is_null() {
                        ...
                        } else if (*wrjob).ack as ::core::ffi::c_int & 2 as ::core::ffi::c_int != 0
                ...
                if (*sn).error as ::core::ffi::c_int != 0 || (*fsn).error as ::core::ffi::c_int != 0
                {
                    status = MFS_ERROR_DISCONNECTED as uint8_t;
                }
                if status as ::core::ffi::c_int != MFS_STATUS_OK {
    ...
    if _mfs_assert_ret_13 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_13 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_35: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_36: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_13);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s\0".as_ptr()
    ...
    if wrdata.condwaiting != 0 {
        let mut _mfs_assert_ret_14: ::core::ffi::c_int = pthread_cond_signal(&raw mut wrdata.cond);
        if _mfs_assert_ret_14 != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"pthread_cond_signal(&(wrdata.cond))\0".as_ptr() as *const ::core::ffi::c_char,
                    _mfs_assert_ret_14,
                    *__errno_location(),
                    _mfs_errorstring_37,
                );
    ...
    if _mfs_assert_ret_15 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_15 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_39: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                ...
                b"pthread_mutex_unlock(&(wrdata.lock))\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_15,
                *__errno_location(),
                _mfs_errorstring_39,
            );
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_40: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_15);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s\0".as_ptr()
    ...
    if _mfs_assert_ret_16 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_16 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_41: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_42: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_16);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s\0".as_ptr()
    ...
    let mut _mfs_assert_ret_17: ::core::ffi::c_int = pthread_mutex_destroy(&raw mut wrdata.lock);
    if _mfs_assert_ret_17 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_17 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_43: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                ...
                b"pthread_mutex_destroy(&(wrdata.lock))\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_17,
                *__errno_location(),
                _mfs_errorstring_43,
            );
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_44: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_17);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s\0".as_ptr()
    ...
    if _mfs_assert_ret_18 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_18 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_45: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                ...
                b"pthread_cond_destroy(&(wrdata.cond))\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_18,
                *__errno_location(),
                _mfs_errorstring_45,
            );
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_46: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_18);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s\0".as_ptr()
...
pub unsafe extern "C" fn mainserv_write(
    ...
    if length & 1 as uint32_t != 0 {
        ...
        if protover as ::core::ffi::c_int != 1 as ::core::ffi::c_int {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOCS_WRITE - wrong protover (%hhu)\0".as_ptr() as *const ::core::ffi::c_char,
                ...
                != 0 as uint32_t
        {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOCS_WRITE - wrong size (%u/13+N*6)\0".as_ptr() as *const ::core::ffi::c_char,
                length,
            );
            return 0 as uint8_t;
        }
    ...
    ::core::intrinsics::atomic_xadd_seqcst(&raw mut stats_hlopw, 1 as uint32_t);
    return ret;
}
#[no_mangle]
