extern "C" {
    ...
    fn job_stats(maxjobscnt: *mut uint32_t);
    fn csserv_stats(bin: *mut uint64_t, bout: *mut uint64_t);
    fn mainserv_stats(
        bin: *mut uint64_t,
        bout: *mut uint64_t,
        hlopr: *mut uint32_t,
    ...
    fn masterconn_stats(bin: *mut uint64_t, bout: *mut uint64_t);
    fn hdd_stats(
        br: *mut uint64_t,
        bw: *mut uint64_t,
        opr: *mut uint32_t,
    ...
    fn replicator_stats(bin: *mut uint64_t, bout: *mut uint64_t, repl: *mut uint32_t);
    fn cpu_init();
    fn cpu_used(scpu: *mut uint64_t, ucpu: *mut uint64_t);
    fn mem_used(rss: *mut uint64_t, virt: *mut uint64_t) -> uint8_t;
}
pub type uint8_t = u8;
...
unsafe extern "C" fn c2rust_run_static_initializers() {
    statdefs = [
        ...
        _statdef {
            name: b"masterin\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        ...
        _statdef {
            name: b"masterout\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('M' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('S' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"csrepin\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        ...
        _statdef {
            name: b"csrepout\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('R' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('E' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"csservin\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('S' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"csservout\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('S' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('R' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"hdrbytesr\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        ...
        _statdef {
            name: b"hdrbytesw\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('H' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('R' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"hdrllopr\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('H' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('R' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"hdrllopw\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('H' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('R' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"datallopr\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('D' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('T' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"datallopw\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('D' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('T' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"version\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        ...
        _statdef {
            name: b"duplicate\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('D' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('U' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"duptrunc\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('D' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('T' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"movels\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('M' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('O' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"movehs\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('M' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('O' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"ec4chunks\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        ...
        _statdef {
            name: b"ec8chunks\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('E' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('C' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"hddmfr\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('H' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('D' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _statdef {
            name: b"hdddmg\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('H' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('D' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
    ...
    estatdefs = [
        ...
        _estatdef {
            name: b"hddread\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('H' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('D' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _estatdef {
            name: b"hddwrite\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('H' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('D' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _estatdef {
            name: b"hddopsr\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('H' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('D' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _estatdef {
            name: b"hddopsw\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('H' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('D' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
        ...
        _estatdef {
            name: b"hddcnt\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            statid: ('H' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
                .wrapping_add('D' as ::core::ffi::c_int as uint8_t as uint32_t)
                .wrapping_mul(256 as uint32_t)
