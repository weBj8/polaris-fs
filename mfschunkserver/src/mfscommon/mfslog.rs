...
pub unsafe extern "C" fn mfs_log_str_to_pri(
    ...
    while *pristr.offset(i as isize) as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
        ...
        {
            c = (c as ::core::ffi::c_int + ('a' as ::core::ffi::c_int - 'A' as ::core::ffi::c_int))
                as ::core::ffi::c_char;
        }
        if c as ::core::ffi::c_int >= 'a' as ::core::ffi::c_int
            && c as ::core::ffi::c_int <= 'z' as ::core::ffi::c_int
...
pub unsafe extern "C" fn mfs_file_log(
    ...
    vfprintf(lfd, fmt, ap.as_va_list());
...
pub unsafe extern "C" fn mfs_log(
    ...
    let mut n: ::core::ffi::c_int = 0;
    let mut ap: ::core::ffi::VaListImpl;
    let mut _mfs_errstring: *const ::core::ffi::c_char = ::core::ptr::null::<::core::ffi::c_char>();
    ...
    if mfs_log_sink.is_some() {
        mfs_log_sink.expect("non-null function pointer")(&raw mut msg as *mut ::core::ffi::c_char);
    }
    if syslog_open != 0 {
        syslog(
