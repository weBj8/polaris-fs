...
unsafe extern "C" {
    ...
    unsafe fn ionice_test();
    unsafe fn ionice_high();
    ...
    unsafe fn job_init() -> ::core::ffi::c_int;
    unsafe fn rnd_init() -> ::core::ffi::c_int;
    unsafe fn hdd_restore() -> ::core::ffi::c_int;
    unsafe fn hdd_late_init() -> ::core::ffi::c_int;
    unsafe fn hdd_init() -> ::core::ffi::c_int;
    unsafe fn masterconn_init() -> ::core::ffi::c_int;
    unsafe fn csserv_init() -> ::core::ffi::c_int;
    unsafe fn mainserv_init() -> ::core::ffi::c_int;
    unsafe fn chartsdata_init() -> ::core::ffi::c_int;
