    ...
    unsafe {
        ...
        if detached as ::core::ffi::c_int != thattr_detached as ::core::ffi::c_int {
            if detached != 0 {
                ...
                if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"pthread_attr_setdetachstate(thattr,PTHREAD_CREATE_DETACHED)\0"
                                .as_ptr() as *const ::core::ffi::c_char,
                            _mfs_assert_ret_1,
                            *__errno_location(),
                            _mfs_errorstring_4,
                ...
                let mut _mfs_assert_ret_2: ::core::ffi::c_int = pthread_attr_setdetachstate(
                    thattr,
                    PTHREAD_CREATE_JOINABLE as ::core::ffi::c_int,
                );
                if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"pthread_attr_setdetachstate(thattr,PTHREAD_CREATE_JOINABLE)\0"
                                .as_ptr() as *const ::core::ffi::c_char,
                            _mfs_assert_ret_2,
                            *__errno_location(),
                            _mfs_errorstring_6,
