...
pub unsafe extern "C" fn inoleng_release(mut ptr: *mut ::core::ffi::c_void) {
    unsafe {
        ...
        ) == 1 as uint32_t
        {
            ...
            let mut _mfs_assert_ret_2: ::core::ffi::c_int = pthread_mutex_unlock(
                (&raw mut hashlock as *mut pthread_mutex_t).offset(h as isize),
            );
            if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
                if _mfs_assert_ret_2 < 0 as ::core::ffi::c_int
...
pub unsafe extern "C" fn inoleng_getfleng(mut ptr: *mut ::core::ffi::c_void) -> uint64_t {
    unsafe {
        let mut il: *mut ileng = ptr as *mut ileng;
        return ::core::intrinsics::atomic_load::<_, { ::core::intrinsics::AtomicOrdering::Relaxed }>(
            &raw mut (*il).fleng,
        );
    }
}
...
pub unsafe extern "C" fn inoleng_setfleng(mut ptr: *mut ::core::ffi::c_void, mut fleng: uint64_t) {
    unsafe {
        let mut il: *mut ileng = ptr as *mut ileng;
        ::core::intrinsics::atomic_store::<_, { ::core::intrinsics::AtomicOrdering::Relaxed }>(
            &raw mut (*il).fleng,
            fleng,
        );
    }
    ...
    unsafe {
        ...
        while h < INOLENG_HASHSIZE as uint32_t {
            ...
            while !ilptr.is_null() {
                ...
                refcnt = ::core::intrinsics::atomic_load::<
                    _,
                    { ::core::intrinsics::AtomicOrdering::SeqCst },
                >(&raw mut (*ilptr).refcnt);
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_WARNING,
            ...
            let mut _mfs_assert_ret_1: ::core::ffi::c_int = pthread_mutex_destroy(
                (&raw mut hashlock as *mut pthread_mutex_t).offset(h as isize),
            );
            if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
                if _mfs_assert_ret_1 < 0 as ::core::ffi::c_int
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"pthread_mutex_destroy(hashlock+h)\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_1,
                        *__errno_location(),
                        _mfs_errorstring_3,
            ...
            if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"pthread_mutex_init(hashlock+h,NULL)\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret,
                        *__errno_location(),
                        _mfs_errorstring,
