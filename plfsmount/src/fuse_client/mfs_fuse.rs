...
pub const IO_RA: C2Rust_Unnamed_2 = 2;
pub const IO_RO: C2Rust_Unnamed_2 = 1;
pub const IO_RW: C2Rust_Unnamed_2 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _lock_owner {
    pub lock_owner: uint64_t,
    pub next: *mut _lock_owner,
}
pub type finfo_lock_owner = _lock_owner;
#[repr(C)]
pub struct _finfo {
    pub flengptr: Option<plfsclient::inoleng::Handle>,
    pub inode: uint32_t,
    pub mode: uint8_t,
    pub uselocks: uint8_t,
    pub valid: uint8_t,
    pub open_waiting: uint8_t,
    pub open_in_master: uint8_t,
    pub open_status: ::core::ffi::c_int,
    pub rdata: *mut ::core::ffi::c_void,
    pub wdata: *mut ::core::ffi::c_void,
    pub create: ::core::ffi::c_double,
    pub posix_lo_head: *mut finfo_lock_owner,
    pub flock_lo_head: *mut finfo_lock_owner,
    pub lock: pthread_mutex_t,
    pub opencond: pthread_cond_t,
    pub findex: uint32_t,
    pub next: uint32_t,
    pub prev: *mut uint32_t,
}
pub type finfo = _finfo;
...
static mut finfo_head: uint32_t = 0 as uint32_t;
static mut finfo_size: uint32_t = 0 as uint32_t;
static mut finfo_max: uint32_t = 1 as uint32_t;
static mut finfo_tab: *mut *mut finfo = ::core::ptr::null_mut::<*mut finfo>();
static mut finfo_tab_lock: pthread_mutex_t = pthread_mutex_t {
...
static mut finfo_inode_hash: [uint32_t; 1024] = [
    0 as uint32_t,
    0,
    0,
    0,
...
unsafe extern "C" fn finfo_free_resources(mut fileinfo: *mut finfo) {
    unsafe {
...
unsafe extern "C" fn finfo_new(mut inode: uint32_t) -> uint32_t {
    unsafe {
        let mut i: uint32_t = 0;
        let mut ni: uint32_t = 0;
        let mut findex: uint32_t = 0;
        let mut fileinfo: *mut finfo = ::core::ptr::null_mut::<finfo>();
        let mut _mfs_assert_ret: ::core::ffi::c_int = pthread_mutex_lock(&raw mut finfo_tab_lock);
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"pthread_mutex_lock(&finfo_tab_lock)\0".as_ptr() as *const ::core::ffi::c_char,
                    _mfs_assert_ret,
                    *__errno_location(),
                    _mfs_errorstring,
                );
        ...
        if finfo_head != 0 as uint32_t {
            i = finfo_head;
            fileinfo = *finfo_tab.offset(i as isize);
            finfo_head = (*fileinfo).next;
        } else {
            if finfo_max >= finfo_size {
                if finfo_size == 0 as uint32_t {
                    finfo_size = 1024 as uint32_t;
                    finfo_tab = malloc(
                        ::core::mem::size_of::<*mut finfo>().wrapping_mul(finfo_size as size_t),
                    ) as *mut *mut finfo;
                } else {
                    finfo_size = finfo_size.wrapping_mul(2 as uint32_t);
                    if finfo_size <= 0x1000000 as uint32_t {
                    } else {
                        fprintf(
                            stderr,
                            ...
                            b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            515 as ::core::ffi::c_int as ::core::ffi::c_uint,
                            b"finfo_size<=0x1000000\0".as_ptr() as *const ::core::ffi::c_char,
                            b"file handle tabble too big\0".as_ptr() as *const ::core::ffi::c_char,
                        );
                        mfs_log(
                            MFSLOG_SYSLOG,
                            MFSLOG_ERR,
                    ...
                    finfo_tab = mfsrealloc(
                        finfo_tab as *mut ::core::ffi::c_void,
                        ::core::mem::size_of::<*mut finfo>().wrapping_mul(finfo_size as size_t),
                    ) as *mut *mut finfo;
                }
                if finfo_tab.is_null() {
                    fprintf(
                        stderr,
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        518 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"finfo_tab\0".as_ptr() as *const ::core::ffi::c_char,
                    );
                    mfs_log(
                        MFSLOG_SYSLOG,
                        MFSLOG_ERR,
            ...
            let c2rust_fresh2 = finfo_max;
            finfo_max = finfo_max.wrapping_add(1);
            i = c2rust_fresh2;
            *finfo_tab.offset(i as isize) = malloc(::core::mem::size_of::<finfo>()) as *mut finfo;
            fileinfo = *finfo_tab.offset(i as isize);
            if fileinfo.is_null() {
                fprintf(
                    stderr,
                    ...
                    b"fileinfo\0".as_ptr() as *const ::core::ffi::c_char,
                );
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_ERR,
            ...
            if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        525 as ::core::ffi::c_int as ::core::ffi::c_uint,
            ...
            if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        526 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_cond_init(&(fileinfo->opencond),NULL)\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_1,
                        *__errno_location(),
                        _mfs_errorstring_5,
        ...
        if findex & 0xffffff as uint32_t == i {
        } else {
            fprintf(
                stderr,
                b"%s:%u - failed assertion '%s' : %s\n\0".as_ptr() as *const ::core::ffi::c_char,
                b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr() as *const ::core::ffi::c_char,
                533 as ::core::ffi::c_int as ::core::ffi::c_uint,
                b"(findex&0xFFFFFF)==i\0".as_ptr() as *const ::core::ffi::c_char,
                b"file info record index mismatch\0".as_ptr() as *const ::core::ffi::c_char,
            );
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
        ...
        findex = findex.wrapping_add(0x1000000 as uint32_t);
        if findex & 0xff000000 as uint32_t == 0 as uint32_t {
            findex = findex.wrapping_add(0x1000000 as uint32_t);
        }
        (*fileinfo).findex = findex;
        (*fileinfo).inode = inode;
        (*fileinfo).next = finfo_inode_hash[(inode & 1023 as uint32_t) as usize];
        ni = (*fileinfo).next;
        finfo_inode_hash[(inode & 1023 as uint32_t) as usize] = i;
        if ni != 0 as uint32_t {
            (**finfo_tab.offset(ni as isize)).prev = &raw mut (*fileinfo).next;
        }
        (*fileinfo).prev = (&raw mut finfo_inode_hash as *mut uint32_t)
            .offset((inode & 1023 as uint32_t) as isize);
        let mut _mfs_assert_ret_2: ::core::ffi::c_int =
            pthread_mutex_unlock(&raw mut finfo_tab_lock);
        if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    546 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_unlock(&finfo_tab_lock)\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret_2,
                    *__errno_location(),
                    _mfs_errorstring_7,
                ...
                && *__errno_location() == 0 as ::core::ffi::c_int
            {
                let mut _mfs_errorstring_8: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_2);
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_ERR,
                    b"%s:%u - unexpected status, '%s' returned: %d : %s\0".as_ptr()
...
#[inline]
unsafe extern "C" fn finfo_get(mut findex: uint32_t) -> *mut finfo {
    unsafe {
        let mut tindex: uint32_t = 0;
        let mut fileinfo: *mut finfo = ::core::ptr::null_mut::<finfo>();
        if findex > 0 as uint32_t {
            tindex = findex & 0xffffff as uint32_t;
            let mut _mfs_assert_ret: ::core::ffi::c_int =
                pthread_mutex_lock(&raw mut finfo_tab_lock);
            if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                if _mfs_assert_ret < 0 as ::core::ffi::c_int
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        555 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_lock(&finfo_tab_lock)\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret,
                        *__errno_location(),
                        _mfs_errorstring,
            ...
            if tindex >= finfo_max {
                fileinfo = ::core::ptr::null_mut::<finfo>();
            } else {
                fileinfo = *finfo_tab.offset(tindex as isize);
...
unsafe extern "C" fn finfo_release(mut findex: uint32_t) {
    unsafe {
        let mut tindex: uint32_t = 0;
        let mut ni: uint32_t = 0;
        let mut fileinfo: *mut finfo = ::core::ptr::null_mut::<finfo>();
        if findex > 0 as uint32_t {
            ...
            if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        577 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_lock(&finfo_tab_lock)\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret,
                        *__errno_location(),
            ...
            if tindex < finfo_max {
                ...
                *(*fileinfo).prev = ni;
                if ni != 0 as uint32_t {
                    (**finfo_tab.offset(ni as isize)).prev = (*fileinfo).prev;
                }
                (*fileinfo).next = finfo_head;
                (*fileinfo).prev = ::core::ptr::null_mut::<uint32_t>();
                finfo_head = tindex;
            }
            let mut _mfs_assert_ret_0: ::core::ffi::c_int =
                pthread_mutex_unlock(&raw mut finfo_tab_lock);
...
unsafe extern "C" fn finfo_freeall() {
    unsafe {
        let mut i: uint32_t = 0;
        let mut fileinfo: *mut finfo = ::core::ptr::null_mut::<finfo>();
        let mut _mfs_assert_ret: ::core::ffi::c_int = pthread_mutex_lock(&raw mut finfo_tab_lock);
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    602 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_lock(&finfo_tab_lock)\0".as_ptr() as *const ::core::ffi::c_char,
                    _mfs_assert_ret,
                    *__errno_location(),
                    _mfs_errorstring,
        ...
        if !finfo_tab.is_null() {
            ...
            while i < finfo_max {
                ...
                if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            609 as ::core::ffi::c_int as ::core::ffi::c_uint,
                ...
                let mut _mfs_assert_ret_3: ::core::ffi::c_int =
                    pthread_cond_destroy(&raw mut (*fileinfo).opencond);
                if _mfs_assert_ret_3 != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"pthread_cond_destroy(&(fileinfo->opencond))\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            _mfs_assert_ret_3,
                            *__errno_location(),
                            _mfs_errorstring_7,
                ...
                free(fileinfo as *mut ::core::ffi::c_void);
                i = i.wrapping_add(1);
            }
            free(finfo_tab as *mut ::core::ffi::c_void);
        }
        finfo_max = 1 as uint32_t;
        finfo_size = 0 as uint32_t;
        finfo_head = 0 as uint32_t;
        finfo_tab = ::core::ptr::null_mut::<*mut finfo>();
        ...
        if _mfs_assert_ret_4 != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    622 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_unlock(&finfo_tab_lock)\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret_4,
                    *__errno_location(),
...
pub unsafe extern "C" fn mfs_setattr(
    ...
    unsafe {
        ...
        if to_set & FUSE_SET_ATTR_SIZE != 0 {
            ...
            if !fi.is_null() {
                let mut fileinfo: *mut finfo = ::core::ptr::null_mut::<finfo>();
                fileinfo = finfo_get((*fi).fh as uint32_t);
                if (*fi).fh == 0 as uint64_t || fileinfo.is_null() {
                    oplog_printf(
                        &raw mut ctx,
                        b"setattr (%lu,0x%X,[%s]) [handle:%08X]: %s\0".as_ptr()
                            as *const ::core::ffi::c_char,
                ...
                if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            2185 as ::core::ffi::c_int as ::core::ffi::c_uint,
                            b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            _mfs_assert_ret,
                            *__errno_location(),
                ...
                if (*fileinfo).inode as fuse_ino_t != ino {
                    let mut _mfs_assert_ret_0: ::core::ffi::c_int =
                        pthread_mutex_unlock(&raw mut (*fileinfo).lock);
                    if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                        if _mfs_assert_ret_0 < 0 as ::core::ffi::c_int
                            && *__errno_location() != 0 as ::core::ffi::c_int
                        {
                            ...
                            mfs_log(
                                ...
                                b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                    as *const ::core::ffi::c_char,
                                2187 as ::core::ffi::c_int as ::core::ffi::c_uint,
                                b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                                    as *const ::core::ffi::c_char,
                                _mfs_assert_ret_0,
                                *__errno_location(),
                ...
                if (*fileinfo).mode as ::core::ffi::c_int == IO_RO as ::core::ffi::c_int {
                    let mut _mfs_assert_ret_1: ::core::ffi::c_int =
                        pthread_mutex_unlock(&raw mut (*fileinfo).lock);
                    if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
                        if _mfs_assert_ret_1 < 0 as ::core::ffi::c_int
                            && *__errno_location() != 0 as ::core::ffi::c_int
                        {
                            ...
                            mfs_log(
                                ...
                                b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                    as *const ::core::ffi::c_char,
                                2193 as ::core::ffi::c_int as ::core::ffi::c_uint,
                                b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                                    as *const ::core::ffi::c_char,
                                _mfs_assert_ret_1,
                                *__errno_location(),
                ...
                if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            2198 as ::core::ffi::c_int as ::core::ffi::c_uint,
                            b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            _mfs_assert_ret_2,
                            *__errno_location(),
...
unsafe extern "C" fn mfs_newfileinfo(
    mut accmode: uint8_t,
    mut inode: uint32_t,
    mut fleng: uint64_t,
    mut open_in_master: uint8_t,
    mut appendonly: uint8_t,
) -> uint32_t {
    unsafe {
        let mut fileinfo: *mut finfo = ::core::ptr::null_mut::<finfo>();
        let mut findex: uint32_t = 0;
        ...
        if fileinfo.is_null() {
            fprintf(
                ...
                b"%s:%u - out of memory: %s is NULL\n\0".as_ptr() as *const ::core::ffi::c_char,
                b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr() as *const ::core::ffi::c_char,
                3438 as ::core::ffi::c_int as ::core::ffi::c_uint,
                b"fileinfo\0".as_ptr() as *const ::core::ffi::c_char,
            );
            mfs_log(
                MFSLOG_SYSLOG,
        ...
        plfsclient::inoleng::set_length((*fileinfo).flengptr.as_ref().unwrap(), fleng);
        (*fileinfo).inode = inode;
        let c2rust_lhs = &raw mut (*fileinfo).uselocks;
        let c2rust_rhs = 0 as uint8_t;
        ::core::intrinsics::atomic_and::<_, _, { ::core::intrinsics::AtomicOrdering::SeqCst }>(
            c2rust_lhs, c2rust_rhs,
        ) & c2rust_rhs;
        (*fileinfo).posix_lo_head = ::core::ptr::null_mut::<finfo_lock_owner>();
        (*fileinfo).flock_lo_head = ::core::ptr::null_mut::<finfo_lock_owner>();
        if accmode as ::core::ffi::c_int == O_RDONLY {
            (*fileinfo).mode = IO_RO as ::core::ffi::c_int as uint8_t;
        } else if appendonly != 0 {
            (*fileinfo).mode = IO_RA as ::core::ffi::c_int as uint8_t;
        } else {
            (*fileinfo).mode = IO_RW as ::core::ffi::c_int as uint8_t;
        }
        (*fileinfo).rdata = NULL;
        (*fileinfo).wdata = NULL;
        (*fileinfo).create = now;
        (*fileinfo).open_waiting = 0 as uint8_t;
        (*fileinfo).open_in_master = open_in_master;
        (*fileinfo).open_status = 0 as ::core::ffi::c_int;
        pthread_mutex_unlock(&raw mut (*fileinfo).lock);
        return findex;
    }
}
unsafe extern "C" fn mfs_removefileinfo(mut findex: uint32_t) {
    unsafe {
        let mut fileinfo: *mut finfo = finfo_get(findex);
        if !fileinfo.is_null() {
            let mut _mfs_assert_ret: ::core::ffi::c_int =
                pthread_mutex_lock(&raw mut (*fileinfo).lock);
            if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        3477 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret,
                        *__errno_location(),
            ...
            if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        3483 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_0,
                        *__errno_location(),
    ...
    unsafe {
        ...
        if fuse_reply_open(req, fi) == -ENOENT {
            ...
            if !fileinfo.is_null() {
                ...
                if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            4017 as ::core::ffi::c_int as ::core::ffi::c_uint,
                            b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            _mfs_assert_ret,
                            *__errno_location(),
                ...
                (*fileinfo).open_in_master = 1 as uint8_t;
                if (*fileinfo).open_waiting != 0 {
                    let mut _mfs_assert_ret_0: ::core::ffi::c_int =
                        pthread_cond_broadcast(&raw mut (*fileinfo).opencond);
                    if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                        if _mfs_assert_ret_0 < 0 as ::core::ffi::c_int
                            && *__errno_location() != 0 as ::core::ffi::c_int
                        {
                            ...
                            mfs_log(
                                ...
                                b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                    as *const ::core::ffi::c_char,
                                4021 as ::core::ffi::c_int as ::core::ffi::c_uint,
                                b"pthread_cond_broadcast(&(fileinfo->opencond))\0".as_ptr()
                                    as *const ::core::ffi::c_char,
                                _mfs_assert_ret_0,
                                *__errno_location(),
                                _mfs_errorstring_2,
                ...
                if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            4023 as ::core::ffi::c_int as ::core::ffi::c_uint,
                            b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            _mfs_assert_ret_1,
                            *__errno_location(),
...
pub unsafe extern "C" fn mfs_release(
    ...
    unsafe {
        ...
        if !fileinfo.is_null() {
            ...
            let mut lock_owner_tab: *mut uint64_t = ::core::ptr::null_mut::<uint64_t>();
            let mut lock_owner_posix_cnt: uint32_t = 0;
            let mut lock_owner_flock_cnt: uint32_t = 0;
            let mut indx: uint32_t = 0;
            plfsclient::inoleng::io_wait((*fileinfo).flengptr.as_ref().unwrap());
            let mut _mfs_assert_ret: ::core::ffi::c_int =
                pthread_mutex_lock(&raw mut (*fileinfo).lock);
            if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                if _mfs_assert_ret < 0 as ::core::ffi::c_int
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4103 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret,
                        *__errno_location(),
            ...
            let c2rust_lhs = &raw mut (*fileinfo).uselocks;
            let c2rust_rhs = 0 as uint8_t;
            uselocks = ::core::intrinsics::atomic_or::<
                _,
                _,
                { ::core::intrinsics::AtomicOrdering::SeqCst },
            >(c2rust_lhs, c2rust_rhs)
                | c2rust_rhs;
            lock_owner_tab = ::core::ptr::null_mut::<uint64_t>();
            lock_owner_posix_cnt = 0 as uint32_t;
            lock_owner_flock_cnt = 0 as uint32_t;
            if !(*fileinfo).posix_lo_head.is_null() || !(*fileinfo).flock_lo_head.is_null() {
                let mut flo: *mut finfo_lock_owner = ::core::ptr::null_mut::<finfo_lock_owner>();
                let mut flop: *mut *mut finfo_lock_owner =
                    ::core::ptr::null_mut::<*mut finfo_lock_owner>();
                flo = (*fileinfo).posix_lo_head;
                while !flo.is_null() {
                    lock_owner_posix_cnt = lock_owner_posix_cnt.wrapping_add(1);
                    flo = (*flo).next as *mut finfo_lock_owner;
                }
                flo = (*fileinfo).flock_lo_head;
                while !flo.is_null() {
                    if (*flo).lock_owner != (*fi).lock_owner {
                        lock_owner_flock_cnt = lock_owner_flock_cnt.wrapping_add(1);
                    }
                    flo = (*flo).next as *mut finfo_lock_owner;
                }
                if lock_owner_posix_cnt.wrapping_add(lock_owner_flock_cnt) > 0 as uint32_t {
                    lock_owner_tab = malloc(::core::mem::size_of::<uint64_t>().wrapping_mul(
                        lock_owner_posix_cnt.wrapping_add(lock_owner_flock_cnt) as size_t,
                    )) as *mut uint64_t;
                    if lock_owner_tab.is_null() {
                        fprintf(
                            stderr,
                            b"%s:%u - out of memory: %s is NULL\n\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            4131 as ::core::ffi::c_int as ::core::ffi::c_uint,
                            b"lock_owner_tab\0".as_ptr() as *const ::core::ffi::c_char,
                        );
                        mfs_log(
                            MFSLOG_SYSLOG,
                            MFSLOG_ERR,
                ...
                indx = 0 as uint32_t;
                flop = &raw mut (*fileinfo).posix_lo_head;
                loop {
                    flo = *flop;
                    if flo.is_null() {
                        break;
                    ...
                    if indx < lock_owner_posix_cnt {
                        *lock_owner_tab.offset(indx as isize) = (*flo).lock_owner;
                    }
                    indx = indx.wrapping_add(1);
                    *flop = (*flo).next as *mut finfo_lock_owner;
                    free(flo as *mut ::core::ffi::c_void);
                }
                if indx == lock_owner_posix_cnt {
                } else {
                    fprintf(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4144 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"indx==lock_owner_posix_cnt\0".as_ptr() as *const ::core::ffi::c_char,
                        b"loop mismatch\0".as_ptr() as *const ::core::ffi::c_char,
                    );
                    mfs_log(
                        MFSLOG_SYSLOG,
                        MFSLOG_ERR,
                ...
                if (*fileinfo).posix_lo_head.is_null() {
                } else {
                    fprintf(
                        stderr,
                        b"%s:%u - failed assertion '%s' : %s\n\0".as_ptr()
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4145 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"fileinfo->posix_lo_head==NULL\0".as_ptr() as *const ::core::ffi::c_char,
                        b"list not freed\0".as_ptr() as *const ::core::ffi::c_char,
                    );
                    mfs_log(
                        MFSLOG_SYSLOG,
                        MFSLOG_ERR,
                ...
                indx = 0 as uint32_t;
                flop = &raw mut (*fileinfo).flock_lo_head;
                loop {
                    flo = *flop;
                    if flo.is_null() {
                        break;
                    ...
                    if (*flo).lock_owner != (*fi).lock_owner {
                        if indx < lock_owner_flock_cnt {
                            *lock_owner_tab
                                .offset(lock_owner_posix_cnt.wrapping_add(indx) as isize) =
                                (*flo).lock_owner;
                        }
                        indx = indx.wrapping_add(1);
                    }
                ...
                if indx == lock_owner_flock_cnt {
                    ...
                    fprintf(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4159 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"indx==lock_owner_flock_cnt\0".as_ptr() as *const ::core::ffi::c_char,
                        b"loop mismatch\0".as_ptr() as *const ::core::ffi::c_char,
                    );
                    mfs_log(
                        MFSLOG_SYSLOG,
                ...
                if (*fileinfo).flock_lo_head.is_null() {
                } else {
                    fprintf(
                        stderr,
                        b"%s:%u - failed assertion '%s' : %s\n\0".as_ptr()
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4160 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"fileinfo->flock_lo_head==NULL\0".as_ptr() as *const ::core::ffi::c_char,
                        b"list not freed\0".as_ptr() as *const ::core::ffi::c_char,
                    );
                    mfs_log(
                        MFSLOG_SYSLOG,
            ...
            if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4163 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_0,
                        *__errno_location(),
            ...
            indx = 0 as uint32_t;
            while indx < lock_owner_posix_cnt {
                let mut status: ::core::ffi::c_int = 0;
                status = fs_posixlock(
                    ino as uint32_t,
                    0 as uint32_t,
                    *lock_owner_tab.offset(indx as isize),
            ...
            if uselocks as ::core::ffi::c_int & 1 as ::core::ffi::c_int != 0 {
            ...
            indx = 0 as uint32_t;
            while indx < lock_owner_flock_cnt {
                let mut status_1: ::core::ffi::c_int = 0;
                status_1 = fs_flock(
                    ino as uint32_t,
                    0 as uint32_t,
                    *lock_owner_tab.offset(lock_owner_posix_cnt.wrapping_add(indx) as isize),
                    FLOCK_RELEASE as uint8_t,
                ) as ::core::ffi::c_int;
            ...
            if !lock_owner_tab.is_null() {
                free(lock_owner_tab as *mut ::core::ffi::c_void);
            }
        }
        dcache::invalidate_attr(ino as uint32_t);
        if !fileinfo.is_null() {
            oplog_printf(
                ...
                ino as ::core::ffi::c_ulong,
                (*fi).fh as uint32_t,
                (*fileinfo).uselocks as ::core::ffi::c_int,
                (*fi).lock_owner,
            );
        } else {
            oplog_printf(
        ...
        if (*fi).fh > 0 as uint64_t {
            if !fileinfo.is_null() {
                ...
                if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            4212 as ::core::ffi::c_int as ::core::ffi::c_uint,
                            b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            _mfs_assert_ret_1,
                            *__errno_location(),
                ...
                while (*fileinfo).open_in_master as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                    (*fileinfo).open_waiting = (*fileinfo).open_waiting.wrapping_add(1);
                    let mut _mfs_assert_ret_2: ::core::ffi::c_int =
                        pthread_cond_wait(&raw mut (*fileinfo).opencond, &raw mut (*fileinfo).lock);
                    if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
                        if _mfs_assert_ret_2 < 0 as ::core::ffi::c_int
                            && *__errno_location() != 0 as ::core::ffi::c_int
                        {
                            ...
                            mfs_log(
                                ...
                                b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                    as *const ::core::ffi::c_char,
                                4215 as ::core::ffi::c_int as ::core::ffi::c_uint,
                                b"pthread_cond_wait(&(fileinfo->opencond),&(fileinfo->lock))\0"
                                    .as_ptr()
                                    as *const ::core::ffi::c_char,
                                _mfs_assert_ret_2,
                                *__errno_location(),
                    ...
                    (*fileinfo).open_waiting = (*fileinfo).open_waiting.wrapping_sub(1);
                }
                let mut _mfs_assert_ret_3: ::core::ffi::c_int =
                    pthread_mutex_unlock(&raw mut (*fileinfo).lock);
                if _mfs_assert_ret_3 != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            4218 as ::core::ffi::c_int as ::core::ffi::c_uint,
                            b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            _mfs_assert_ret_3,
                            *__errno_location(),
            ...
            mfs_removefileinfo((*fi).fh as uint32_t);
        }
        fs_dec_acnt(ino as uint32_t);
    }
}
...
pub unsafe extern "C" fn mfs_read(
    ...
    unsafe {
        ...
        if (*fileinfo).inode as fuse_ino_t != ino {
            oplog_printf(
                ...
                b"read (%lu!=%lu,%llu,%llu) [handle:%08X]: %s\0".as_ptr()
                    as *const ::core::ffi::c_char,
                (*fileinfo).inode as ::core::ffi::c_ulong,
                ino as ::core::ffi::c_ulong,
                size as ::core::ffi::c_ulonglong,
                off as ::core::ffi::c_ulonglong,
                (*fi).fh as uint32_t,
        ...
        plfsclient::inoleng::read_start((*fileinfo).flengptr.as_ref().unwrap());
        ...
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    4403 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret,
                    *__errno_location(),
        ...
        if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    4433 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret_0,
                    *__errno_location(),
        ...
        if oim as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
            ...
            if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4443 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_1,
                        *__errno_location(),
                ...
                if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            4448 as ::core::ffi::c_int as ::core::ffi::c_uint,
                            b"pthread_cond_wait(&(fileinfo->opencond),&(fileinfo->lock))\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            _mfs_assert_ret_2,
                            *__errno_location(),
                            _mfs_errorstring_5,
            ...
            if (*fileinfo).open_status != 0 as ::core::ffi::c_int {
            ...
            if _mfs_assert_ret_3 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4456 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_3,
                        *__errno_location(),
        ...
        plfsclient::inoleng::read_end((*fileinfo).flengptr.as_ref().unwrap());
        let mut _mfs_assert_ret_4: ::core::ffi::c_int =
            pthread_mutex_lock(&raw mut (*fileinfo).lock);
        if _mfs_assert_ret_4 != 0 as ::core::ffi::c_int {
            if _mfs_assert_ret_4 < 0 as ::core::ffi::c_int
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    4481 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret_4,
                    *__errno_location(),
        ...
        if _mfs_assert_ret_5 != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    4492 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret_5,
                    *__errno_location(),
...
pub unsafe extern "C" fn mfs_write(
    ...
    unsafe {
        ...
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    4565 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret,
                    *__errno_location(),
            ...
            if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4569 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_cond_wait(&(fileinfo->opencond),&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_0,
                        *__errno_location(),
            ...
            if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4575 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_1,
                        *__errno_location(),
        ...
        appendonly = (if (*fileinfo).mode as ::core::ffi::c_int == IO_RA as ::core::ffi::c_int {
            1 as ::core::ffi::c_int
        } else {
            0 as ::core::ffi::c_int
        }) as uint8_t;
            ...
            if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4583 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_2,
                        *__errno_location(),
        ...
        if _mfs_assert_ret_3 != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    4588 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret_3,
                    *__errno_location(),
        ...
        plfsclient::inoleng::write_start((*fileinfo).flengptr.as_ref().unwrap());
        let mut _mfs_assert_ret_4: ::core::ffi::c_int =
            pthread_mutex_lock(&raw mut (*fileinfo).lock);
        if _mfs_assert_ret_4 != 0 as ::core::ffi::c_int {
            if _mfs_assert_ret_4 < 0 as ::core::ffi::c_int
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    4590 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret_4,
                    *__errno_location(),
        ...
        original_off = off;
        leng = plfsclient::inoleng::get_length((*fileinfo).flengptr.as_ref().unwrap()) as off_t;
                ...
                if _mfs_assert_ret_5 != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            4611 as ::core::ffi::c_int as ::core::ffi::c_uint,
                            b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            _mfs_assert_ret_5,
                            *__errno_location(),
                ...
                if _mfs_assert_ret_6 != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            4613 as ::core::ffi::c_int as ::core::ffi::c_uint,
                            b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            _mfs_assert_ret_6,
                            *__errno_location(),
        ...
        if err == 0 as ::core::ffi::c_int {
            if (*fileinfo).wdata.is_null() {
                (*fileinfo).wdata = write_data_new(ino as uint32_t, leng as uint64_t);
            }
            ...
            if _mfs_assert_ret_7 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4631 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_7,
                        *__errno_location(),
            ...
            if _mfs_assert_ret_8 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4641 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_8,
                        *__errno_location(),
            ...
            if _mfs_assert_ret_9 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4655 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_9,
                        *__errno_location(),
            ...
            if _mfs_assert_ret_10 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4674 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_10,
                        *__errno_location(),
        ...
        plfsclient::inoleng::write_end((*fileinfo).flengptr.as_ref().unwrap());
    }
}
#[inline]
unsafe extern "C" fn mfs_do_fsync(mut fileinfo: *mut finfo) -> ::core::ffi::c_int {
    unsafe {
        let mut inode: uint32_t = 0;
        let mut err: ::core::ffi::c_int = 0;
        err = 0 as ::core::ffi::c_int;
        ...
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    4701 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret,
                    *__errno_location(),
        ...
        if !(*fileinfo).wdata.is_null()
            && ((*fileinfo).mode as ::core::ffi::c_int == IO_RW as ::core::ffi::c_int
                || (*fileinfo).mode as ::core::ffi::c_int == IO_RA as ::core::ffi::c_int)
        {
            let mut _mfs_assert_ret_0: ::core::ffi::c_int =
                pthread_mutex_unlock(&raw mut (*fileinfo).lock);
            if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4715 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_0,
                        *__errno_location(),
            ...
            if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4719 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_1,
                        *__errno_location(),
            ...
            if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4728 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_2,
                        *__errno_location(),
            ...
            if _mfs_assert_ret_3 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4730 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_3,
                        *__errno_location(),
    ...
    unsafe {
        ...
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    4796 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret,
                    *__errno_location(),
                ...
                || (*fileinfo).mode as ::core::ffi::c_int == IO_RA as ::core::ffi::c_int)
        {
            ...
            if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4809 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_0,
                        *__errno_location(),
            ...
            if uselocks as ::core::ffi::c_int & 2 as ::core::ffi::c_int != 0
                ...
                || (*fileinfo).create + fsync_before_close_min_time < monotonic_seconds()
                || write_cache_almost_full() as ::core::ffi::c_int != 0
            {
                ...
                do_truncate(
                    ...
                    (*gids).gidcnt,
                    (*gids).gidtab,
                    write_data_getmaxfleng((*fileinfo).wdata),
                    ::core::ptr::null_mut::<uint8_t>(),
                    ::core::ptr::null_mut::<uint64_t>(),
                );
                groups_rel(gids);
            ...
            if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        4820 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_1,
                        *__errno_location(),
        ...
        if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    4865 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret_2,
                    *__errno_location(),
...
pub unsafe extern "C" fn mfs_flock(
    ...
    unsafe {
        ...
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    5104 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret,
                    *__errno_location(),
            ...
            if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        5109 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_cond_wait(&(fileinfo->opencond),&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_0,
                        *__errno_location(),
            ...
            if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        5115 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_1,
                        *__errno_location(),
        ...
        if lock_mode as ::core::ffi::c_int != FLOCK_UNLOCK {
            ...
            if flo.is_null() {
                flo = malloc(::core::mem::size_of::<finfo_lock_owner>()) as *mut finfo_lock_owner;
                (*flo).lock_owner = owner;
                (*flo).next = (*fileinfo).flock_lo_head as *mut _lock_owner;
        ...
        if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    5140 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret_2,
                    *__errno_location(),
        ...
        let c2rust_lhs_0 = &raw mut (*fileinfo).uselocks;
        let c2rust_rhs_0 = 1 as uint8_t;
        ::core::intrinsics::atomic_or::<_, _, { ::core::intrinsics::AtomicOrdering::SeqCst }>(
            c2rust_lhs_0,
            c2rust_rhs_0,
        ) | c2rust_rhs_0;
...
pub unsafe extern "C" fn mfs_getlk(
    ...
    unsafe {
        ...
        if fi.is_null() || finfo_get((*fi).fh as uint32_t).is_null() {
            if debug_mode != 0 {
                oplog_printf(
                    &raw mut ctx,
                    b"getlk (inode:%lu owner:- start:- end:- type:-): %s\0".as_ptr()
    ...
    unsafe {
        ...
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    5470 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret,
                    *__errno_location(),
            ...
            if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        5475 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_cond_wait(&(fileinfo->opencond),&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_0,
                        *__errno_location(),
            ...
            if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
                    ...
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
                    ...
                    mfs_log(
                        ...
                        b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        5481 as ::core::ffi::c_int as ::core::ffi::c_uint,
                        b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        _mfs_assert_ret_1,
                        *__errno_location(),
        ...
        if r#type as ::core::ffi::c_int != POSIX_LOCK_UNLCK {
            ...
            if flo.is_null() {
                flo = malloc(::core::mem::size_of::<finfo_lock_owner>()) as *mut finfo_lock_owner;
                (*flo).lock_owner = owner;
                (*flo).next = (*fileinfo).posix_lo_head as *mut _lock_owner;
        ...
        if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"/tmp/moosefs-ref/mfsclient/mfs_fuse.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    5511 as ::core::ffi::c_int as ::core::ffi::c_uint,
                    b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret_2,
                    *__errno_location(),
