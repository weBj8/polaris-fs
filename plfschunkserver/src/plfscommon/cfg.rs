...
unsafe extern "C" {
    ...
    unsafe fn ftell(__stream: *mut FILE) -> ::core::ffi::c_long;
    unsafe fn memcpy(
    ...
    unsafe {
        ...
        if fd.is_null() {
            if *__errno_location() == ENOENT {
                ...
                mfs_log(
                    ...
                    MFSLOG_ERR,
                    b"can't load main config file (%s), error\0".as_ptr()
        ...
        while getline(&raw mut linebuff, &raw mut lbsize, fd) != -1 as __ssize_t {
                ...
                || npe == nps
            {
                ...
                i = i.wrapping_add(1);
                while *linebuff.offset(i as isize) as ::core::ffi::c_int
                    == ' ' as ::core::ffi::c_int
                ...
                while i > vps
                    && *linebuff.offset(i.wrapping_sub(1 as uint32_t) as isize)
                        as ::core::ffi::c_int
                        == 32 as ::core::ffi::c_int
                {
                    i = i.wrapping_sub(1);
                        ...
                        != '#' as ::core::ffi::c_int
                {
                    ...
                    *linebuff.offset(vpe as isize) = 0 as ::core::ffi::c_char;
                    ...
                    while !tmp.is_null() && found as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                        if strcmp((*tmp).name, linebuff.offset(nps as isize))
                            == 0 as ::core::ffi::c_int
                        {
                            mfs_log(
                                MFSLOG_SYSLOG_STDERR,
                    ...
                    if found as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                        ...
                        (*tmp).name =
                            malloc(npe.wrapping_sub(nps).wrapping_add(1 as uint32_t) as size_t)
                                as *mut ::core::ffi::c_char;
                        (*tmp).value =
                            malloc(vpe.wrapping_sub(vps).wrapping_add(1 as uint32_t) as size_t)
                                as *mut ::core::ffi::c_char;
    ...
    unsafe {
        ...
        if ret.is_null() {
            fprintf(
                ...
                b"/tmp/moosefs-ref/mfschunkserver/../mfscommon/cfg.c\0".as_ptr()
                    as *const ::core::ffi::c_char,
