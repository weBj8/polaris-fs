...
unsafe extern "C" {
    ...
    unsafe fn feof(__stream: *mut FILE) -> ::core::ffi::c_int;
    ...
    unsafe fn sclass_get_export_group(sclassid: uint16_t) -> uint8_t;
    unsafe fn fs_getdirpath_size(inode: uint32_t) -> uint32_t;
    unsafe fn fs_getdirpath_data(inode: uint32_t, buff: *mut uint8_t, size: uint32_t);
    unsafe fn of_session_removed(sessionid: uint32_t);
    unsafe fn of_noofopenedfiles(sessionid: uint32_t) -> uint32_t;
        ...
        loop {
            ...
            ) == recsize as int64_t
            {
                ...
                if statsinfile as ::core::ffi::c_int > SESSION_STATS {
                    ptr = ptr.offset(
                        (4 as ::core::ffi::c_int
                            * (statsinfile as ::core::ffi::c_int - SESSION_STATS))
                            as isize,
                    );
                }
                i = 0 as uint32_t;
                ...
                if (*asesdata).ileng > 0 as uint32_t {
                    (*asesdata).info =
                        malloc((*asesdata).ileng.wrapping_add(1 as uint32_t) as size_t)
                            as *mut uint8_t;
...
pub unsafe extern "C" fn sessions_import_data() -> ::core::ffi::c_int {
    unsafe {
        ...
        ) == 0 as ::core::ffi::c_int
        {
            ...
            &raw mut hdr as *mut uint8_t as *const ::core::ffi::c_void,
            b"MFSS \x01\x06\x01\0".as_ptr() as *const ::core::ffi::c_char
        ...
        ) == 0 as ::core::ffi::c_int
        {
            ...
            &raw mut hdr as *mut uint8_t as *const ::core::ffi::c_void,
            b"MFSS \x01\x06\x02\0".as_ptr() as *const ::core::ffi::c_char
                as *const ::core::ffi::c_void,
            8 as size_t,
        ) == 0 as ::core::ffi::c_int
        {
            ...
            &raw mut hdr as *mut uint8_t as *const ::core::ffi::c_void,
            b"MFSS \x01\x06\x03\0".as_ptr() as *const ::core::ffi::c_char
                as *const ::core::ffi::c_void,
            8 as size_t,
        ) == 0 as ::core::ffi::c_int
        {
            ...
            &raw mut hdr as *mut uint8_t as *const ::core::ffi::c_void,
            b"MFSS \x01\x06\x04\0".as_ptr() as *const ::core::ffi::c_char
                as *const ::core::ffi::c_void,
            8 as size_t,
        ) == 0 as ::core::ffi::c_int
        {
        ...
        while feof(fd) == 0 {
            if mapalldata as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                r = fread(
                    fsesrecord as *mut ::core::ffi::c_void,
                    (25 as uint32_t).wrapping_add(statsinfile.wrapping_mul(8 as uint32_t))
                        as size_t,
                    1 as size_t,
                    fd,
                ) as ::core::ffi::c_int;
                ...
                r = fread(
                    fsesrecord as *mut ::core::ffi::c_void,
                    (33 as uint32_t).wrapping_add(statsinfile.wrapping_mul(8 as uint32_t))
                        as size_t,
                    1 as size_t,
                    fd,
                ) as ::core::ffi::c_int;
                ...
                r = fread(
                    fsesrecord as *mut ::core::ffi::c_void,
                    (43 as uint32_t).wrapping_add(statsinfile.wrapping_mul(8 as uint32_t))
                        as size_t,
                    1 as size_t,
                    fd,
                ) as ::core::ffi::c_int;
    ...
    unsafe {
        ...
        if vmode as ::core::ffi::c_int == 0xff as ::core::ffi::c_int {
            ...
            if (vmode as ::core::ffi::c_int) < 3 as ::core::ffi::c_int {
                size = (56 as ::core::ffi::c_int + SESSION_STATS * 8 as ::core::ffi::c_int)
                    as uint32_t;
            } else if (vmode as ::core::ffi::c_int) < 4 as ::core::ffi::c_int {
                size = (58 as ::core::ffi::c_int + SESSION_STATS * 8 as ::core::ffi::c_int)
                    as uint32_t;
            } else {
                size = (62 as ::core::ffi::c_int + SESSION_STATS * 8 as ::core::ffi::c_int)
                    as uint32_t;
            }
            size = size.wrapping_add((*sesdata).ileng);
            if (*sesdata).rootinode == 0 as uint32_t {
...
unsafe extern "C" fn sessions_create_session(
    ...
    unsafe {
        ...
        if sesflags as ::core::ffi::c_int & SESFLAG_METARESTORE == 0 as ::core::ffi::c_int {
            changelog(
                b"%u|SESADD(#%lu,%u,%hhu,0%03ho,%u,%u,%u,%u,0x%04hX,%u,%u,0x%08X,%u,%s):%u\0"
                    .as_ptr() as *const ::core::ffi::c_char,
                main_time(),
                exportscsum,
                rootinode,
...
unsafe extern "C" fn sessions_not_changed(
    ...
    unsafe {
        ...
        if !(*sesdata).info.is_null() && info.is_null()
            || (*sesdata).info.is_null() && !info.is_null()
        {
            return 0 as uint8_t;
        }
        if memcmp(
...
pub unsafe extern "C" fn sessions_add_stats(
    ...
    unsafe {
        ...
        if !sesdata.is_null() && (statid as ::core::ffi::c_int) < SESSION_STATS {
            (*sesdata).chouropstats[statid as usize] =
                ((*sesdata).chouropstats[statid as usize] as uint64_t).wrapping_add(value)
                    as uint32_t;
            (*sesdata).cminopstats[statid as usize] =
                ((*sesdata).cminopstats[statid as usize] as uint64_t).wrapping_add(value)
                    as uint32_t;
        }
    }
}
