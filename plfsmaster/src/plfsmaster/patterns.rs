...
unsafe extern "C" {
    ...
    unsafe fn glob_new(globstr: *const uint8_t) -> *mut ::core::ffi::c_void;
    unsafe fn glob_free(glob: *mut ::core::ffi::c_void);
...
pub unsafe extern "C" fn patterns_list(mut buff: *mut uint8_t) -> uint32_t {
    unsafe {
        ...
        while i < PATTERNS_MAX as uint32_t {
            if patterntab[i as usize].valid != 0 {
                if buff.is_null() {
                    if patterntab[i as usize].omask as ::core::ffi::c_int & PATTERN_OMASK_SCLASS
                        != 0
                    {
                        lsize = lsize.wrapping_add(
                            (patterntab[i as usize].gnleng as ::core::ffi::c_int
                                + sclass_get_nleng(patterntab[i as usize].scid)
                                    as ::core::ffi::c_int
                    ...
                    buff =
                        buff.offset(patterntab[i as usize].gnleng as ::core::ffi::c_int as isize);
                        ...
                        != 0
                    {
                        ...
                        memcpy(
                            buff as *mut ::core::ffi::c_void,
                            sclass_get_name(patterntab[i as usize].scid)
    ...
    unsafe {
        ...
        if mver as ::core::ffi::c_int > 0x11 as ::core::ffi::c_int {
            mfs_log(
                ...
                MFSLOG_ERR,
                b"loading patterns data: unsupported format\0".as_ptr()
                    as *const ::core::ffi::c_char,
            );
            return -1 as ::core::ffi::c_int;
        }
                ...
                ) != (psize + gnleng as int32_t) as int64_t
                {
                    ...
                    *__errno_location() = err_0;
                    mfs_log(
                        MFSLOG_ERRNO_SYSLOG_STDERR,
                        MFSLOG_ERR,
                        b"loading patterns data: read error\0".as_ptr()
                            as *const ::core::ffi::c_char,
                    );
                    return -1 as ::core::ffi::c_int;
                }
