...
pub unsafe extern "C" fn bgsaver_worker() {
    unsafe {
        ...
        let mut chlogbuff: *mut ::core::ffi::c_char =
                            ...
                            if leng <= 10000000 as uint32_t {
                                ...
                                if l != leng as int32_t {
                                    ...
                                    match cmd {
                                                ...
                                                if wleng != leng.wrapping_sub(16 as uint32_t) {
                                                        ...
                                                        )
                                                    {
                                                        ...
                                                        if speedlimit > 0 as uint32_t {
                                                            ...
                                                            bytes = bytes
                                                                .wrapping_add(wleng as uint64_t);
                                                            ...
                                                            if expected_seconds > seconds_passed {
                                                                usleep(
                                                                    ((expected_seconds - seconds_passed)
                                        ...
                                        5 => {
                                            ...
                                            if leng >= 12 as uint32_t {
                                                ...
                                                if logfd >= 0 as ::core::ffi::c_int {
                                                    if leng.wrapping_add(50 as uint32_t)
                                                        > chlogbuffsize
                                                    {
                                                        if chlogbuff.is_null() {
                                                            ...
                                                            if chlogbuff.is_null() {
                                                                ...
                                                                chlogbuffsize = leng
                                                                    .wrapping_add(500 as uint32_t);
                                                            }
                                                        } else {
                                                            let mut prevptr: *mut ::core::ffi::c_char = chlogbuff;
                                                            chlogbuff = realloc(
                                                                chlogbuff
                                        ...
                                        8 => {
                                            if leng != 4 as uint32_t {
                                                ...
                                                let mut logname1: [::core::ffi::c_char; 100] =
                                                    [0; 100];
                                                let mut logname2: [::core::ffi::c_char; 100] =
                                                    [0; 100];
                                            ...
                                            == BGSAVER_ROTATELOG as ::core::ffi::c_int as uint32_t
                                    {
                                        if status != 0 {
                                            if cmd
                                                == BGSAVER_CHANGELOG as ::core::ffi::c_int
                                                    as uint32_t
                                            ...
                                            if chloglostcnt == 0 as uint32_t {
                                                ...
                                                mfs_log(
                                                    MFSLOG_SYSLOG,
                                                    MFSLOG_WARNING,
                                                    b"next 100000 changelogs are lost !!!\0"
                                                        .as_ptr()
                                                        as *const ::core::ffi::c_char,
                                                );
                                                chloglostcnt = 0 as uint32_t;
        ...
        if (*eptr).mode as ::core::ffi::c_int == KILL as ::core::ffi::c_int {
            ...
            if terminating as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_ERR,
                    b"connection with background data writer has been terminated - exiting\0"
                        .as_ptr() as *const ::core::ffi::c_char,
                );
                main_exit();
            }
    ...
    unsafe {
        ...
        if (*eptr).pdescpos_w >= 0 as int32_t {
            if ((*pdesc.offset((*eptr).pdescpos_w as isize)).events as ::core::ffi::c_int & POLLOUT
                == 0 as ::core::ffi::c_int
                && !(*eptr).outputhead.is_null()
                || (*pdesc.offset((*eptr).pdescpos_w as isize)).revents as ::core::ffi::c_int
                    & POLLOUT
                    != 0)
                && (*eptr).mode as ::core::ffi::c_int == DATA as ::core::ffi::c_int
            {
