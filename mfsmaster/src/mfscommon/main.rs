...
extern "C" {
    ...
    fn strerr_term();
    fn mycrc32_init();
    fn topology_init() -> ::core::ffi::c_int;
    fn exports_init() -> ::core::ffi::c_int;
    fn dcm_init() -> ::core::ffi::c_int;
    fn matomlserv_init() -> ::core::ffi::c_int;
    fn matocsserv_init() -> ::core::ffi::c_int;
    fn matoclserv_init() -> ::core::ffi::c_int;
    fn meta_setignoreflag();
    fn meta_allowautorestore();
    fn meta_incverboselevel();
    fn meta_init() -> ::core::ffi::c_int;
    fn meta_restore() -> ::core::ffi::c_int;
    fn rnd_init() -> ::core::ffi::c_int;
    fn changelog_init() -> ::core::ffi::c_int;
    fn chartsdata_init() -> ::core::ffi::c_int;
    fn missing_log_init() -> ::core::ffi::c_int;
    fn glob_cache_init() -> ::core::ffi::c_int;
    fn bgsaver_init() -> ::core::ffi::c_int;
    fn multilan_init() -> ::core::ffi::c_int;
...
#[no_mangle]
pub static mut RestoreRunTab: [C2Rust_Unnamed_10; 3] = [
    C2Rust_Unnamed_10 {
        r#fn: Some(dcm_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"data cache manager\0".as_ptr() as *const ::core::ffi::c_char
            as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
        r#fn: Some(meta_restore as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"metadata restore\0".as_ptr() as *const ::core::ffi::c_char
            as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
        r#fn: None,
...
#[no_mangle]
pub static mut RunTab: [C2Rust_Unnamed_10; 15] = [
    C2Rust_Unnamed_10 {
    ...
    C2Rust_Unnamed_10 {
        r#fn: Some(bgsaver_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"bgsaver\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
        r#fn: Some(glob_cache_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"glob engine\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
        r#fn: Some(multilan_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"multilan map\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
        r#fn: Some(changelog_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"change log\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
        r#fn: Some(missing_log_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"missing chunks/files log\0".as_ptr() as *const ::core::ffi::c_char
            as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
        r#fn: Some(dcm_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
    ...
    C2Rust_Unnamed_10 {
        r#fn: Some(exports_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"exports manager\0".as_ptr() as *const ::core::ffi::c_char
            as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
        r#fn: Some(topology_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"net topology module\0".as_ptr() as *const ::core::ffi::c_char
            as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
        r#fn: Some(meta_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"metadata manager\0".as_ptr() as *const ::core::ffi::c_char
            as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
    ...
    C2Rust_Unnamed_10 {
        r#fn: Some(matomlserv_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"communication with metalogger\0".as_ptr() as *const ::core::ffi::c_char
            as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
        r#fn: Some(matocsserv_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"communication with chunkserver\0".as_ptr() as *const ::core::ffi::c_char
            as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
        r#fn: Some(matoclserv_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"communication with clients\0".as_ptr() as *const ::core::ffi::c_char
            as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
        r#fn: None,
...
pub unsafe extern "C" fn main_destruct_register_fname(
    ...
    if aux.is_null() {
        fprintf(
            ...
            b"/tmp/moosefs-ref/mfsmaster/../mfscommon/main.c\0".as_ptr()
...
pub unsafe extern "C" fn mainloop() -> ::core::ffi::c_int {
    ...
    while t != 3 as ::core::ffi::c_int {
        ...
        if r == 1 as ::core::ffi::c_int {
            ...
            infile = fopen(
                b".mfsmaster_info.txt\0".as_ptr() as *const ::core::ffi::c_char,
...
pub unsafe extern "C" fn wdlock(mut runmode: uint8_t, mut timeout: uint32_t) -> uint8_t {
    ...
    lfd = open(
        b".mfsmaster.lock\0".as_ptr() as *const ::core::ffi::c_char,
        O_WRONLY | O_CREAT,
    ...
    if ownerpid > 0 as ::core::ffi::c_int {
        if runmode as ::core::ffi::c_int == RM_TEST {
            mfs_log(
                MFSLOG_SYSLOG_STDERR,
                MFSLOG_INFO,
                b"mfsmaster pid: %ld\0".as_ptr() as *const ::core::ffi::c_char,
    ...
    if runmode as ::core::ffi::c_int == RM_START || runmode as ::core::ffi::c_int == RM_RESTART {
        ...
        mfs_log(
            MFSLOG_SYSLOG_STDERR,
            MFSLOG_NOTICE,
            b"mfsmaster is not running\0".as_ptr() as *const ::core::ffi::c_char,
        );
        return 1 as uint8_t;
    }
    return 0 as uint8_t;
...
unsafe fn main_0(
    ...
    cfgfile = strdup(
        b"/home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/etc/mfs/mfsmaster.cfg\0"
            .as_ptr() as *const ::core::ffi::c_char,
    );
    if cfgfile.is_null() {
        fprintf(
    ...
    if fd < 0 as ::core::ffi::c_int && *__errno_location() == ENOENT {
        ocfgfile = strdup(
            b"/home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/etc/mfsmaster.cfg\0"
                .as_ptr() as *const ::core::ffi::c_char,
        );
        if ocfgfile.is_null() {
            fprintf(
    ...
    loop {
        ch = getopt(
            argc,
            argv,
            b"nuvfdc:t:h?iax\0".as_ptr() as *const ::core::ffi::c_char,
        );
    ...
    if movewarning != 0 {
        mfs_log(
            MFSLOG_SYSLOG_STDERR,
            MFSLOG_WARNING,
            b"default sysconf path has changed - please move mfsmaster.cfg from /home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/etc/ to /home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/etc/mfs/\0"
                .as_ptr() as *const ::core::ffi::c_char,
        );
    }
    ...
    logappname = cfg_getstr(
        ...
        b"mfsmaster\0".as_ptr() as *const ::core::ffi::c_char,
    );
