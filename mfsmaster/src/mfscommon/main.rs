...
unsafe extern "C" {
    ...
    unsafe fn topology_init() -> ::core::ffi::c_int;
    unsafe fn exports_init() -> ::core::ffi::c_int;
    unsafe fn dcm_init() -> ::core::ffi::c_int;
    unsafe fn matomlserv_init() -> ::core::ffi::c_int;
    unsafe fn matocsserv_init() -> ::core::ffi::c_int;
    unsafe fn matoclserv_init() -> ::core::ffi::c_int;
    unsafe fn meta_setignoreflag();
    unsafe fn meta_allowautorestore();
    unsafe fn meta_incverboselevel();
    unsafe fn meta_init() -> ::core::ffi::c_int;
    unsafe fn meta_restore() -> ::core::ffi::c_int;
    unsafe fn rnd_init() -> ::core::ffi::c_int;
    unsafe fn changelog_init() -> ::core::ffi::c_int;
    unsafe fn chartsdata_init() -> ::core::ffi::c_int;
    unsafe fn missing_log_init() -> ::core::ffi::c_int;
    unsafe fn glob_cache_init() -> ::core::ffi::c_int;
    unsafe fn bgsaver_init() -> ::core::ffi::c_int;
    unsafe fn multilan_init() -> ::core::ffi::c_int;
