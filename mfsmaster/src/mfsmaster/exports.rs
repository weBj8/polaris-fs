...
extern "C" {
    ...
    fn cfg_use_option(name: *const ::core::ffi::c_char, value: *const ::core::ffi::c_char);
    fn cfg_getstr(
...
unsafe extern "C" fn murmur3_32(
    ...
    hash =
        (hash as ::core::ffi::c_uint).wrapping_mul(0x85ebca6b as ::core::ffi::c_uint) as uint32_t;
    hash ^= hash >> 13 as ::core::ffi::c_int;
    hash =
        (hash as ::core::ffi::c_uint).wrapping_mul(0xc2b2ae35 as ::core::ffi::c_uint) as uint32_t;
    hash ^= hash >> 16 as ::core::ffi::c_int;
    return hash;
}
...
pub unsafe extern "C" fn exports_info_size(mut versmode: uint8_t) -> uint32_t {
    ...
    while !e.is_null() {
        if (*e).meta() != 0 {
            ...
            size = size.wrapping_add((35 as uint32_t).wrapping_add(add).wrapping_add((*e).pleng));
        }
    ...
    while !e.is_null() {
            ...
            && meta as ::core::ffi::c_int == (*e).meta() as ::core::ffi::c_int
        {
                ...
                ) == 0 as ::core::ffi::c_int
            {
                ...
                && pleng > (*e).pleng
                && *p.offset((*e).pleng as isize) as ::core::ffi::c_int == '/' as ::core::ffi::c_int
                && memcmp(
                    p as *const ::core::ffi::c_void,
                    (*e).path as *const ::core::ffi::c_void,
                    (*e).pleng as size_t,
        ...
        if ok != 0 {
            if f.is_null() {
                ...
                == 0 as ::core::ffi::c_int
                && (*f).sesflags as ::core::ffi::c_int & SESFLAG_READONLY != 0 as ::core::ffi::c_int
            {
                f = e;
            } else if (*e).rootuid == 0 as uint32_t && (*f).rootuid != 0 as uint32_t {
                f = e;
            } else if (*e).sesflags as ::core::ffi::c_int & SESFLAG_ADMIN != 0 as ::core::ffi::c_int
                && (*f).sesflags as ::core::ffi::c_int & SESFLAG_ADMIN == 0 as ::core::ffi::c_int
            {
                f = e;
...
pub unsafe extern "C" fn exports_parseumask(
    ...
    *umaskval = ((*umaskstr.offset(1 as isize) as ::core::ffi::c_int - '0' as ::core::ffi::c_int)
...
pub unsafe extern "C" fn exports_parseversion(
        ...
        && *verstr as ::core::ffi::c_int <= '9' as ::core::ffi::c_int
    {
        ...
        vp = vp
            .wrapping_add((*verstr as ::core::ffi::c_int - '0' as ::core::ffi::c_int) as uint32_t);
...
pub unsafe extern "C" fn exports_parseuidgid(
        ...
        && *eptr as ::core::ffi::c_int <= '9' as ::core::ffi::c_int
    {
        ...
        uid =
            uid.wrapping_add((*eptr as ::core::ffi::c_int - '0' as ::core::ffi::c_int) as uint32_t);
        eptr = eptr.offset(1);
    }
    if *eptr as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
        if getpwnam_r(
        ...
        match *p as ::core::ffi::c_int {
            ...
            114 => {
                    ...
                    == 0 as ::core::ffi::c_int
                {
                    *disables = (*disables as ::core::ffi::c_uint | DISABLE_RENAME) as uint32_t;
                    ...
                    == 0 as ::core::ffi::c_int
                {
                    *disables = (*disables as ::core::ffi::c_uint | DISABLE_READDIR) as uint32_t;
                    o = 1 as ::core::ffi::c_int;
            ...
            115 => {
                if strcmp(p, b"symlink\0".as_ptr() as *const ::core::ffi::c_char)
                    == 0 as ::core::ffi::c_int
                {
                    *disables = (*disables as ::core::ffi::c_uint | DISABLE_SYMLINK) as uint32_t;
                    o = 1 as ::core::ffi::c_int;
                } else if strcmp(p, b"setlength\0".as_ptr() as *const ::core::ffi::c_char)
                    == 0 as ::core::ffi::c_int
                {
                    *disables = (*disables as ::core::ffi::c_uint | DISABLE_SETLENGTH) as uint32_t;
                    o = 1 as ::core::ffi::c_int;
                } else if strcmp(p, b"snapshot\0".as_ptr() as *const ::core::ffi::c_char)
                    == 0 as ::core::ffi::c_int
                {
                    *disables = (*disables as ::core::ffi::c_uint | DISABLE_SNAPSHOT) as uint32_t;
                    o = 1 as ::core::ffi::c_int;
                } else if strcmp(p, b"settrash\0".as_ptr() as *const ::core::ffi::c_char)
                    == 0 as ::core::ffi::c_int
                {
                    *disables = (*disables as ::core::ffi::c_uint | DISABLE_SETTRASH) as uint32_t;
                    o = 1 as ::core::ffi::c_int;
                } else if strcmp(p, b"setsclass\0".as_ptr() as *const ::core::ffi::c_char)
                    == 0 as ::core::ffi::c_int
                {
                    *disables = (*disables as ::core::ffi::c_uint | DISABLE_SETSCLASS) as uint32_t;
                    o = 1 as ::core::ffi::c_int;
                } else if strcmp(p, b"seteattr\0".as_ptr() as *const ::core::ffi::c_char)
                    == 0 as ::core::ffi::c_int
                {
                    *disables = (*disables as ::core::ffi::c_uint | DISABLE_SETEATTR) as uint32_t;
                    o = 1 as ::core::ffi::c_int;
                } else if strcmp(p, b"setxattr\0".as_ptr() as *const ::core::ffi::c_char)
                    == 0 as ::core::ffi::c_int
                {
                    *disables = (*disables as ::core::ffi::c_uint | DISABLE_SETXATTR) as uint32_t;
                    o = 1 as ::core::ffi::c_int;
                } else if strcmp(p, b"setfacl\0".as_ptr() as *const ::core::ffi::c_char)
                    == 0 as ::core::ffi::c_int
                {
                    *disables = (*disables as ::core::ffi::c_uint | DISABLE_SETFACL) as uint32_t;
                    o = 1 as ::core::ffi::c_int;
                }
            }
            116 => {
                if strcmp(p, b"truncate\0".as_ptr() as *const ::core::ffi::c_char)
                    == 0 as ::core::ffi::c_int
                {
                    *disables = (*disables as ::core::ffi::c_uint | DISABLE_TRUNCATE) as uint32_t;
                    o = 1 as ::core::ffi::c_int;
                }
            }
            117 => {
...
pub unsafe extern "C" fn exports_parseoptions(
            ...
            105 => {
                    ...
                    == 0 as ::core::ffi::c_int
                {
                    if (*arec).meta() != 0 {
                        ...
                        (*arec).sesflags =
                            ((*arec).sesflags as ::core::ffi::c_int | SESFLAG_IGNOREGID) as uint8_t;
                    }
                    o = 1 as ::core::ffi::c_int;
                }
            }
            ...
            109 => {
                ...
                ) == 0 as ::core::ffi::c_int
                {
                    ...
                    if (*arec).meta() != 0 {
                        ...
                        (*arec).set_rootredefined(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
                    }
                } else if strncmp(
                    p,
                ...
                ) == 0 as ::core::ffi::c_int
                {
                    ...
                    if (*arec).meta() != 0 {
                        ...
                        (*arec).sesflags =
                            ((*arec).sesflags as ::core::ffi::c_int | SESFLAG_MAPALL) as uint8_t;
                    }
                } else if strncmp(
                    p,
                ...
                ) == 0 as ::core::ffi::c_int
                {
                    ...
                    if *ptr as ::core::ffi::c_int == 0 as ::core::ffi::c_int && i == 32 as uint32_t
                    {
                        ...
                        while i < 16 as uint32_t {
                            if *ptr as ::core::ffi::c_int >= '0' as ::core::ffi::c_int
                                && *ptr as ::core::ffi::c_int <= '9' as ::core::ffi::c_int
                            {
                                (*arec).passworddigest[i as usize] = ((*ptr as ::core::ffi::c_int
                                    - '0' as ::core::ffi::c_int)
                                    << 4 as ::core::ffi::c_int)
                                    as uint8_t;
                                ...
                                && *ptr as ::core::ffi::c_int <= '9' as ::core::ffi::c_int
                            {
                                (*arec).passworddigest[i as usize] =
                                    ((*arec).passworddigest[i as usize] as ::core::ffi::c_int
                        ...
                        mfs_log(
                            MFSLOG_SYSLOG_STDERR,
                            MFSLOG_WARNING,
                            b"mfsexports: incorrect md5pass definition (%s) in line: %u\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            p,
                            lineno,
                        );
                ...
                ) == 0 as ::core::ffi::c_int
                {
                    ...
                    ) < 0 as ::core::ffi::c_int
                    {
                        mfs_log(
                            MFSLOG_SYSLOG_STDERR,
                            MFSLOG_WARNING,
                            b"mfsexports: incorrect mingoal definition (%s) in line: %u\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            p,
                            lineno,
                        );
                    ...
                    if mingoal as ::core::ffi::c_int > maxgoal as ::core::ffi::c_int {
                        mfs_log(
                            MFSLOG_SYSLOG_STDERR,
                            MFSLOG_WARNING,
                            b"mfsexports: mingoal>maxgoal in definition (%s) in line: %u\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            p,
                            lineno,
                        );
                ...
                ) == 0 as ::core::ffi::c_int
                {
                    ...
                    ) < 0 as ::core::ffi::c_int
                    {
                        mfs_log(
                            MFSLOG_SYSLOG_STDERR,
                            MFSLOG_WARNING,
                            b"mfsexports: incorrect maxgoal definition (%s) in line: %u\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            p,
                            lineno,
                        );
                    ...
                    if mingoal as ::core::ffi::c_int > maxgoal as ::core::ffi::c_int {
                        mfs_log(
                            MFSLOG_SYSLOG_STDERR,
                            MFSLOG_WARNING,
                            b"mfsexports: maxgoal<mingoal in definition (%s) in line: %u\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            p,
                            lineno,
                        );
                ...
                ) == 0 as ::core::ffi::c_int
                {
                    ...
                    ) < 0 as ::core::ffi::c_int
                    {
                        mfs_log(
                            MFSLOG_SYSLOG_STDERR,
                            MFSLOG_WARNING,
                            b"mfsexports: incorrect umask definition (%s) in line: %u\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            p,
                            lineno,
                        );
    ...
    if goal_defined != 0 {
        ...
        while o <= maxgoal as ::core::ffi::c_int {
            (*arec).sclassgroups = ((*arec).sclassgroups as ::core::ffi::c_int
                | (1 as ::core::ffi::c_int) << o) as uint16_t;
            o += 1;
        }
    }
    return 0 as ::core::ffi::c_int;
        ...
        if *__errno_location() == ENOENT {
            if !exports_records.is_null() {
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_WARNING,
                    b"mfsexports configuration file (%s) not found - exports not changed\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    ExportsFileName,
                );
            } else {
            ...
            mfs_log(
                ...
                MFSLOG_WARNING,
                b"can't open mfsexports configuration file (%s) - no exports !!!, error\0".as_ptr()
                    as *const ::core::ffi::c_char,
                ExportsFileName,
            );
        }
...
pub unsafe extern "C" fn exports_reload() {
    ...
    if cfg_isdefined(b"EXPORTS_FILENAME\0".as_ptr() as *const ::core::ffi::c_char) == 0 {
        ExportsFileName = strdup(
            b"/home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/etc/mfs/mfsexports.cfg\0"
                .as_ptr() as *const ::core::ffi::c_char,
        );
        if ExportsFileName.is_null() {
            fprintf(
        ...
        if fd < 0 as ::core::ffi::c_int && *__errno_location() == ENOENT {
            let mut tmpname: *mut ::core::ffi::c_char =
                ::core::ptr::null_mut::<::core::ffi::c_char>();
            tmpname = strdup(
                b"/home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/etc/mfsexports.cfg\0"
                    .as_ptr() as *const ::core::ffi::c_char,
            );
            ...
            if fd >= 0 as ::core::ffi::c_int {
                ...
                mfs_log(
                    MFSLOG_SYSLOG_STDERR,
                    MFSLOG_WARNING,
                    b"default sysconf path has changed - please move mfsexports.cfg from /home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/etc/ to /home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/etc/mfs/\0"
                        .as_ptr() as *const ::core::ffi::c_char,
                );
            } else {
