...
extern "C" {
    ...
    fn shp_inc(vs: *mut ::core::ffi::c_void);
    fn shp_dec(vs: *mut ::core::ffi::c_void);
    fn fs_mr_access(ts: uint32_t, inode: uint32_t) -> uint8_t;
    fn fs_mr_append_slice(
        ts: uint32_t,
        inode: uint32_t,
        inode_src: uint32_t,
        slice_from: uint32_t,
    ...
    fn fs_mr_repair(ts: uint32_t, inode: uint32_t, indx: uint32_t, nversion: uint32_t) -> uint8_t;
    fn fs_mr_symlink(
        ts: uint32_t,
        parent: uint32_t,
        nleng: uint32_t,
    ...
    fn fs_mr_setpath(inode: uint32_t, path: *const uint8_t) -> uint8_t;
    fn fs_mr_snapshot(
        ts: uint32_t,
        inode_src: uint32_t,
        parent_dst: uint32_t,
    ...
    fn fs_mr_trash_remove(ts: uint32_t, inode: uint32_t) -> uint8_t;
    fn fs_mr_purge(ts: uint32_t, inode: uint32_t) -> uint8_t;
    fn fs_mr_undel(ts: uint32_t, inode: uint32_t) -> uint8_t;
    fn fs_mr_trunc(ts: uint32_t, inode: uint32_t, indx: uint32_t, chunkid: uint64_t) -> uint8_t;
    fn fs_mr_write(
        ts: uint32_t,
        inode: uint32_t,
        indx: uint32_t,
    ...
    fn fs_mr_unlock(ts: uint32_t, chunkid: uint64_t) -> uint8_t;
    fn fs_mr_setsclass(
        ts: uint32_t,
        inode: uint32_t,
        uid: uint32_t,
    ...
    fn fs_mr_set_file_chunk(inode: uint32_t, indx: uint32_t, chunkdid: uint64_t) -> uint8_t;
    fn fs_mr_autoarch(
        inode: uint32_t,
    ...
    fn fs_mr_renumerate_edges(expected_nextedgeid: uint64_t) -> uint8_t;
    fn sessions_mr_seschanged(
        sessionid: uint32_t,
    ...
    fn sessions_mr_sesdel(sessionid: uint32_t) -> uint8_t;
    fn sessions_mr_connected(sessionid: uint32_t) -> uint8_t;
    fn sessions_mr_disconnected(sessionid: uint32_t, disctime: uint32_t) -> uint8_t;
    fn sessions_mr_session(sessionid: uint32_t) -> uint8_t;
    fn of_mr_acquire(sessionid: uint32_t, inode: uint32_t) -> ::core::ffi::c_int;
    fn of_mr_release(sessionid: uint32_t, inode: uint32_t) -> ::core::ffi::c_int;
    fn flock_mr_change(
        inode: uint32_t,
        sessionid: uint32_t,
        owner: uint64_t,
    ...
    fn csdb_mr_op(csop: uint8_t, ip: uint32_t, port: uint16_t, arg: uint32_t) -> uint8_t;
    fn sclass_maskorgroup_to_labelexpr(
        labelexpr: *mut [uint8_t; 128],
        labelmasks: *mut uint32_t,
        labelscnt: uint8_t,
    );
    fn sclass_mr_ec_version(ec_new_version: uint8_t) -> uint8_t;
    fn sclass_mr_set_entry(
        nleng: uint8_t,
        name: *const uint8_t,
        esclassid: uint16_t,
        new_flag: uint8_t,
    ...
    fn sclass_mr_delete_entry(nleng: uint8_t, name: *const uint8_t, esclassid: uint16_t)
        -> uint8_t;
    fn chunk_mr_increase_version(chunkid: uint64_t) -> ::core::ffi::c_int;
    fn chunk_mr_set_version(chunkid: uint64_t, version: uint32_t) -> ::core::ffi::c_int;
    fn chunk_mr_nextchunkid(nchunkid: uint64_t) -> ::core::ffi::c_int;
    fn chunk_mr_chunkadd(
        ts: uint32_t,
        chunkid: uint64_t,
        version: uint32_t,
        lockedto: uint32_t,
    ) -> ::core::ffi::c_int;
    fn chunk_mr_chunkdel(ts: uint32_t, chunkid: uint64_t, version: uint32_t) -> ::core::ffi::c_int;
    fn chunk_mr_flagsclr(ts: uint32_t, chunkid: uint64_t) -> ::core::ffi::c_int;
    fn patterns_mr_add(
        gnleng: uint8_t,
        gname: *const uint8_t,
        euid: uint32_t,
    ...
    fn meta_mr_setmetaid(newmetaid: uint64_t) -> uint8_t;
    fn mfs_log(
        mode: ::core::ffi::c_int,
...
pub unsafe extern "C" fn do_addattr(
    ...
    loop {
        ...
        if _tmp_c as ::core::ffi::c_int == '%' as ::core::ffi::c_int {
            ...
            _tmp_c = (_tmp_h1 as ::core::ffi::c_int * 16 as ::core::ffi::c_int
                + _tmp_h2 as ::core::ffi::c_int) as ::core::ffi::c_char;
        }
    ...
    ptr = ptr.offset(1);
    return fs_mr_additionalattr(ts, inode, flags, attrblob, attrblobleng) as ::core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn do_append(
    ...
    ptr = ptr.offset(1);
    return fs_mr_append_slice(ts, inode, inode_src, slice_from, slice_to) as ::core::ffi::c_int;
}
#[no_mangle]
...
pub unsafe extern "C" fn do_create(
    ...
    loop {
        ...
        if !(_tmp_c as ::core::ffi::c_int != ',' as ::core::ffi::c_int && _tmp_i < 255 as uint32_t)
        {
            break;
        }
        if _tmp_c as ::core::ffi::c_int == '\0' as ::core::ffi::c_int
    ...
    loop {
        ...
        if ileng >= infosize {
            ...
            if info.is_null() {
                ...
                info =
                    realloc(info as *mut ::core::ffi::c_void, infosize as size_t) as *mut uint8_t;
                if info.is_null() {
                    free(_tmp_buff as *mut ::core::ffi::c_void);
                }
            }
...
pub unsafe extern "C" fn do_setpath(
    ...
    if _tmp_i >= pathsize {
        ...
        if path.is_null() {
            ...
            path = realloc(path as *mut ::core::ffi::c_void, pathsize as size_t) as *mut uint8_t;
            if path.is_null() {
        ...
        if path.is_null() {
            fprintf(
                stderr,
                b"%s:%u - out of memory: %s is NULL\n\0".as_ptr() as *const ::core::ffi::c_char,
                b"/tmp/moosefs-ref/mfsmaster/restore.c\0".as_ptr() as *const ::core::ffi::c_char,
                1329 as ::core::ffi::c_int as ::core::ffi::c_uint,
                b"path\0".as_ptr() as *const ::core::ffi::c_char,
            );
            mfs_log(
    ...
    loop {
        ...
        if _tmp_c_0 as ::core::ffi::c_int == '%' as ::core::ffi::c_int {
            ...
            _tmp_c_0 = (_tmp_h1_0 as ::core::ffi::c_int * 16 as ::core::ffi::c_int
                + _tmp_h2_0 as ::core::ffi::c_int) as ::core::ffi::c_char;
        }
        if valueleng >= valuesize {
            ...
            if value.is_null() {
                ...
                value =
                    realloc(value as *mut ::core::ffi::c_void, valuesize as size_t) as *mut uint8_t;
                if value.is_null() {
                    free(_tmp_buff as *mut ::core::ffi::c_void);
                }
            }
                    ...
                    && _tmp_c_0 as ::core::ffi::c_int <= '9' as ::core::ffi::c_int
                {
                    ...
                    *gid.offset(c2rust_fresh62 as isize) =
                    ...
                    mfs_log(
                        MFSLOG_SYSLOG_STDERR,
                        MFSLOG_WARNING,
                        b"%s:%lu: number or ',' expected\0".as_ptr() as *const ::core::ffi::c_char,
                        filename,
                        lv,
                    );
                    return -1 as ::core::ffi::c_int;
            ...
            loop {
                ...
                if gidleng >= gidstrsize {
                    ...
                    if gidstr.is_null() {
                        ...
                        gidstr = realloc(gidstr as *mut ::core::ffi::c_void, gidstrsize as size_t)
                            as *mut uint8_t;
                        if gidstr.is_null() {
...
pub unsafe extern "C" fn do_scset(
    ...
    if *ptr as ::core::ffi::c_int == 'W' as ::core::ffi::c_int {
            ...
            == 0 as ::core::ffi::c_int
        {
            ...
            arch_delay = (arch_delay as ::core::ffi::c_int * 24 as ::core::ffi::c_int) as uint16_t;
        }
        ...
        || *ptr as ::core::ffi::c_int == '1' as ::core::ffi::c_int
    {
        ...
        let mut eptr_14: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
        ...
        ptr = ptr.offset(1);
        let mut eptr_15: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
        ...
        let mut eptr_17: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
        ...
        ptr = ptr.offset(1);
        let mut eptr_18: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
        ...
        let mut eptr_19: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
        ...
        let mut eptr_21: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
        ...
        ptr = ptr.offset(1);
        let mut eptr_22: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
        ...
        let mut eptr_23: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
        ...
        let mut eptr_25: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
        ...
        let mut eptr_30: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
        ...
        let mut eptr_31: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
            ...
            == 0 as ::core::ffi::c_int
        {
            ...
            while (i as ::core::ffi::c_int) < keep.labelscnt as ::core::ffi::c_int {
                ...
                loop {
                    ...
                    {
                        _tmp_h1_2 = (_tmp_h1_2 as ::core::ffi::c_int - '0' as ::core::ffi::c_int)
                            as ::core::ffi::c_char;
                    ...
                    {
                        _tmp_h2_2 = (_tmp_h2_2 as ::core::ffi::c_int - '0' as ::core::ffi::c_int)
                            as ::core::ffi::c_char;
            ...
            while (i as ::core::ffi::c_int) < arch.labelscnt as ::core::ffi::c_int {
                ...
                loop {
                    ...
                    {
                        _tmp_h1_3 = (_tmp_h1_3 as ::core::ffi::c_int - '0' as ::core::ffi::c_int)
                            as ::core::ffi::c_char;
                    ...
                    {
                        _tmp_h2_3 = (_tmp_h2_3 as ::core::ffi::c_int - '0' as ::core::ffi::c_int)
                            as ::core::ffi::c_char;
            ...
            while (i as ::core::ffi::c_int) < trash.labelscnt as ::core::ffi::c_int {
                ...
                loop {
                    ...
                    {
                        _tmp_h1_4 = (_tmp_h1_4 as ::core::ffi::c_int - '0' as ::core::ffi::c_int)
                            as ::core::ffi::c_char;
                    ...
                    {
                        _tmp_h2_4 = (_tmp_h2_4 as ::core::ffi::c_int - '0' as ::core::ffi::c_int)
                            as ::core::ffi::c_char;
    ...
    if lv.wrapping_add(1 as uint64_t) != meta_version() {
        if lv.wrapping_add(1 as uint64_t) > meta_version() {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"desync - meta version has not been increased after the operation (%s)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                ptr,
            );
        } else {
...
pub unsafe extern "C" fn restore_file(
    ...
    let mut filename: *mut ::core::ffi::c_char = shp_get(shfilename) as *mut ::core::ffi::c_char;
    if lastv == 0 as uint64_t || v == 0 as uint64_t || lastshfn.is_null() {
        v = meta_version();
        lastv = lv.wrapping_sub(1 as uint64_t);
        lastfn = b"(no file)\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char;
    } else {
