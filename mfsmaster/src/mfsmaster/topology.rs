...
extern "C" {
    ...
    fn itree_rebalance(o: *mut ::core::ffi::c_void) -> *mut ::core::ffi::c_void;
    fn itree_add_interval(
        o: *mut ::core::ffi::c_void,
        f: uint32_t,
        t: uint32_t,
        id: uint32_t,
    ) -> *mut ::core::ffi::c_void;
    fn itree_find(o: *mut ::core::ffi::c_void, v: uint32_t) -> uint32_t;
    fn itree_freeall(o: *mut ::core::ffi::c_void);
    ...
    if rackidtabsize == 0 as uint32_t {
        ...
        if rackidtab.is_null() {
            fprintf(
                ...
                b"/tmp/moosefs-ref/mfsmaster/topology.c\0".as_ptr() as *const ::core::ffi::c_char,
    ...
    if !rname1.is_null() && !rname2.is_null() {
        ...
        loop {
            if *rname1.offset(pos as isize) as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                && *rname2.offset(pos as isize) as ::core::ffi::c_int == '|' as ::core::ffi::c_int
                || *rname1.offset(pos as isize) as ::core::ffi::c_int == '|' as ::core::ffi::c_int
                    && *rname2.offset(pos as isize) as ::core::ffi::c_int == 0 as ::core::ffi::c_int
            {
                lastbar = pos;
                break;
            } else {
    ...
    *p = 0 as ::core::ffi::c_char;
        ...
        || *p as ::core::ffi::c_int == '#' as ::core::ffi::c_int
    {
        mfs_log(
            MFSLOG_SYSLOG_STDERR,
            MFSLOG_WARNING,
            b"mfstopology: incorrect rack id in line: %u\0".as_ptr() as *const ::core::ffi::c_char,
            lineno,
        );
        return -1 as ::core::ffi::c_int;
    }
