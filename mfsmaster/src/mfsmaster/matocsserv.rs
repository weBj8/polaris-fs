...
extern "C" {
    ...
    fn csdb_new_connection(
        ip: uint32_t,
        port: uint16_t,
        csid: uint16_t,
        eptr: *mut ::core::ffi::c_void,
    ) -> *mut ::core::ffi::c_void;
    fn csdb_get_csid(v_csptr: *mut ::core::ffi::c_void) -> uint16_t;
    fn csdb_temporary_maintenance_mode(v_csptr: *mut ::core::ffi::c_void);
    fn csdb_lost_connection(v_csptr: *mut ::core::ffi::c_void);
    fn csdb_server_load(v_csptr: *mut ::core::ffi::c_void, load: uint32_t);
    fn csdb_server_is_overloaded(v_csptr: *mut ::core::ffi::c_void, now: uint32_t) -> uint8_t;
    fn csdb_server_is_being_maintained(v_csptr: *mut ::core::ffi::c_void) -> uint8_t;
    fn sclass_ec_version() -> uint8_t;
    fn chunk_got_status_data(
        chunkid: uint64_t,
    ...
    fn chunk_get_mfrstatus(csid: uint16_t) -> uint8_t;
    fn chunk_server_connected(ptr: *mut ::core::ffi::c_void) -> uint16_t;
    fn chunk_server_has_chunk(csid: uint16_t, chunkid: uint64_t, ecid: uint8_t, version: uint32_t);
    fn chunk_damaged(csid: uint16_t, chunkid: uint64_t, ecid: uint8_t);
    fn chunk_lost(csid: uint16_t, chunkid: uint64_t, ecid: uint8_t, report: uint8_t);
    fn chunk_server_register_end(csid: uint16_t);
    fn chunk_server_disconnected(csid: uint16_t);
    fn chunk_got_delete_status(csid: uint16_t, chunkid: uint64_t, ecid: uint8_t, status: uint8_t);
    fn chunk_got_replicate_status(
        csid: uint16_t,
        chunkid: uint64_t,
        ecid: uint8_t,
        version: uint32_t,
    ...
    fn chunk_got_chunkop_status(csid: uint16_t, chunkid: uint64_t, ecid: uint8_t, status: uint8_t);
    fn chunk_got_create_status(csid: uint16_t, chunkid: uint64_t, ecid: uint8_t, status: uint8_t);
    fn chunk_got_duplicate_status(
        csid: uint16_t,
        chunkid: uint64_t,
        ecid: uint8_t,
        status: uint8_t,
    );
    fn chunk_got_setversion_status(
        csid: uint16_t,
        chunkid: uint64_t,
        ecid: uint8_t,
        status: uint8_t,
    );
    fn chunk_got_truncate_status(csid: uint16_t, chunkid: uint64_t, ecid: uint8_t, status: uint8_t);
    fn chunk_got_duptrunc_status(csid: uint16_t, chunkid: uint64_t, ecid: uint8_t, status: uint8_t);
    fn chunk_got_localsplit_status(
        csid: uint16_t,
        chunkid: uint64_t,
        version: uint32_t,
        status: uint8_t,
    ...
    fn univallocstripport(ip: uint32_t, port: uint16_t) -> *mut ::core::ffi::c_char;
    ...
    fn labelmask_matches_labelexpr(labelmask: uint32_t, labelexpr: *const uint8_t) -> uint8_t;
...
unsafe extern "C" fn sizestrtod(
    ...
    {
        val *= 10.0f64;
        val += (*str as ::core::ffi::c_int - '0' as ::core::ffi::c_int) as ::core::ffi::c_double;
        str = str.offset(1);
...
pub unsafe extern "C" fn matocsserv_replication_find(
    ...
    let mut hash: uint32_t = (chunkid ^ version as uint64_t ^ chunkid >> 8 as ::core::ffi::c_int)
        ...
        if (*r).chunkid == chunkid && (*r).version == version && (*r).dst == dst {
            ...
            while !rs.is_null() {
                ...
                (*((*rsdel).src as *mut matocsserventry)).rrepcounter =
                    ((*((*rsdel).src as *mut matocsserventry)).rrepcounter as ::core::ffi::c_int
                        - (*r).rweight as ::core::ffi::c_int) as uint16_t;
                if ok != 0 {
                    (*((*rsdel).src as *mut matocsserventry)).replreadok[(*r).reason as usize] =
                        (*((*rsdel).src as *mut matocsserventry)).replreadok[(*r).reason as usize]
                            .wrapping_add((*r).rweight as uint32_t);
                } else {
                    (*((*rsdel).src as *mut matocsserventry)).replreaderr[(*r).reason as usize] =
                        (*((*rsdel).src as *mut matocsserventry)).replreaderr[(*r).reason as usize]
                            .wrapping_add((*r).rweight as uint32_t);
                }
...
pub unsafe extern "C" fn matocsserv_log_extra_info(mut fd: *mut FILE) {
    ...
    let mut hlstatus_name: *const ::core::ffi::c_char = ::core::ptr::null::<::core::ffi::c_char>();
    ...
    while !eptr.is_null() {
            ...
            && !(*eptr).csptr.is_null()
        {
            ...
            while (i as ::core::ffi::c_int) < REPL_REASONS as ::core::ffi::c_int {
                ...
                if (*eptr).lreplwriteok[i as usize] != 0 || (*eptr).lreplwriteerr[i as usize] != 0 {
                    fprintf(
                        fd,
...
unsafe extern "C" fn matocsserv_weighted_roundrobin_used(
    ...
    if fcnt > totalcnt.wrapping_mul(10 as uint32_t) {
        ...
        i = 0 as uint32_t;
        while i < cnt {
            (**servers.offset(i as isize)).create_total_counter = (**servers.offset(i as isize))
        ...
        while i < cnt {
            ...
            (**servers.offset(i as isize)).dist = cnt.wrapping_sub(i).wrapping_sub(1 as uint32_t);
            (**servers.offset(i as isize)).create_total_counter = (**servers.offset(i as isize))
                .create_total_counter
                .wrapping_add(1);
            i = i.wrapping_add(1);
...
pub unsafe extern "C" fn matocsserv_servers_matches_labelexpr(
    ...
    while !eptr.is_null() {
        if (*eptr).mode as ::core::ffi::c_int != KILL as ::core::ffi::c_int
            ...
            && !(*eptr).csptr.is_null()
        {
            if matocsserv_server_matches_labelexpr(eptr as *mut ::core::ffi::c_void, labelexpr) != 0
            {
...
pub unsafe extern "C" fn matocsserv_getservers_wrandom(
    ...
    static mut servtab: *mut *mut matocsserventry = ::core::ptr::null_mut::<*mut matocsserventry>();
    let mut eptr: *mut matocsserventry = ::core::ptr::null_mut::<matocsserventry>();
    let mut i: uint32_t = 0;
    let mut gracecnt: uint32_t = 0;
    let mut stdcnt: uint32_t = 0;
...
pub unsafe extern "C" fn matocsserv_get_server_groups(
        ...
        == counters[0 as usize] as ::core::ffi::c_int
    {
        ...
        fprintf(
            ...
            b"positions[CSSTATE_OK]==counters[CSSTATE_OK]\0".as_ptr() as *const ::core::ffi::c_char,
    ...
    if *positions.offset(1 as isize) as ::core::ffi::c_int
        == counters[0 as usize] as ::core::ffi::c_int + counters[1 as usize] as ::core::ffi::c_int
    {
    } else {
        fprintf(
            stderr,
    ...
    i = 1 as uint16_t;
    while (i as ::core::ffi::c_int) < counters[CSSTATE_OVERLOADED as usize] as ::core::ffi::c_int {
        ...
        j = (*positions.offset(CSSTATE_OK as isize) as ::core::ffi::c_int + i as ::core::ffi::c_int)
            as uint16_t;
                ...
                && !(*eptr).csptr.is_null()
            {
                ...
                's_265: {
                    match matocsserv_server_can_be_used_in_replication(eptr) as ::core::ffi::c_int {
                        2 => {
                            (*sm).replallowed = (*sm).replallowed.wrapping_add(1);
                            if datamatch as ::core::ffi::c_int & chksummatch as ::core::ffi::c_int
                                != 0
                            {
                                ...
                                (*sm).chksum_replallowed = (*sm).chksum_replallowed.wrapping_add(1);
                            }
                        }
                        1 => {}
                        _ => {
...
pub unsafe extern "C" fn matocsserv_calculate_space() {
    ...
    while !eptr.is_null() {
            ...
            && (*eptr).totalspace > 0 as uint64_t
        {
            ...
            mpusage = (100000 as ::core::ffi::c_int as ::core::ffi::c_double * dusage) as uint32_t;
    ...
    match ReserveSpaceMode as ::core::ffi::c_int {
        1 => {
            rspace = (ReserveSpaceValue * (tspace as ::core::ffi::c_double / 100.0f64)) as uint64_t;
        }
        2 => {
...
pub unsafe extern "C" fn matocsserv_hlstatus_fix() {
    ...
    while !eptr.is_null() {
            ...
            && !(*eptr).csptr.is_null()
        {
            ...
            {
                if csdb_server_is_overloaded((*eptr).csptr as *mut ::core::ffi::c_void, now) != 0 {
...
pub unsafe extern "C" fn matocsserv_got_chunk_checksum(
    ...
    chunkid =
        (chunkid as ::core::ffi::c_ulong & 0xffffffffffffff as ::core::ffi::c_ulong) as uint64_t;
...
pub unsafe extern "C" fn matocsserv_broadcast_chunk_status(mut chunkid: uint64_t) {
    ...
    if ChunkServerCheck as ::core::ffi::c_int > 0 as ::core::ffi::c_int {
        ...
        while !eptr.is_null() {
            ...
            {
                data =
                    matocsserv_create_packet(eptr, MATOCS_CHUNK_STATUS as uint32_t, 8 as uint32_t);
...
pub unsafe extern "C" fn matocsserv_got_chunk_status(
        ...
        || length.wrapping_div(8 as uint32_t) > 256 as uint32_t
    {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CSTOMA_CHUNK_STATUS - wrong size (%u/8+8*n)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matocsserv_got_createchunk_status(
    ...
    if status as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_NOTICE,
            b"(%s) chunk: %016lX%s creation status: %s\0".as_ptr() as *const ::core::ffi::c_char,
            (*eptr).servdesc,
            chunkid,
            matocsserv_ecid_to_str(ecid),
            mfsstrerr(status),
...
pub unsafe extern "C" fn matocsserv_got_deletechunk_status(
    ...
    if status as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_NOTICE,
            b"(%s) chunk: %016lX%s deletion status: %s\0".as_ptr() as *const ::core::ffi::c_char,
            (*eptr).servdesc,
            chunkid,
            matocsserv_ecid_to_str(ecid),
            mfsstrerr(status),
...
pub unsafe extern "C" fn matocsserv_send_replicatechunk(
    ...
    dstchunkid =
        chunkid & 0xffffffffffffff as uint64_t | (ecid as uint64_t) << 56 as ::core::ffi::c_int;
    if matocsserv_replication_find(dstchunkid, version, dsteptr as *mut ::core::ffi::c_void) != 0 {
        return -1 as ::core::ffi::c_int;
    }
...
pub unsafe extern "C" fn matocsserv_got_setchunkversion_status(
    ...
    if status as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_NOTICE,
            b"(%s) chunk: %016lX%s set version status: %s\0".as_ptr() as *const ::core::ffi::c_char,
            (*eptr).servdesc,
            chunkid,
            matocsserv_ecid_to_str(ecid),
            mfsstrerr(status),
...
pub unsafe extern "C" fn matocsserv_got_duplicatechunk_status(
    ...
    if status as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_NOTICE,
            b"(%s) chunk: %016lX%s duplication status: %s\0".as_ptr() as *const ::core::ffi::c_char,
            (*eptr).servdesc,
            chunkid,
            matocsserv_ecid_to_str(ecid),
            mfsstrerr(status),
...
pub unsafe extern "C" fn matocsserv_got_truncatechunk_status(
    ...
    if status as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_NOTICE,
            b"(%s) chunk: %016lX%s truncate status: %s\0".as_ptr() as *const ::core::ffi::c_char,
            (*eptr).servdesc,
            chunkid,
            matocsserv_ecid_to_str(ecid),
            mfsstrerr(status),
...
pub unsafe extern "C" fn matocsserv_send_localsplitchunk(
    ...
    if (*eptr).mode as ::core::ffi::c_int != KILL as ::core::ffi::c_int {
        ...
        matocsserv_replication_begin(
            ...
            &raw mut e,
            FULL_REPLICATION_WEIGHT as uint8_t,
            (LOCALPART_REPLICATION_WEIGHT * bitcount(missingmask) as ::core::ffi::c_int) as uint8_t,
...
pub unsafe extern "C" fn matocsserv_got_localsplitchunk_status(
    ...
    if status as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_NOTICE,
            b"(%s) chunk: %016lX localsplit status: %s\0".as_ptr() as *const ::core::ffi::c_char,
            (*eptr).servdesc,
            chunkid,
            mfsstrerr(status),
        );
...
pub unsafe extern "C" fn matocsserv_got_chunkop_status(
    ...
    copychunkid = (copychunkid as ::core::ffi::c_ulong & 0xffffffffffffff as ::core::ffi::c_ulong)
        as uint64_t;
...
pub unsafe extern "C" fn matocsserv_get_config_file(
    ...
    if fdata.is_null() {
        ptr = matocsserv_create_packet(eptr, ANTOAN_CONFIG_FILE_CONTENT as uint32_t, 5 as uint32_t);
        put32bit(&raw mut ptr, msgid);
    ...
    if length & 1 as uint32_t == 0 as uint32_t {
        ...
        if rversion as ::core::ffi::c_int == 60 as ::core::ffi::c_int {
                ...
                if length == 55 as uint32_t {
                        ...
                        == 0 as ::core::ffi::c_int
                    {
                        mfs_log(
                            MFSLOG_SYSLOG,
                            MFSLOG_WARNING,
                            b"CSTOMA_REGISTER (BEGIN) - access denied - check password\0".as_ptr()
                                as *const ::core::ffi::c_char,
                        );
                        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
                        return;
                    ...
                    })) as uint32_t
            {
                ...
                p_1 = matocsserv_create_packet(eptr, MATOCS_MASTER_ACK as uint32_t, 1 as uint32_t);
            ...
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_INFO,
                b"chunkserver %s graceful disconnection\0".as_ptr() as *const ::core::ffi::c_char,
                (*eptr).servdesc,
            );
            if !(*eptr).csptr.is_null() {
...
pub unsafe extern "C" fn matocsserv_current_load(
    ...
    if length < 4 as uint32_t || length > 6 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CSTOMA_CURRENT_LOAD - wrong size (%u/4-6)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matocsserv_chunk_damaged(
    ...
    if length.wrapping_rem(8 as uint32_t) != 0 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CSTOMA_CHUNK_DAMAGED - wrong size (%u/N*8)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matocsserv_chunks_lost(
    ...
    receivingchunks = (receivingchunks as ::core::ffi::c_int | TRANSFERRING_LOST_CHUNKS) as uint8_t;
    i = 0 as uint32_t;
    while i < length.wrapping_div(8 as uint32_t) {
        chunkid = get64bit(&raw mut data);
        ecid = (chunkid >> 56 as ::core::ffi::c_int) as uint8_t;
...
pub unsafe extern "C" fn matocsserv_chunks_new(
    ...
    receivingchunks = (receivingchunks as ::core::ffi::c_int | TRANSFERRING_NEW_CHUNKS) as uint8_t;
    i = 0 as uint32_t;
...
pub unsafe extern "C" fn matocsserv_error_occurred(
    ...
    if length != 0 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CSTOMA_ERROR_OCCURRED - wrong size (%u/0)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matocsserv_broadcast_regfirst_chunk(mut chunkid: uint64_t) {
    ...
    while !eptr.is_null() {
        ...
        {
            data = matocsserv_create_packet(eptr, MATOCS_REGISTER_FIRST as uint32_t, 8 as uint32_t);
            put64bit(&raw mut data, chunkid);
        }
        eptr = (*eptr).next as *mut matocsserventry;
    }
    ...
    if ForceTimeout > 0 as uint32_t {
        ...
        while !eptr.is_null() {
                        ...
                        })) as uint32_t
            {
                ...
                data =
                    matocsserv_create_packet(eptr, ANTOAN_FORCE_TIMEOUT as uint32_t, 2 as uint32_t);
...
pub unsafe extern "C" fn matocsserv_term() {
    ...
    mfs_log(
        MFSLOG_SYSLOG,
        MFSLOG_INFO,
        b"master <-> chunkservers module: closing %s:%s\0".as_ptr() as *const ::core::ffi::c_char,
        ListenHost,
        ListenPort,
    );
    tcpclose(lsock);
...
pub unsafe extern "C" fn matocsserv_reload_common() {
    ...
    let mut reservespace: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
...
pub unsafe extern "C" fn matocsserv_init() -> ::core::ffi::c_int {
    ...
    mfs_log(
        MFSLOG_SYSLOG_STDERR,
        MFSLOG_INFO,
        b"master <-> chunkservers module: listen on %s:%s\0".as_ptr() as *const ::core::ffi::c_char,
        ListenHost,
        ListenPort,
    );
