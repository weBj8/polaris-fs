...
unsafe extern "C" {
    ...
    unsafe fn mkstemp(__template: *mut ::core::ffi::c_char) -> ::core::ffi::c_int;
    unsafe fn memcpy(
    ...
    unsafe fn rewinddir(__dirp: *mut DIR);
    ...
    unsafe fn bio_null_open(direction: uint8_t) -> *mut bio;
    unsafe fn bio_file_open(
        fname: *const ::core::ffi::c_char,
        direction: uint8_t,
        buffersize: uint32_t,
    ) -> *mut bio;
    unsafe fn bio_file_position(b: *mut bio) -> uint64_t;
    unsafe fn bio_file_size(b: *mut bio) -> uint64_t;
    unsafe fn bio_crc(b: *mut bio) -> uint32_t;
    ...
    unsafe fn bio_seek(b: *mut bio, offset: int64_t, whence: ::core::ffi::c_int) -> int8_t;
    unsafe fn bio_skip(b: *mut bio, len: uint64_t);
    unsafe fn bio_error(b: *mut bio) -> uint8_t;
    unsafe fn bio_lasterrno(b: *mut bio) -> ::core::ffi::c_int;
    unsafe fn bio_descriptor(b: *mut bio) -> ::core::ffi::c_int;
    unsafe fn bio_sync(b: *mut bio);
    unsafe fn bio_close(b: *mut bio);
    unsafe fn sessions_cleanup();
    unsafe fn sessions_init() -> ::core::ffi::c_int;
    unsafe fn sessions_new();
    unsafe fn sessions_store(fd: *mut bio) -> uint8_t;
    unsafe fn sessions_load(fd: *mut bio, mver: uint8_t) -> ::core::ffi::c_int;
    unsafe fn sessions_import();
    unsafe fn sessions_set_nextsessionid(nsi: uint32_t);
    unsafe fn dict_init() -> ::core::ffi::c_int;
    unsafe fn dict_cleanup();
    unsafe fn xattr_cleanup();
    unsafe fn xattr_store(fd: *mut bio) -> uint8_t;
    unsafe fn xattr_load(
        fd: *mut bio,
        mver: uint8_t,
        ignoreflag_0: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
    unsafe fn xattr_init() -> ::core::ffi::c_int;
    unsafe fn posix_acl_cleanup();
    unsafe fn posix_acl_store(fd: *mut bio) -> uint8_t;
    unsafe fn posix_acl_load(
        fd: *mut bio,
        mver: uint8_t,
        ignoreflag_0: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
    unsafe fn posix_acl_init() -> ::core::ffi::c_int;
    unsafe fn flock_store(fd: *mut bio) -> uint8_t;
    unsafe fn flock_load(fd: *mut bio, mver: uint8_t, ignoreflag_0: uint8_t) -> ::core::ffi::c_int;
    unsafe fn flock_cleanup();
    unsafe fn flock_init() -> ::core::ffi::c_int;
    unsafe fn posix_lock_store(fd: *mut bio) -> uint8_t;
    unsafe fn posix_lock_load(
        fd: *mut bio,
        mver: uint8_t,
        ignoreflag_0: uint8_t,
    ) -> ::core::ffi::c_int;
    unsafe fn posix_lock_cleanup();
    unsafe fn posix_lock_init() -> ::core::ffi::c_int;
    unsafe fn of_store(fd: *mut bio) -> uint8_t;
    unsafe fn of_load(fd: *mut bio, mver: uint8_t) -> ::core::ffi::c_int;
    unsafe fn of_cleanup();
    unsafe fn of_init() -> ::core::ffi::c_int;
    unsafe fn csdb_cleanup();
    unsafe fn csdb_store(fd: *mut bio) -> uint8_t;
    unsafe fn csdb_load(
        fd: *mut bio,
        mver: uint8_t,
        ignoreflag_0: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
    unsafe fn csdb_init() -> ::core::ffi::c_int;
    unsafe fn sclass_store(fd: *mut bio) -> uint8_t;
    unsafe fn sclass_load(
        fd: *mut bio,
        mver: uint8_t,
        ignoreflag_0: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
    unsafe fn sclass_new();
    unsafe fn sclass_cleanup();
    unsafe fn sclass_init() -> ::core::ffi::c_int;
    unsafe fn patterns_cleanup();
    unsafe fn patterns_store(fd: *mut bio) -> uint8_t;
    unsafe fn patterns_load(
        fd: *mut bio,
        mver: uint8_t,
        ignoreflag_0: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
    unsafe fn patterns_init() -> ::core::ffi::c_int;
    unsafe fn chunk_is_afterload_needed(mver: uint8_t) -> uint8_t;
    unsafe fn chunk_load(
        fd: *mut bio,
        mver: uint8_t,
        ignoreflag_0: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
    unsafe fn chunk_store(fd: *mut bio) -> uint8_t;
    unsafe fn chunk_cleanup();
    unsafe fn chunk_newfs();
    unsafe fn chunk_strinit() -> ::core::ffi::c_int;
    unsafe fn fs_set_root_times(ts: uint32_t) -> ::core::ffi::c_int;
    unsafe fn fs_new();
    unsafe fn fs_cleanup();
    unsafe fn fs_printinfo();
    unsafe fn fs_afterload();
    unsafe fn fs_check_consistency(ignoreflag_0: ::core::ffi::c_int) -> ::core::ffi::c_int;
    unsafe fn fs_importnodes(
        fd: *mut bio,
        maxnodeid: uint32_t,
        ignoreflag_0: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
    unsafe fn fs_loadnodes(
        fd: *mut bio,
        mver: uint8_t,
        ignoreflag_0: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
    unsafe fn fs_loadedges(
        fd: *mut bio,
        mver: uint8_t,
        ignoreflag_0: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
    unsafe fn fs_loadfree(
        fd: *mut bio,
        mver: uint8_t,
        ignoreflag_0: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
    unsafe fn fs_loadquota(
        fd: *mut bio,
        mver: uint8_t,
        ignoreflag_0: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
    unsafe fn fs_storenodes(fd: *mut bio) -> uint8_t;
    unsafe fn fs_storeedges(fd: *mut bio) -> uint8_t;
    unsafe fn fs_storefree(fd: *mut bio) -> uint8_t;
    unsafe fn fs_storequota(fd: *mut bio) -> uint8_t;
    unsafe fn fs_renumerate_edge_test();
    unsafe fn fs_strinit() -> ::core::ffi::c_int;
    ...
    unsafe fn merger_loop(verblevel: uint8_t) -> ::core::ffi::c_int;
    unsafe fn changelog_rotate(rotate_flags: uint8_t);
    unsafe fn changelog(format: *const ::core::ffi::c_char, ...);
    unsafe fn changelog_findfirstversion(fname: *const ::core::ffi::c_char) -> uint64_t;
    unsafe fn changelog_findlastversion(fname: *const ::core::ffi::c_char) -> uint64_t;
    unsafe fn changelog_checkname(fname: *const ::core::ffi::c_char) -> ::core::ffi::c_int;
    unsafe fn monotonic_seconds() -> ::core::ffi::c_double;
    unsafe fn monotonic_useconds() -> uint64_t;
    unsafe fn matoclserv_close_lsock();
    unsafe fn matocsserv_close_lsock();
    unsafe fn matomlserv_close_lsock();
    ...
    unsafe fn main_mayexit_register_fname(
    ...
    unsafe {
        ...
        if storefn.is_none() {
            ...
            hdr[5 as usize] = ('0' as ::core::ffi::c_int
                + (mver as ::core::ffi::c_int >> 4 as ::core::ffi::c_int
        ...
        if (fver as ::core::ffi::c_int) < 0x16 as ::core::ffi::c_int {
            ...
            loop {
                ...
                ) == 0 as ::core::ffi::c_int
                {
                        ...
                        < 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            MFSLOG_SYSLOG,
                            MFSLOG_ERR,
                            b"error reading metadata (edge)\0".as_ptr()
                                as *const ::core::ffi::c_char,
                        );
                        return -1 as ::core::ffi::c_int;
                    }
                ...
                ) == 0 as ::core::ffi::c_int
                {
                    ...
                    fprintf(
                        stderr,
                        b"loading deletion timestamps ... \0".as_ptr()
                            as *const ::core::ffi::c_char,
                    );
                    fflush(stderr);
                    if fs_loadfree(fd, mver, ignoreflag as ::core::ffi::c_int)
                        < 0 as ::core::ffi::c_int
                    {
                        fprintf(stderr, b"error\n\0".as_ptr() as *const ::core::ffi::c_char);
                        mfs_log(
                            MFSLOG_SYSLOG,
                            MFSLOG_ERR,
                            b"error reading metadata (free)\0".as_ptr()
                                as *const ::core::ffi::c_char,
                        );
                        return -1 as ::core::ffi::c_int;
                    }
                ...
                ) == 0 as ::core::ffi::c_int
                {
                        ...
                        < 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            MFSLOG_SYSLOG,
                            MFSLOG_ERR,
                            b"error reading metadata (quota)\0".as_ptr()
                                as *const ::core::ffi::c_char,
                        );
                        return -1 as ::core::ffi::c_int;
                    }
                ...
                ) == 0 as ::core::ffi::c_int
                {
                    ...
                    fflush(stderr);
                    if xattr_load(fd, mver, ignoreflag as ::core::ffi::c_int)
                        < 0 as ::core::ffi::c_int
                    {
                        fprintf(stderr, b"error\n\0".as_ptr() as *const ::core::ffi::c_char);
                        mfs_log(
                            MFSLOG_SYSLOG,
                            MFSLOG_ERR,
                            b"error reading metadata (xattr)\0".as_ptr()
                                as *const ::core::ffi::c_char,
                        );
                        return -1 as ::core::ffi::c_int;
                    }
                ...
                ) == 0 as ::core::ffi::c_int
                {
                    ...
                    fflush(stderr);
                    if csdb_load(fd, mver, ignoreflag as ::core::ffi::c_int)
                        < 0 as ::core::ffi::c_int
                    {
                        fprintf(stderr, b"error\n\0".as_ptr() as *const ::core::ffi::c_char);
                        mfs_log(
                            MFSLOG_SYSLOG,
                            MFSLOG_ERR,
                            b"error reading metadata (csdb)\0".as_ptr()
                                as *const ::core::ffi::c_char,
                        );
                        return -1 as ::core::ffi::c_int;
                    }
                    ...
                    ) == 0 as ::core::ffi::c_int
                {
                    ...
                    fprintf(
                        stderr,
                        b"loading storage classes data ... \0".as_ptr()
                            as *const ::core::ffi::c_char,
                    );
                    fflush(stderr);
                    if sclass_load(fd, mver, ignoreflag as ::core::ffi::c_int)
                        < 0 as ::core::ffi::c_int
                    {
                        fprintf(stderr, b"error\n\0".as_ptr() as *const ::core::ffi::c_char);
                        mfs_log(
                ...
                ) == 0 as ::core::ffi::c_int
                {
                    ...
                    fflush(stderr);
                    if chunk_load(fd, mver, ignoreflag as ::core::ffi::c_int)
                        < 0 as ::core::ffi::c_int
                    {
                        fprintf(stderr, b"error\n\0".as_ptr() as *const ::core::ffi::c_char);
                        mfs_log(
                            MFSLOG_SYSLOG,
                            MFSLOG_ERR,
                            b"error reading metadata (chunks)\0".as_ptr()
                                as *const ::core::ffi::c_char,
                        );
                        return -1 as ::core::ffi::c_int;
                    }
                        ...
                        && (offbegin as uint64_t).wrapping_add(sleng) != bio_file_position(fd)
                    {
                        if ignoreflag != 0 {
                            mfs_log(
                                MFSLOG_SYSLOG_STDERR,
                                MFSLOG_NOTICE,
                                b"not all section has been read - file corrupted - ignoring\0"
                                    .as_ptr()
                                    as *const ::core::ffi::c_char,
                            );
                        } else {
        ...
        if crcfd.is_null() {
            ...
            if crcdata.is_null() {
                fprintf(
                    ...
                    b"/tmp/moosefs-ref/mfsmaster/metadata.c\0".as_ptr()
                        as *const ::core::ffi::c_char,
        ...
        if metasaverkilled != 0 {
            ...
            if chstatus == 1 as ::core::ffi::c_int {
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_ERR,
                    b"metadata stored in emergency mode (in non-standard location) - exiting\0"
                        .as_ptr() as *const ::core::ffi::c_char,
                );
                main_exit();
    ...
    unsafe {
        ...
        if bg != 0 {
            ...
            if i < 0 as ::core::ffi::c_int {
                ...
                processname_set(b"mfsmaster (metadata saver)\0".as_ptr()
                    as *const ::core::ffi::c_char
                    ...
                    && *__errno_location() == ENOENT
                {
                    ...
                    if fd < 0 as ::core::ffi::c_int {
                        mfs_log(
                            MFSLOG_ERRNO_SYSLOG_STDERR,
                            MFSLOG_ERR,
                            b"can't create temporary file %s\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            name,
                        );
                    ...
                    ) < 0 as ::core::ffi::c_int
                    {
                        mfs_log(
                            MFSLOG_ERRNO_SYSLOG_STDERR,
                            MFSLOG_ERR,
                            b"can't rename metadata.mfs -> %s\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            name,
                        );
                        close(fd);
    ...
    unsafe {
        ...
        if MetaSaveOffset > (60 as ::core::ffi::c_int * 24 as ::core::ffi::c_int) as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG_STDERR,
                MFSLOG_WARNING,
                b"METADATA_SAVE_OFFSET is higher than 24 hours - using value modulo 24 hours\0"
                    .as_ptr() as *const ::core::ffi::c_char,
            );
