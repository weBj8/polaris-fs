...
extern "C" {
    ...
    fn csipmap_map(servip: uint32_t, clientip: uint32_t) -> uint32_t;
    fn csipmap_loadmap(fname: *const ::core::ffi::c_char);
    fn csipmap_term();
    fn csipmap_init() -> ::core::ffi::c_int;
}
...
pub unsafe extern "C" fn multilan_reload() {
    ...
    let mut ipmapfname: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
            ...
            match err as ::core::ffi::c_int {
                1 => {
                    mfs_log(
                        MFSLOG_SYSLOG_STDERR,
                        MFSLOG_WARNING,
                        b"error parsing ip class from MULTILAN_CLASSES - octet>255 (%s)\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        netstr,
                    );
                }
    ...
    ipmapfname = cfg_getstr(
        ...
        b"/home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/etc/mfs/mfsipmap.cfg\0"
            .as_ptr() as *const ::core::ffi::c_char,
    );
