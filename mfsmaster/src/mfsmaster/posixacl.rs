...
unsafe extern "C" {
    ...
    unsafe fn fs_set_aclflag(inode: uint32_t, acltype: uint8_t);
    unsafe fn fs_del_aclflag(inode: uint32_t, acltype: uint8_t);
    unsafe fn fs_get_mode(inode: uint32_t) -> uint16_t;
    unsafe fn mmap(
...
unsafe extern "C" fn posix_acl_xxx_hash_move() {
    unsafe {
        ...
        loop {
            ...
            ehptr = paclhashtab[(paclrehashpos
                .wrapping_sub(paclhashsize.wrapping_div(2 as uint32_t))
...
pub unsafe extern "C" fn posix_acl_getmode(mut inode: uint32_t) -> uint16_t {
    unsafe {
        ...
        return (((*acn).userperm as ::core::ffi::c_int & 7 as ::core::ffi::c_int)
            << 6 as ::core::ffi::c_int
            | ((*acn).mask as ::core::ffi::c_int & 7 as ::core::ffi::c_int)
                << 3 as ::core::ffi::c_int
            ...
            && (*pacn).mask as ::core::ffi::c_int == 0xffff as ::core::ffi::c_int
        {
            *mode = (*mode as ::core::ffi::c_int
            ...
            (*acn).otherperm = ((*acn).otherperm as ::core::ffi::c_int
                ...
                as uint16_t;
            (*acn).otherperm = ((*acn).otherperm as ::core::ffi::c_int
                & (*pacn).otherperm as ::core::ffi::c_int)
                as uint16_t;
            (*acn).mask =
                ((*acn).mask as ::core::ffi::c_int & 0xfff8 as ::core::ffi::c_int) as uint16_t;
            (*acn).mask = ((*acn).mask as ::core::ffi::c_int
                | *mode as ::core::ffi::c_int >> 3 as ::core::ffi::c_int & 7 as ::core::ffi::c_int)
                as uint16_t;
            (*acn).mask = ((*acn).mask as ::core::ffi::c_int & (*pacn).mask as ::core::ffi::c_int)
                as uint16_t;
            *mode = (*mode as ::core::ffi::c_int & 0xfe00 as ::core::ffi::c_int
            ...
            while i < acls {
                ...
                (*(*acn).acltab.offset(i as isize)).perm =
                    (*(*pacn).acltab.offset(i as isize)).perm;
                i = i.wrapping_add(1);
            }
        }
        if directory != 0 {
        ...
        while i < HASHTAB_HISIZE as uint32_t {
            if !paclhashtab[i as usize].is_null() {
                ...
                while j < HASHTAB_LOSIZE as uint32_t {
                    ...
                    *paclhashtab[i as usize].offset(j as isize) =
                        ::core::ptr::null_mut::<acl_node>();
                    j = j.wrapping_add(1);
                }
            }
                                ...
                                .wrapping_add((*acn).namedgroups as uint32_t)
                        {
                            if acbcnt == 100 as uint32_t {
                                if bio_write(
                                    ...
                                    (6 as ::core::ffi::c_int * 100 as ::core::ffi::c_int)
                                        as uint64_t,
                                ) != (6 as ::core::ffi::c_int * 100 as ::core::ffi::c_int)
                                    as int64_t
                                {
                ...
                && acltype as ::core::ffi::c_int != POSIX_ACL_DEFAULT
            {
                ...
                if ignoreflag != 0 {
                    ...
                    mfs_log(
                        MFSLOG_SYSLOG_STDERR,
                        MFSLOG_ERR,
                        b"loading posix_acl: wrong acl type\0".as_ptr()
                            as *const ::core::ffi::c_char,
                    );
                    return -1 as ::core::ffi::c_int;
                }
                ...
                if !acn.is_null() {
                    ...
                    if ignoreflag != 0 {
                        ...
                        mfs_log(
                            MFSLOG_SYSLOG_STDERR,
                            MFSLOG_ERR,
                            b"loading posix_acl: repeated acl\0".as_ptr()
                                as *const ::core::ffi::c_char,
                        );
                        return -1 as ::core::ffi::c_int;
                    }
                        ...
                        && mask as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                    {
                        ...
                        userperm = (userperm as ::core::ffi::c_int & 0xfff8 as ::core::ffi::c_int)
                            as uint16_t;
