...
extern "C" {
    ...
    fn meta_chlog_keep_version() -> uint64_t;
    fn mfs_log(
        mode: ::core::ffi::c_int,
    ...
    fn bgsaver_changelog(version: uint64_t, message: *const ::core::ffi::c_char);
    fn bgsaver_rotatelog() -> ::core::ffi::c_int;
    ...
    fn matomlserv_get_min_version() -> uint64_t;
    fn matomlserv_broadcast_logstring(
        version: uint64_t,
        logstr: *mut uint8_t,
        logstrsize: uint32_t,
    );
    fn matomlserv_broadcast_logrotate();
    fn cfg_getuint8(name: *const ::core::ffi::c_char, def: uint8_t) -> uint8_t;
    fn cfg_getuint16(name: *const ::core::ffi::c_char, def: uint16_t) -> uint16_t;
...
unsafe extern "C" fn changelog_store_logstring(
    ...
    oce =
        (&raw mut (*oc).old_changes_block as *mut old_changes_entry).offset((*oc).entries as isize);
    (*oce).version = version;
...
pub unsafe extern "C" fn changelog_get_old_changes(
    ...
    while !oc.is_null() {
        ...
        if start != 0 {
            ...
            while i < (*oc).entries {
                oce =
                    (&raw mut (*oc).old_changes_block as *mut old_changes_entry).offset(i as isize);
...
pub unsafe extern "C" fn changelog_generate_gids(
    ...
    static mut gidstr: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
...
pub unsafe extern "C" fn changelog_escape_name(
    ...
    let mut currescname: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
    let mut i: uint32_t = 0;
    let mut c: uint8_t = 0;
...
pub unsafe extern "C" fn changelog_findlastversion(
    ...
    while size > 0 as uint64_t && size.wrapping_add(200000 as uint64_t) > st.st_size as uint64_t {
        if size > 32768 as uint64_t {
            ...
            memmove(
                (&raw mut buff as *mut uint8_t).offset(size as isize) as *mut ::core::ffi::c_void,
                &raw mut buff as *mut uint8_t as *const ::core::ffi::c_void,
                32 as size_t,
            );
                ...
                || size.wrapping_add(buffpos as uint64_t) == 0 as uint64_t
            {
                if lastnewline == 0 as uint64_t {
                    ...
                    while buffpos < 32800 as uint32_t
                        && buff[buffpos as usize] as ::core::ffi::c_int >= '0' as ::core::ffi::c_int
                        && buff[buffpos as usize] as ::core::ffi::c_int <= '9' as ::core::ffi::c_int
                    {
                    ...
                    if buffpos == 32800 as uint32_t
                        || buff[buffpos as usize] as ::core::ffi::c_int != ':' as ::core::ffi::c_int
                    {
                        lv = 0 as uint64_t;
                    }
                    close(fd);
