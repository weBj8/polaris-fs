...
extern "C" {
    ...
    fn fs_set_xattrflag(inode: uint32_t);
    fn fs_del_xattrflag(inode: uint32_t);
    fn dict_search(data: *const uint8_t, leng: uint32_t) -> *mut ::core::ffi::c_void;
    fn dict_insert(data: *const uint8_t, leng: uint32_t) -> *mut ::core::ffi::c_void;
    fn dict_get_ptr(dptr: *mut ::core::ffi::c_void) -> *const uint8_t;
    fn dict_get_leng(dptr: *mut ::core::ffi::c_void) -> uint32_t;
    fn dict_dec_ref(dptr: *mut ::core::ffi::c_void);
    fn dict_inc_ref(dptr: *mut ::core::ffi::c_void);
}
    ...
    while (i as ::core::ffi::c_uint) < HASHTAB_HISIZE {
        if !xattrhashtab[i as usize].is_null() {
            ...
            munmap(
                ...
                ::core::mem::size_of::<*mut xattrentry>().wrapping_mul(HASHTAB_LOSIZE as size_t),
            );
        }
        xattrhashtab[i as usize] = ::core::ptr::null_mut::<*mut xattrentry>();
        i = i.wrapping_add(1);
...
pub unsafe extern "C" fn xattr_setattr(
    ...
    let mut dictvalue: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<::core::ffi::c_void>();
    ...
    loop {
        ...
        inode_anleng =
            inode_anleng.wrapping_add(dict_get_leng((*xp).dictname).wrapping_add(1 as uint32_t));
...
pub unsafe extern "C" fn xattr_store(mut fd: *mut bio) -> uint8_t {
    ...
    if bio_write(
        fd,
        &raw mut hdrbuff as *mut uint8_t as *const ::core::ffi::c_void,
        (4 as ::core::ffi::c_int + 1 as ::core::ffi::c_int + 4 as ::core::ffi::c_int) as uint64_t,
    ) != (4 as ::core::ffi::c_int + 1 as ::core::ffi::c_int + 4 as ::core::ffi::c_int) as int64_t
    {
        return 0xff as uint8_t;
    }
    return 0 as uint8_t;
