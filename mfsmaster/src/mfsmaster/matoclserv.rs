...
extern "C" {
    ...
    fn sclass_maskorgroup_to_labelexpr(
        labelexpr: *mut [uint8_t; 128],
        labelmasks: *mut uint32_t,
        labelscnt: uint8_t,
    );
    fn sclass_labelexpr_to_maskorgroup(
        labelmasks: *mut uint32_t,
        labelexpr: *mut [uint8_t; 128],
        labelscnt: uint8_t,
    ) -> uint8_t;
    fn sclass_ec_version() -> uint8_t;
    fn sclass_info(buff: *mut uint8_t, fver: uint8_t) -> uint32_t;
    fn sclass_create_entry(
        nleng: uint8_t,
        name: *const uint8_t,
        dleng: uint8_t,
        desc: *const uint8_t,
    ...
    fn sclass_delete_entry(nleng: uint8_t, name: *const uint8_t) -> uint8_t;
    fn sclass_duplicate_entry(
        oldnleng: uint8_t,
        oldname: *const uint8_t,
        newnleng: uint8_t,
        newname: *const uint8_t,
    ) -> uint8_t;
    fn sclass_rename_entry(
        oldnleng: uint8_t,
        oldname: *const uint8_t,
        newnleng: uint8_t,
        newname: *const uint8_t,
    ) -> uint8_t;
    fn sclass_list_entries(buff: *mut uint8_t, sclsmode: uint8_t) -> uint32_t;
    ...
    fn chunk_store_info(buff: *mut uint8_t) -> uint32_t;
    fn chunk_store_chunkcounters(buff: *mut uint8_t, matrixid: uint8_t, classid: int16_t);
    fn chunk_info(
    ...
    fn chunk_counters_in_progress() -> uint8_t;
    fn chunk_locked_or_busy(cptr: *mut ::core::ffi::c_void) -> ::core::ffi::c_int;
    fn chunk_get_version_and_csdata(
        mode: uint8_t,
        chunkid: uint64_t,
        clientip: uint32_t,
    ...
    fn chunk_get_version_and_copies(
        mode: uint8_t,
        chunkid: uint64_t,
        clientip: uint32_t,
        version: *mut uint32_t,
    ...
    fn chunk_get_version(chunkid: uint64_t, version: *mut uint32_t) -> uint8_t;
    fn chunk_get_memusage(allocated: *mut uint64_t, used: *mut uint64_t);
    fn matomlserv_mloglist_size() -> uint32_t;
    fn matomlserv_mloglist_data(ptr: *mut uint8_t);
    fn sessions_attach_session(
        vsesdata: *mut ::core::ffi::c_void,
        peerip: uint32_t,
        version: uint32_t,
    );
    fn sessions_close_session(vsesdata: *mut ::core::ffi::c_void);
    fn sessions_disconnection(vsesdata: *mut ::core::ffi::c_void);
    fn sessions_find_session(sessionid: uint32_t) -> *mut ::core::ffi::c_void;
    fn sessions_datasize(vmode: uint8_t) -> uint32_t;
    fn sessions_datafill(ptr: *mut uint8_t, vmode: uint8_t);
    fn sessions_force_remove(sessionid: uint32_t) -> uint8_t;
    fn sessions_new_session(
    ...
    fn sessions_get_id(vsesdata: *mut ::core::ffi::c_void) -> uint32_t;
    fn sessions_get_exportscsum(vsesdata: *mut ::core::ffi::c_void) -> uint64_t;
    fn sessions_get_peerip(vsesdata: *mut ::core::ffi::c_void) -> uint32_t;
    fn sessions_get_rootinode(vsesdata: *mut ::core::ffi::c_void) -> uint32_t;
    fn sessions_get_sesflags(vsesdata: *mut ::core::ffi::c_void) -> uint32_t;
    fn sessions_get_umask(vsesdata: *mut ::core::ffi::c_void) -> uint16_t;
    fn sessions_get_disables(vsesdata: *mut ::core::ffi::c_void) -> uint32_t;
    fn sessions_is_root_remapped(vsesdata: *mut ::core::ffi::c_void) -> uint8_t;
    fn sessions_check_sclass(
        vsesdata: *mut ::core::ffi::c_void,
        smode: uint8_t,
        sclassid: uint8_t,
    ) -> uint8_t;
    fn sessions_check_trashretention(
        vsesdata: *mut ::core::ffi::c_void,
        smode: uint8_t,
        trashretention: uint32_t,
    ) -> uint8_t;
    fn sessions_inc_stats(vsesdata: *mut ::core::ffi::c_void, statid: uint8_t);
    fn sessions_add_stats(vsesdata: *mut ::core::ffi::c_void, statid: uint8_t, value: uint64_t);
    fn sessions_ugid_remap(
        vsesdata: *mut ::core::ffi::c_void,
        auid: *mut uint32_t,
        agid: *mut uint32_t,
    );
    fn csdb_servlist_data(mode: uint8_t, ptr: *mut uint8_t, clientip: uint32_t) -> uint32_t;
    fn csdb_remove_server(ip: uint32_t, port: uint16_t) -> uint8_t;
    fn csdb_back_to_work(ip: uint32_t, port: uint16_t) -> uint8_t;
    fn csdb_maintenance(ip: uint32_t, port: uint16_t, onoff: uint8_t) -> uint8_t;
    fn fs_info(
    ...
    fn fs_getrootinode(rootinode: *mut uint32_t, path: *const uint8_t) -> uint8_t;
    fn fs_path_lookup(
        rootinode: uint32_t,
        sesflags: uint8_t,
        base_inode: uint32_t,
    ...
    fn fs_set_additional_attributes(
        rootinode: uint32_t,
        sesflags: uint8_t,
        inode: uint32_t,
        flags: uint8_t,
    ...
    fn fs_end_setlength(chunkid: uint64_t) -> uint8_t;
    fn fs_do_setlength(
        rootinode: uint32_t,
        sesflags: uint8_t,
        inode: uint32_t,
    ...
    fn fs_gettrashretention_prepare(
        rootinode: uint32_t,
        sesflags: uint8_t,
        inode: uint32_t,
        gmode: uint8_t,
    ...
    fn fs_gettrashretention_store(
        fptr: *mut ::core::ffi::c_void,
        dptr: *mut ::core::ffi::c_void,
        buff: *mut uint8_t,
    );
    fn fs_settrashretention(
        rootinode: uint32_t,
        sesflags: uint8_t,
        inode: uint32_t,
        uid: uint32_t,
    ...
    fn fs_listxattr_data(xanode: *mut ::core::ffi::c_void, xabuff: *mut uint8_t);
    fn fs_setxattr(
        rootinode: uint32_t,
        sesflags: uint8_t,
        inode: uint32_t,
    ...
    fn fs_get_parents_count(rootinode: uint32_t, inode: uint32_t, cnt: *mut uint32_t) -> uint8_t;
    fn fs_get_parents_data(rootinode: uint32_t, inode: uint32_t, buff: *mut uint8_t);
    fn fs_get_paths_size(rootinode: uint32_t, inode: uint32_t, psize: *mut uint32_t) -> uint8_t;
    fn fs_get_paths_data(rootinode: uint32_t, inode: uint32_t, buff: *mut uint8_t);
    fn fs_archget(
        rootinode: uint32_t,
        sesflags: uint8_t,
        inode: uint32_t,
    ...
    fn fs_trash_remove(sesflags: uint8_t, inode: uint32_t, uid: uint32_t) -> uint8_t;
    fn fs_readsustained_size(
        rootinode: uint32_t,
        sesflags: uint8_t,
        dbuffsize: *mut uint32_t,
    ) -> uint8_t;
    fn fs_readsustained_data(rootinode: uint32_t, sesflags: uint8_t, dbuff: *mut uint8_t);
    fn fs_listsustained(
        partno: uint8_t,
        uid: uint32_t,
        gnleng: uint8_t,
    ...
    fn fs_readtrash_size(
        rootinode: uint32_t,
        sesflags: uint8_t,
        tid: uint32_t,
        dbuffsize: *mut uint32_t,
    ) -> uint8_t;
    fn fs_readtrash_data(
        rootinode: uint32_t,
        sesflags: uint8_t,
        tid: uint32_t,
        dbuff: *mut uint8_t,
    ...
    fn fs_purge(rootinode: uint32_t, sesflags: uint8_t, inode: uint32_t) -> uint8_t;
    fn fs_undel(rootinode: uint32_t, sesflags: uint8_t, inode: uint32_t) -> uint8_t;
    fn fs_listtrash(
        partno: uint8_t,
        format: uint8_t,
        uid: uint32_t,
    ...
    fn fs_getquotainfo(buff: *mut uint8_t, ver: uint8_t) -> uint32_t;
    fn fs_get_memusage(allocated: *mut uint64_t, used: *mut uint64_t);
    fn of_openfile(sessionid: uint32_t, inode: uint32_t);
    fn of_sync(sessionid: uint32_t, inode: *mut uint32_t, inodecnt: uint32_t);
    fn of_isfileopened_by_session(inode: uint32_t, sessionid: uint32_t) -> uint8_t;
    fn of_lsof(sessionid: uint32_t, buff: *mut uint8_t) -> uint32_t;
    fn flock_locks_cmd(
    ...
    fn flock_list(inode: uint32_t, buff: *mut uint8_t) -> uint32_t;
    fn flock_disconnected(connptr: *mut ::core::ffi::c_void);
    fn posix_lock_cmd(
        connptr: *mut ::core::ffi::c_void,
        sessionid: uint32_t,
        msgid: uint32_t,
    ...
    fn posix_lock_list(inode: uint32_t, buff: *mut uint8_t) -> uint32_t;
    fn posix_lock_disconnected(connptr: *mut ::core::ffi::c_void);
    fn meta_version() -> uint64_t;
    fn meta_get_id() -> uint64_t;
    fn meta_info(
    ...
    fn rndu8() -> uint8_t;
    fn exports_info_size(versmode: uint8_t) -> uint32_t;
    fn exports_info_data(versmode: uint8_t, buff: *mut uint8_t);
    fn exports_check(
        ip: uint32_t,
        version: uint32_t,
        path: *const uint8_t,
    ...
    fn exports_reload();
    fn exports_checksum() -> uint64_t;
    fn dcm_open(inode: uint32_t, sessionid: uint32_t) -> ::core::ffi::c_int;
    fn dcm_access(inode: uint32_t, sessionid: uint32_t);
    fn dcm_modify(inode: uint32_t, sessionid: uint32_t);
    ...
    fn chartsdata_resusage(mem: *mut uint64_t, syscpu: *mut uint64_t, usrcpu: *mut uint64_t);
    fn patterns_add(
        gnleng: uint8_t,
        gname: *const uint8_t,
        euid: uint32_t,
    ...
    fn patterns_list(buff: *mut uint8_t) -> uint32_t;
    ...
    fn cfg_getdefaultfile(name: *const ::core::ffi::c_char, maxleng: uint32_t) -> *mut cfg_buff;
    fn cfg_getstr(
    ...
    fn main_keepalive_register_fname(
        fun: Option<unsafe extern "C" fn() -> ()>,
        fname: *const ::core::ffi::c_char,
    );
    ...
    fn main_utime() -> uint64_t;
    fn univallocstrip(ip: uint32_t) -> *mut ::core::ffi::c_char;
    ...
    fn missing_log_getdata(buff: *mut uint8_t, mode: uint8_t) -> uint32_t;
    fn iptosesid_add(ip: uint32_t, sessionid: uint32_t);
    fn iptosesid_check(ip: uint32_t) -> uint8_t;
    fn iptosesid_get(ip: uint32_t) -> uint32_t;
}
...
unsafe extern "C" fn matoclserv_fuse_write_chunk_common(
    ...
    if status as ::core::ffi::c_int != MFS_STATUS_OK {
        ...
        ptr = matoclserv_create_packet(eptr, MATOCL_FUSE_WRITE_CHUNK as uint32_t, 5 as uint32_t);
...
pub unsafe extern "C" fn matoclserv_chunk_status(mut chunkid: uint64_t, mut status: uint8_t) {
    ...
    flags = 0 as uint8_t;
    pswc =
        (&raw mut swchunkshash as *mut *mut swchunks).offset((chunkid & 0xff as uint64_t) as isize);
    loop {
        swc = *pswc;
        if swc.is_null() {
            break;
    ...
    match r#type as ::core::ffi::c_int {
        ...
        2 => {
            if status as ::core::ffi::c_int != MFS_STATUS_OK {
                ptr =
                    matoclserv_create_packet(eptr, MATOCL_FUSE_TRUNCATE as uint32_t, 5 as uint32_t);
                put32bit(&raw mut ptr, msgid);
                put8bit(&raw mut ptr, status);
                fs_rollback(inode, indx, prevchunkid, chunkid);
                return;
...
pub unsafe extern "C" fn matoclserv_cserv_command(
    ...
    if length != 6 as uint32_t && length != 7 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_CSSERV_COMMAND - wrong size (%u/6|7)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_session_list(
    ...
    if length != 0 as uint32_t && length != 1 as uint32_t && length != 5 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_SESSION_LIST - wrong size (%u/0|1|5)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_session_command(
    ...
    if length != 5 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_SESSION_COMMAND - wrong size (%u/5)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_get_config_file(
    ...
    if length < 5 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"ANTOAN_GET_CONFIG_FILE - wrong size (%u)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
    ...
    {
        fdata = cfg_getdefaultfile(&raw mut name as *mut ::core::ffi::c_char, 65535 as uint32_t);
    } else {
        fdata = ::core::ptr::null_mut::<cfg_buff>();
    }
    if fdata.is_null() {
        ptr = matoclserv_create_packet(eptr, ANTOAN_CONFIG_FILE_CONTENT as uint32_t, 5 as uint32_t);
        put32bit(&raw mut ptr, msgid);
...
pub unsafe extern "C" fn matoclserv_module_info(
    ...
    if length != 0 as uint32_t && length != 4 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOAN_MODULE_INFO - wrong size (%u/4|0)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_missing_chunks(
    ...
    if length != 0 as uint32_t && length != 1 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_MISSING_CHUNKS - wrong size (%u/0|1)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_node_info(
    ...
    if length != 16 as uint32_t && length != 20 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_NODE_INFO - wrong size (%u/16|20)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_full_directory_data(
    ...
    if status as ::core::ffi::c_int != MFS_STATUS_OK {
        ptr = matoclserv_create_packet(eptr, MATOCL_FULL_DIRECTORY_DATA as uint32_t, 5 as uint32_t);
    } else {
        ptr = matoclserv_create_packet(
            eptr,
...
pub unsafe extern "C" fn matoclserv_fstest_info(
    ...
    if length != 0 as uint32_t && length != 1 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FSTEST_INFO - wrong size (%u/0|1)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_chunkstest_info(
    ...
    if length != 0 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_CHUNKSTEST_INFO - wrong size (%u/0)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_quota_info(
    ...
    if length != 0 as uint32_t && length != 1 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_QUOTA_INFO - wrong size (%u/(0|1))\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_exports_info(
    ...
    if length != 0 as uint32_t && length != 1 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_EXPORTS_INFO - wrong size (%u/0|1)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_instance_name(
    ...
    if length != 0 as uint32_t && length != 4 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_INSTANCE_NAME - wrong size (%u/4|0)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_fuse_register(
    ...
    if length < 64 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_REGISTER - wrong size (%u/<64)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
    ...
    ) == 0 as ::core::ffi::c_int
    {
                ...
                && rcode as ::core::ffi::c_int != REGISTER_CLOSESESSION
        {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_REGISTER/ACL - wrong rcode (%d) for registered status (%d)\0".as_ptr()
                    as *const ::core::ffi::c_char,
            ...
            REGISTER_NEWSESSION => {
                ...
                if length < (77 as uint32_t).wrapping_add(ileng) {
                    mfs_log(
                        MFSLOG_SYSLOG,
                        MFSLOG_WARNING,
                        b"CLTOMA_FUSE_REGISTER/ACL.2 - wrong size (%u/>=77+ileng(%u))\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        length,
                        ileng,
                    );
                ...
                if pleng > 0 as uint32_t {
                    ...
                    if *rptr.offset(-1 as isize) as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
                        mfs_log(
                            MFSLOG_SYSLOG,
                            MFSLOG_WARNING,
            ...
            REGISTER_RECONNECT => {
                ...
                if status as ::core::ffi::c_int == MFS_STATUS_OK {
                        ...
                        || sessions_get_peerip((*eptr).sesdata) == 0 as uint32_t
                    {
                        ...
                        || sessions_get_sesflags((*eptr).sesdata) & SESFLAG_DYNAMICIP as uint32_t
                            == 0 as uint32_t
        ...
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_REGISTER - wrong register blob\0".as_ptr() as *const ::core::ffi::c_char,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
    };
    ...
    if ForceTimeout > 0 as uint32_t {
        ...
        while !eptr.is_null() {
                        ...
                        })) as uint32_t
            {
                ...
                data =
                    matoclserv_create_packet(eptr, ANTOAN_FORCE_TIMEOUT as uint32_t, 6 as uint32_t);
...
pub unsafe extern "C" fn matoclserv_fuse_sustained_inodes(
    ...
    if length > inodetabsize {
        ...
        inodetab = malloc(::core::mem::size_of::<uint32_t>().wrapping_mul(inodetabsize as size_t))
            as *mut uint32_t;
        if inodetab.is_null() {
            fprintf(
                stderr,
...
pub unsafe extern "C" fn matoclserv_fuse_opdata(
    ...
    if length != 28 as uint32_t && length != 44 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_OPDATA - wrong size (%u/28|44)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
    ...
    if (*eptr).sesdata.is_null() {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_OPDATA - session doesn't exist\0".as_ptr() as *const ::core::ffi::c_char,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
    }
...
pub unsafe extern "C" fn matoclserv_fuse_time_sync(
    ...
    if length != 0 as uint32_t && length != 4 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_TIME_SYNC - wrong size (%u/0)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
    ...
    if length & 1 as uint32_t == 1 as uint32_t {
        if length != 17 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_ACCESS - wrong size (%u/17)\0".as_ptr() as *const ::core::ffi::c_char,
                length,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_ACCESS - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        if gids > MFS_GIDS_MAX as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_ACCESS - too many group ids\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_LOOKUP - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        if gids > MFS_GIDS_MAX as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_LOOKUP - too many group ids\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
            ...
            })) as uint32_t
    {
        ...
        if status as ::core::ffi::c_int == MFS_STATUS_OK {
            ...
            if filenode as ::core::ffi::c_int != 0
                && lflags as ::core::ffi::c_int & LOOKUP_ACCESS_MODES_IO != 0 as ::core::ffi::c_int
            {
                if knowflags != 0 {
                    if lflags as ::core::ffi::c_int & LOOKUP_DIRECTMODE == 0 as ::core::ffi::c_int {
                        if dcm_open(newinode, sessions_get_id((*eptr).sesdata)) != 0 {
                            lflags = (lflags as ::core::ffi::c_int | LOOKUP_KEEPCACHE) as uint16_t;
            ...
            if lflags as ::core::ffi::c_int & LOOKUP_CHUNK_ZERO_DATA != 0 {
                ...
                ptr = matoclserv_create_packet(
                    eptr,
                    MATOCL_FUSE_LOOKUP as uint32_t,
                    ((*eptr).asize as ::core::ffi::c_int + 10 as ::core::ffi::c_int) as uint32_t,
                );
                put32bit(&raw mut ptr, msgid);
                put32bit(&raw mut ptr, newinode);
                memcpy(
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_SETATTR - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
...
pub unsafe extern "C" fn matoclserv_fuse_readlink(
    ...
    if length != 8 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_READLINK - wrong size (%u/8)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_SYMLINK - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
...
pub unsafe extern "C" fn matoclserv_fuse_mknod(
    ...
    cumask = (cumask as ::core::ffi::c_int
        | sessions_get_umask((*eptr).sesdata) as ::core::ffi::c_int) as uint16_t;
    uid = get32bit(&raw mut data);
    auid = uid;
    if length <= (26 as uint32_t).wrapping_add(nleng as uint32_t) {
        gids = 1 as uint32_t;
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_MKNOD - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        if gids > MFS_GIDS_MAX as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_MKNOD - too many group ids\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
    ...
    if disables & DISABLE_MKFIFO as uint32_t != 0 && r#type as ::core::ffi::c_int == TYPE_FIFO
        ...
        || disables & DISABLE_MKSOCK as uint32_t != 0 && r#type as ::core::ffi::c_int == TYPE_SOCKET
        || disables & DISABLE_CREATE as uint32_t != 0 && r#type as ::core::ffi::c_int == TYPE_FILE
    {
        status = MFS_ERROR_EPERM as uint8_t;
    } else {
        status = fs_mknod(
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_MKDIR - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        if gids > MFS_GIDS_MAX as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_MKDIR - too many group ids\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_UNLINK - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        if gids > MFS_GIDS_MAX as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_UNLINK - too many group ids\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_RMDIR - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        if gids > MFS_GIDS_MAX as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_RMDIR - too many group ids\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_RENAME - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        if gids > MFS_GIDS_MAX as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_RENAME - too many group ids\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_LINK - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        if gids > MFS_GIDS_MAX as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_LINK - too many group ids\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_READDIR - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
...
pub unsafe extern "C" fn matoclserv_fuse_open(
    ...
    if length < 17 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_OPEN - wrong size (%u/17+N*4)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_OPEN - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        if gids > MFS_GIDS_MAX as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_OPEN - too many group ids\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_CREATE - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        if gids > MFS_GIDS_MAX as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_CREATE - too many group ids\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
                ...
                == MFS_STATUS_OK
            {
                if prevchunkid == 0 as uint64_t {
                    ...
                    fprintf(
                        ...
                        b"chunk created after mknod - prevchunkid should be always zero\0".as_ptr()
                            as *const ::core::ffi::c_char,
                    );
                    mfs_log(
                        MFSLOG_SYSLOG,
...
pub unsafe extern "C" fn matoclserv_fuse_read_chunk(
    ...
    {
        chunkopflags = (chunkopflags as ::core::ffi::c_int & !CHUNKOPFLAG_CANMODTIME) as uint8_t;
    }
...
pub unsafe extern "C" fn matoclserv_fuse_write_chunk_end(
    ...
    dcm_modify(inode, sessions_get_id((*eptr).sesdata));
    ptr = matoclserv_create_packet(eptr, MATOCL_FUSE_WRITE_CHUNK_END as uint32_t, 5 as uint32_t);
    put32bit(&raw mut ptr, msgid);
    put8bit(&raw mut ptr, status);
    if length >= 29 as uint32_t {
        chunk_get_version(chunkid, &raw mut version);
...
pub unsafe extern "C" fn matoclserv_fuse_posix_lock(
    ...
    if length != 42 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_POSIX_LOCK - wrong size (%u/42)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
    ...
    if cmd as ::core::ffi::c_int == POSIX_LOCK_CMD_GET
        && status as ::core::ffi::c_int == MFS_STATUS_OK
    {
        ptr = matoclserv_create_packet(eptr, MATOCL_FUSE_POSIX_LOCK as uint32_t, 25 as uint32_t);
        put32bit(&raw mut ptr, msgid);
        ...
        *gid.offset(0 as isize) = get32bit(&raw mut data);
        ...
        if gids == 0 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_REPAIR - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        if gids > MFS_GIDS_MAX as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_REPAIR - too many group ids\0".as_ptr() as *const ::core::ffi::c_char,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
        }
        ...
        if mode as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
            if mode as ::core::ffi::c_int == 2 as ::core::ffi::c_int {
                ...
                ptr = matoclserv_create_packet(
                    eptr,
                    MATOCL_FUSE_CHECK as uint32_t,
                    (4 as ::core::ffi::c_int + 5 as ::core::ffi::c_int * j as ::core::ffi::c_int)
                        as uint32_t,
                );
                put32bit(&raw mut ptr, msgid);
                i = 0 as uint32_t;
                ...
                ptr = matoclserv_create_packet(
                    eptr,
                    MATOCL_FUSE_CHECK as uint32_t,
                    (4 as ::core::ffi::c_int + 6 as ::core::ffi::c_int * j_0 as ::core::ffi::c_int)
                        as uint32_t,
                );
                put32bit(&raw mut ptr, msgid);
                i = 0 as uint32_t;
...
pub unsafe extern "C" fn matoclserv_fuse_gettrashretention(
    ...
    ptr = matoclserv_create_packet(
        ...
        if status as ::core::ffi::c_int != MFS_STATUS_OK {
            ...
            (12 as uint32_t).wrapping_add((8 as uint32_t).wrapping_mul(fnodes.wrapping_add(dnodes)))
        },
    );
    put32bit(&raw mut ptr, msgid);
    if status as ::core::ffi::c_int != MFS_STATUS_OK {
...
pub unsafe extern "C" fn matoclserv_fuse_getsclass(
    ...
    if length != 9 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_GETSCLASS - wrong size (%u/9)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_fuse_setsclass(
    ...
    if length < 14 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_SETSCLASS - wrong size (%u/<14)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
    ...
    if setid as ::core::ffi::c_int == 0xff as ::core::ffi::c_int {
        ...
        if length < pskip.wrapping_add(1 as uint32_t) {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"CLTOMA_FUSE_SETSCLASS - wrong size (%u)\0".as_ptr() as *const ::core::ffi::c_char,
                length,
            );
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
            return;
...
pub unsafe extern "C" fn matoclserv_fuse_geteattr(
    ...
    if length != 9 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_GETEATTR - wrong size (%u/9)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
            ...
            })) as uint32_t
    {
        ...
        while (i as ::core::ffi::c_int) < (1 as ::core::ffi::c_int) << EATTR_BITS {
            feattrtab[(i as ::core::ffi::c_int & 0xf as ::core::ffi::c_int) as usize] = feattrtab
                [(i as ::core::ffi::c_int & 0xf as ::core::ffi::c_int) as usize]
                .wrapping_add(feattrtab[i as usize]);
            feattrtab[i as usize] = 0 as uint32_t;
            deattrtab[(i as ::core::ffi::c_int & 0xf as ::core::ffi::c_int) as usize] = deattrtab
                [(i as ::core::ffi::c_int & 0xf as ::core::ffi::c_int) as usize]
        ...
        i = 32 as uint16_t;
        while (i as ::core::ffi::c_int) < (1 as ::core::ffi::c_int) << EATTR_BITS {
            feattrtab[(i as ::core::ffi::c_int & 0x1f as ::core::ffi::c_int) as usize] = feattrtab
                [(i as ::core::ffi::c_int & 0x1f as ::core::ffi::c_int) as usize]
                .wrapping_add(feattrtab[i as usize]);
            feattrtab[i as usize] = 0 as uint32_t;
            deattrtab[(i as ::core::ffi::c_int & 0x1f as ::core::ffi::c_int) as usize] = deattrtab
                [(i as ::core::ffi::c_int & 0x1f as ::core::ffi::c_int) as usize]
                .wrapping_add(deattrtab[i as usize]);
            deattrtab[i as usize] = 0 as uint32_t;
            i = i.wrapping_add(1);
    ...
    if status as ::core::ffi::c_int == MFS_STATUS_OK {
        ...
        while (i as ::core::ffi::c_int) < (1 as ::core::ffi::c_int) << EATTR_BITS {
            ...
            if deattrtab[i as usize] != 0 && (dn as ::core::ffi::c_int) < 255 as ::core::ffi::c_int
            {
                dn = dn.wrapping_add(1);
            } else {
                deattrtab[i as usize] = 0 as uint32_t;
    ...
    ptr = matoclserv_create_packet(
        ...
        (if status as ::core::ffi::c_int != MFS_STATUS_OK {
            ...
            6 as ::core::ffi::c_int
                + 5 as ::core::ffi::c_int * (r#fn as ::core::ffi::c_int + dn as ::core::ffi::c_int)
        }) as uint32_t,
    );
    put32bit(&raw mut ptr, msgid);
    if status as ::core::ffi::c_int != MFS_STATUS_OK {
...
pub unsafe extern "C" fn matoclserv_fuse_seteattr(
    ...
    if length != 14 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_SETEATTR - wrong size (%u/14)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_fuse_getxattr(
        ...
        && mode as ::core::ffi::c_int != MFS_XATTR_LENGTH_ONLY
    {
        ...
        let mut xanode: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<::core::ffi::c_void>();
...
pub unsafe extern "C" fn matoclserv_fuse_setxattr(
    ...
    if avleng > MFS_XATTR_SIZE_MAX as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_SETXATTR - xattr value too long\0".as_ptr() as *const ::core::ffi::c_char,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
    }
...
pub unsafe extern "C" fn matoclserv_fuse_append_slice(
    ...
    let mut status: uint8_t = 0;
    let mut flags: uint8_t = 0;
    if length < 20 as uint32_t || length & 1 as uint32_t == 1 as uint32_t && length < 29 as uint32_t
    {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
    ...
    if status as ::core::ffi::c_int == MFS_STATUS_OK {
        matoclserv_fuse_fleng_has_changed(::core::ptr::null_mut::<matoclserventry>(), inode, fleng);
    }
...
pub unsafe extern "C" fn matoclserv_fuse_quotacontrol(
    ...
    if length != 65 as uint32_t && length != 69 as uint32_t && length != 9 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_QUOTACONTROL - wrong size (%u)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_fuse_archctl(
    ...
    if length != 13 as uint32_t && length != 9 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_ARCHCTL - wrong size (%u/9|13)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
        ...
        if fver as ::core::ffi::c_int <= 6 as ::core::ffi::c_int {
                    ...
                    + dleng as ::core::ffi::c_int) as uint32_t
            {
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_WARNING,
                    b"CLTOMA_SCLASS_CREATE/%hhu - wrong size (%u:nleng=%hhu:dleng=%hhu)\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    fver as ::core::ffi::c_int,
                    length,
                    nleng as ::core::ffi::c_int,
            ...
            || chgmask as ::core::ffi::c_int == 0 as ::core::ffi::c_int
        {
                    ...
                    + dleng as ::core::ffi::c_int) as uint32_t
            {
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_WARNING,
                    b"CLTOMA_SCLASS_CHANGE/%hhu - wrong size (%u:nleng=%hhu:dleng=%hhu)\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    fver as ::core::ffi::c_int,
                    length,
                    nleng as ::core::ffi::c_int,
    ...
    if fver as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
        if status as ::core::ffi::c_int == MFS_STATUS_OK {
            ...
            if (arch.ec_data_chksum_parts as ::core::ffi::c_int
                | trash.ec_data_chksum_parts as ::core::ffi::c_int) as uint32_t
                | create.uniqmask
                | keep.uniqmask
                | arch.uniqmask
                | trash.uniqmask
    ...
    if status as ::core::ffi::c_int != MFS_STATUS_OK {
        ...
        if fver as ::core::ffi::c_int >= 1 as ::core::ffi::c_int {
            ...
            while (i as ::core::ffi::c_int) < create.labelscnt as ::core::ffi::c_int {
                memcpy(
                    ptr as *mut ::core::ffi::c_void,
                    &raw mut *(&raw mut create.labelexpr as *mut [uint8_t; 128]).offset(i as isize)
            ...
            while (i as ::core::ffi::c_int) < keep.labelscnt as ::core::ffi::c_int {
                memcpy(
                    ptr as *mut ::core::ffi::c_void,
                    &raw mut *(&raw mut keep.labelexpr as *mut [uint8_t; 128]).offset(i as isize)
                        as *mut uint8_t as *const ::core::ffi::c_void,
                    SCLASS_EXPR_MAX_SIZE as size_t,
                );
                ptr = ptr.offset(SCLASS_EXPR_MAX_SIZE as isize);
            ...
            while (i as ::core::ffi::c_int) < arch.labelscnt as ::core::ffi::c_int {
                memcpy(
                    ptr as *mut ::core::ffi::c_void,
                    &raw mut *(&raw mut arch.labelexpr as *mut [uint8_t; 128]).offset(i as isize)
                        as *mut uint8_t as *const ::core::ffi::c_void,
                    SCLASS_EXPR_MAX_SIZE as size_t,
                );
                ptr = ptr.offset(SCLASS_EXPR_MAX_SIZE as isize);
            ...
            while (i as ::core::ffi::c_int) < trash.labelscnt as ::core::ffi::c_int {
                memcpy(
                    ptr as *mut ::core::ffi::c_void,
                    &raw mut *(&raw mut trash.labelexpr as *mut [uint8_t; 128]).offset(i as isize)
                        as *mut uint8_t as *const ::core::ffi::c_void,
                    SCLASS_EXPR_MAX_SIZE as size_t,
                );
                ptr = ptr.offset(SCLASS_EXPR_MAX_SIZE as isize);
            ...
            i = 0 as uint8_t;
            while (i as ::core::ffi::c_int) < create.labelscnt as ::core::ffi::c_int * MASKORGROUP {
...
pub unsafe extern "C" fn matoclserv_sclass_duplicate(
    ...
    if length < 5 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_SCLASS_DUPLICATE - wrong size (%u)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_trash_recover(
    ...
    if gids == 0 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_TRASH_RECOVER - group ids missing\0".as_ptr() as *const ::core::ffi::c_char,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
    }
    if gids > MFS_GIDS_MAX as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_TRASH_RECOVER - too many group ids\0".as_ptr() as *const ::core::ffi::c_char,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
    }
...
pub unsafe extern "C" fn matoclserv_trash_remove(
    ...
    if length != 12 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_TRASH_REMOVE - wrong size (%u/12)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_fuse_getdirstats_old(
    ...
    if length != 8 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_GETDIRSTATS - wrong size (%u/8)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
...
pub unsafe extern "C" fn matoclserv_fuse_gettrash(
    ...
    if length != 4 as uint32_t && length != 8 as uint32_t {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"CLTOMA_FUSE_GETTRASH - wrong size (%u/4)\0".as_ptr() as *const ::core::ffi::c_char,
            length,
        );
        (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        return;
        ...
        if (*eptr).input_packet.is_null() {
            ...
            if leng > MaxPacketSize as uint32_t {
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_WARNING,
                    b"main master server module: packet too long (%u/%u) ; command:%u\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    leng,
                    MaxPacketSize,
                    r#type,
...
pub unsafe extern "C" fn matoclserv_serve(mut pdesc: *mut pollfd) {
        ...
        && (*pdesc.offset(lsockpdescpos as isize)).revents as ::core::ffi::c_int & POLLIN != 0
    {
        ...
        if ns < 0 as ::core::ffi::c_int {
            mfs_log(
                MFSLOG_SYSLOG_STDERR,
                MFSLOG_WARNING,
                b"main master server module: accept error\0".as_ptr() as *const ::core::ffi::c_char,
            );
        } else {
            tcpnonblock(ns);
            tcpnodelay(ns);
    ...
    while !eptr.is_null() {
        ...
        if ((*eptr).lastread + (*eptr).timeout as ::core::ffi::c_int as ::core::ffi::c_double) < now
        {
            (*eptr).mode = KILL as ::core::ffi::c_int as uint8_t;
        }
...
pub unsafe extern "C" fn matoclserv_reload() {
    ...
    if cfg_isdefined(b"MATOCL_LISTEN_HOST\0".as_ptr() as *const ::core::ffi::c_char) != 0
        ...
        || !(cfg_isdefined(b"MATOCU_LISTEN_HOST\0".as_ptr() as *const ::core::ffi::c_char) != 0
            || cfg_isdefined(b"MATOCU_LISTEN_PORT\0".as_ptr() as *const ::core::ffi::c_char) != 0)
    {
