...
extern "C" {
    ...
    fn strerr_term();
    fn mycrc32_init();
    fn mfscgiserv_init() -> ::core::ffi::c_int;
...
pub static mut RunTab: [C2Rust_Unnamed_10; 2] = [
    C2Rust_Unnamed_10 {
        r#fn: Some(mfscgiserv_init as unsafe extern "C" fn() -> ::core::ffi::c_int),
        name: b"cgi_server\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
    },
    C2Rust_Unnamed_10 {
        r#fn: None,
...
pub unsafe extern "C" fn main_destruct_register_fname(
    ...
    if aux.is_null() {
        fprintf(
            ...
            b"/tmp/moosefs-ref/mfsgui/../mfscommon/main.c\0".as_ptr() as *const ::core::ffi::c_char,
...
pub unsafe extern "C" fn mainloop() -> ::core::ffi::c_int {
    ...
    while t != 3 as ::core::ffi::c_int {
        ...
        if r == 1 as ::core::ffi::c_int {
            ...
            infile = fopen(
                b".mfsgui_info.txt\0".as_ptr() as *const ::core::ffi::c_char,
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                b"/tmp/moosefs-ref/mfsgui/../mfscommon/main.c\0".as_ptr()
                    as *const ::core::ffi::c_char,
...
pub unsafe extern "C" fn wdlock(mut runmode: uint8_t, mut timeout: uint32_t) -> uint8_t {
    ...
    lfd = open(
        b".mfsgui.lock\0".as_ptr() as *const ::core::ffi::c_char,
        O_WRONLY | O_CREAT,
    ...
    if ownerpid > 0 as ::core::ffi::c_int {
        if runmode as ::core::ffi::c_int == RM_TEST {
            mfs_log(
                MFSLOG_SYSLOG_STDERR,
                MFSLOG_INFO,
                b"mfsgui pid: %ld\0".as_ptr() as *const ::core::ffi::c_char,
    ...
    if runmode as ::core::ffi::c_int == RM_START || runmode as ::core::ffi::c_int == RM_RESTART {
        ...
        mfs_log(
            MFSLOG_SYSLOG_STDERR,
            MFSLOG_NOTICE,
            b"mfsgui is not running\0".as_ptr() as *const ::core::ffi::c_char,
        );
        return 1 as uint8_t;
    }
    return 0 as uint8_t;
...
unsafe fn main_0(
    ...
    cfgfile = strdup(
        b"/home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/etc/mfs/mfsgui.cfg\0"
            .as_ptr() as *const ::core::ffi::c_char,
    );
    if cfgfile.is_null() {
        fprintf(
    ...
    if fd < 0 as ::core::ffi::c_int && *__errno_location() == ENOENT {
        ocfgfile = strdup(
            b"/home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/etc/mfsgui.cfg\0"
                .as_ptr() as *const ::core::ffi::c_char,
        );
        if ocfgfile.is_null() {
            fprintf(
    ...
    if movewarning != 0 {
        mfs_log(
            MFSLOG_SYSLOG_STDERR,
            MFSLOG_WARNING,
            b"default sysconf path has changed - please move mfsgui.cfg from /home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/etc/ to /home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/etc/mfs/\0"
                .as_ptr() as *const ::core::ffi::c_char,
        );
    }
    ...
    logappname = cfg_getstr(
        ...
        b"mfsgui\0".as_ptr() as *const ::core::ffi::c_char,
    );
