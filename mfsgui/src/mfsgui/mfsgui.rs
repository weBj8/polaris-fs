...
pub const DEFAULT_CGIDIR: [::core::ffi::c_char; 87] = unsafe {
    ::core::mem::transmute::<
        [u8; 87],
        [::core::ffi::c_char; 87],
    >(
        *b"/home/ston/Workspaces/polaris-fs/target/mfs-port/mfs-build/../mfs-install/share/mfscgi\0",
    )
};
    ...
    while i < 16 as ::core::ffi::c_int {
        *(*r).etag.offset((i * 2 as ::core::ffi::c_int) as isize) =
            ::core::mem::transmute::<[u8; 17], [::core::ffi::c_char; 17]>(*b"0123456789ABCDEF\0")
                [(digest[i as usize] as ::core::ffi::c_int >> 4 as ::core::ffi::c_int) as usize];
        *(*r)
            .etag
            .offset((i * 2 as ::core::ffi::c_int + 1 as ::core::ffi::c_int) as isize) =
            ::core::mem::transmute::<[u8; 17], [::core::ffi::c_char; 17]>(*b"0123456789ABCDEF\0")
                [(digest[i as usize] as ::core::ffi::c_int & 15 as ::core::ffi::c_int) as usize];
        i += 1;
    }
...
unsafe extern "C" fn mfscgiserv_loaddata(mut r: *mut requests) -> ::core::ffi::c_int {
    ...
    ) != (*r).fsize as ssize_t
    {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"guiserv: can't read content of the file: %s\0".as_ptr() as *const ::core::ffi::c_char,
            (*r).fname,
        );
        close(fd);
        return -1 as ::core::ffi::c_int;
    ...
    if fd.is_null() {
        if *__errno_location() == ENOENT {
            ...
            mfs_log(
                ...
                MFSLOG_WARNING,
                b"guiserv: can't open mfsgui requests file (%s) - no requests !!!, error\0".as_ptr()
                    as *const ::core::ffi::c_char,
                RequestsFile,
            );
        }
        ...
        if (*r).rtype as ::core::ffi::c_int == RTYPE_FILE as ::core::ffi::c_int {
            if stat((*r).fname, &raw mut fst) >= 0 as ::core::ffi::c_int {
                if (*r).mtime != fst.st_mtim.tv_sec || (*r).fsize as __off_t != fst.st_size {
                    mfscgiserv_reloaddata(r, fst.st_mtim.tv_sec as time_t, fst.st_size as off_t);
                }
            } else {
                mfs_log(
                    MFSLOG_SYSLOG,
...
pub unsafe extern "C" fn mfscgiserv_parse_hdrline(
    ...
    if lineno == 0 as uint32_t {
            ...
            && (*(*h).req).rtype as ::core::ffi::c_int == RTYPE_FILE as ::core::ffi::c_int
        {
            ...
            if !(*(*h).req).mtimestr.is_null() {
                ...
                if hl > 0 as ::core::ffi::c_int {
                    ...
                    if (*h).mtimematch as ::core::ffi::c_int == MATCH_UNKNOWN as ::core::ffi::c_int
                    {
        ...
        hl = mfscgiserv_check_header(sptr, b"Connection\0".as_ptr() as *const ::core::ffi::c_char);
        if hl > 0 as ::core::ffi::c_int {
            p = sptr.offset(hl as isize);
            while *p as ::core::ffi::c_int != 0
                && *p as ::core::ffi::c_int == ' ' as ::core::ffi::c_int
...
pub unsafe extern "C" fn mfscgiserv_printf(
    ...
    maxstrleng = (HTTP_HEADERMAX as uint32_t)
        .wrapping_sub((*h).outputdataleng.wrapping_add(2 as uint32_t)) as int32_t;
            ...
            *(*h).inputdata.offset((*h).inputdataleng as isize) = 0 as uint8_t;
                ...
                && (*h).method as ::core::ffi::c_int == METHOD_NONE as ::core::ffi::c_int
            {
                if memcmp(
                    ...
                    b"GET \0".as_ptr() as *const ::core::ffi::c_char as *const ::core::ffi::c_void,
                    4 as size_t,
                ) == 0 as ::core::ffi::c_int
                {
...
pub unsafe extern "C" fn mfscgiserv_handle_cgioutput(
    ...
    univnonblock(fd);
    cont =
        mfscgiserv_piperead(h, fd, (FWD_BUFFSIZE - 1 as ::core::ffi::c_int) as uint32_t) as uint8_t;
    if (*h).error != 0 {
        return;
    }
    ...
    loop {
        ...
        if *p as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
            ...
            *eoln = 0 as ::core::ffi::c_char;
            ...
            if mfscgiserv_check_header(sline, b"Status\0".as_ptr() as *const ::core::ffi::c_char)
                >= 0 as ::core::ffi::c_int
            {
...
pub unsafe extern "C" fn mfscgiserv_handle_cgi(mut h: *mut httphandle) {
    ...
    let mut argp: [*mut ::core::ffi::c_char; 7] = [
        ...
        b"SERVER_PROTOCOL=HTTP/1.1\0".as_ptr() as *const ::core::ffi::c_char
            as *mut ::core::ffi::c_char,
        b"REQUEST_METHOD=GET\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        b"SERVER_NAME=mfsgui\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        OsPath,
        ::core::ptr::null_mut::<::core::ffi::c_char>(),
        ::core::ptr::null_mut::<::core::ffi::c_char>(),
    ];
...
pub unsafe extern "C" fn mfscgiserv_reload() {
    ...
    if tcpnumlisten(newlsock, listenip, listenport, 100 as uint16_t) < 0 as ::core::ffi::c_int {
        mfs_log(
            MFSLOG_ERRNO_SYSLOG_STDERR,
            MFSLOG_WARNING,
            b"guiserv: socket address has changed, but can't listen on socket (%s:%s)\0".as_ptr()
                as *const ::core::ffi::c_char,
            ListenHost,
            ListenPort,
        );
...
unsafe extern "C" fn c2rust_run_static_initializers() {
    mimes = [
        ...
        _mimetype {
            ...
            mime: b"text/css\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        },
        _mimetype {
        ...
        _mimetype {
            ...
            mime: b"image/gif\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        },
        _mimetype {
            extl: ::core::mem::size_of::<[::core::ffi::c_char; 4]>().wrapping_sub(1 as usize)
                as uint32_t,
        ...
        _mimetype {
            ...
            mime: b"image/png\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        },
        _mimetype {
            extl: ::core::mem::size_of::<[::core::ffi::c_char; 5]>().wrapping_sub(1 as usize)
                as uint32_t,
        ...
        _mimetype {
            ...
            mime: b"image/bmp\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        },
        _mimetype {
            extl: ::core::mem::size_of::<[::core::ffi::c_char; 4]>().wrapping_sub(1 as usize)
                as uint32_t,
        ...
        _mimetype {
            ...
            mime: b"text/xml\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        },
        _mimetype {
            extl: ::core::mem::size_of::<[::core::ffi::c_char; 4]>().wrapping_sub(1 as usize)
                as uint32_t,
