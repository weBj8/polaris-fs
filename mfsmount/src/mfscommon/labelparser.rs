            ...
            match n as ::core::ffi::c_int & SCLASS_EXPR_TYPE_MASK {
                SCLASS_EXPR_SYMBOL => {
                    if n as ::core::ffi::c_int == SCLASS_EXPR_SYMBOL_ANY {
                        ...
                        stack[sp as usize].str = malloc(1 as size_t) as *mut ::core::ffi::c_char;
                ...
                SCLASS_EXPR_OP_AND => {
                    ...
                    while r as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
                        ...
                        l = (l as ::core::ffi::c_int
                            + stack[(sp as ::core::ffi::c_int - r as ::core::ffi::c_int) as usize]
                                .len as ::core::ffi::c_int) as uint8_t;
                        r = r.wrapping_sub(1);
                    }
                    l = (l as ::core::ffi::c_int
                    ...
                    while r as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
                        ...
                        memcpy(
                            ...
                            stack[(sp as ::core::ffi::c_int - r as ::core::ffi::c_int) as usize].str
                                as *const ::core::ffi::c_void,
                            stack[(sp as ::core::ffi::c_int - r as ::core::ffi::c_int) as usize].len
                                as size_t,
                        );
                        l = (l as ::core::ffi::c_int
                            + stack[(sp as ::core::ffi::c_int - r as ::core::ffi::c_int) as usize]
                ...
                SCLASS_EXPR_OP_ONE => {
                    ...
                    if n as ::core::ffi::c_int == SCLASS_EXPR_OP_NOT {
                        ...
                        l = stack[(sp as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as usize]
                            .len;
                        ...
                        *str.offset(c2rust_fresh7 as isize) = '~' as ::core::ffi::c_char;
                        ...
                        memcpy(
                            str.offset(l as ::core::ffi::c_int as isize)
                                as *mut ::core::ffi::c_void,
                            stack[(sp as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as usize].str
                                as *const ::core::ffi::c_void,
                            stack[(sp as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as usize].len
                                as size_t,
                        );
                        l = (l as ::core::ffi::c_int
    ...
    if (*pd).uniqmask != 0 as uint32_t {
        *p = '/' as ::core::ffi::c_char;
        ...
        if (*pd).uniqmask & UNIQ_MASK_IP as uint32_t != 0 {
            ...
            memcpy(
                p as *mut ::core::ffi::c_void,
                b"[RACK]\0".as_ptr() as *const ::core::ffi::c_char as *const ::core::ffi::c_void,
                6 as size_t,
            );
    ...
    if *(*e).str.offset(0 as isize) as ::core::ffi::c_int == '[' as ::core::ffi::c_int {
            ...
            || *(*e).str.offset(0 as isize) as ::core::ffi::c_int == 'i' as ::core::ffi::c_int
        {
            ...
            if *(*e).str.offset(0 as isize) as ::core::ffi::c_int == 'P' as ::core::ffi::c_int
                || *(*e).str.offset(0 as isize) as ::core::ffi::c_int == 'p' as ::core::ffi::c_int
            {
                (*e).str = (*e).str.offset(1);
            }
            if *(*e).str.offset(0 as isize) as ::core::ffi::c_int != ']' as ::core::ffi::c_int {
        ...
        } else if *(*e).str.offset(0 as isize) as ::core::ffi::c_int == 'R' as ::core::ffi::c_int
            || *(*e).str.offset(0 as isize) as ::core::ffi::c_int == 'r' as ::core::ffi::c_int
        {
            ...
            {
                (*e).str = (*e).str.offset(1);
                if *(*e).str.offset(0 as isize) as ::core::ffi::c_int == 'C' as ::core::ffi::c_int
                    || *(*e).str.offset(0 as isize) as ::core::ffi::c_int
                        == 'c' as ::core::ffi::c_int
                {
                    (*e).str = (*e).str.offset(1);
        ...
        || *(*e).str.offset(0 as isize) as ::core::ffi::c_int == '=' as ::core::ffi::c_int
    {
        ...
        if *(*e).str.offset(0 as isize) as ::core::ffi::c_int == '+' as ::core::ffi::c_int {
            ...
            if *(*e).str.offset(0 as isize) as ::core::ffi::c_int >= '1' as ::core::ffi::c_int
                ...
                && ((*e).ec_data_chksum_parts as ::core::ffi::c_int == 4 as ::core::ffi::c_int
                    || (*e).ec_data_chksum_parts as ::core::ffi::c_int == 8 as ::core::ffi::c_int)
            {
        ...
        while i < 9 as uint32_t {
            ...
            if *(*e).str.offset(0 as isize) as ::core::ffi::c_int >= '1' as ::core::ffi::c_int
                && *(*e).str.offset(0 as isize) as ::core::ffi::c_int <= '9' as ::core::ffi::c_int
            {
                g = (*(*e).str.offset(0 as isize) as ::core::ffi::c_int - '0' as ::core::ffi::c_int)
                    as uint32_t;
                (*e).str = (*e).str.offset(1);
                f = 1 as uint8_t;
            } else {
            ...
            if i == 0 as uint32_t
                ...
                && (*(*e).str.offset(0 as isize) as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                    || *(*e).str.offset(0 as isize) as ::core::ffi::c_int
                        == '/' as ::core::ffi::c_int)
            {
                a = newnode(
...
unsafe extern "C" fn expr_rpn_top(mut o: *mut rpnbuff) -> uint8_t {
    if (*o).pos as ::core::ffi::c_int > 0 as ::core::ffi::c_int {
        return (*o).rpndata[((*o).pos as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as usize];
    }
    return 0 as uint8_t;
}
#[inline]
...
pub unsafe extern "C" fn parse_label_expr(
            ...
            || *exprstr.offset(0 as isize) as ::core::ffi::c_int == '~' as ::core::ffi::c_int))
    {
        ...
        i = 0 as uint32_t;
        while i < 9 as uint32_t && res == 0 as ::core::ffi::c_int && !e.terms[i as usize].is_null()
        {
            ...
            match n as ::core::ffi::c_int & SCLASS_EXPR_TYPE_MASK {
                ...
                SCLASS_EXPR_OP_ONE => {
                    ...
                    if n as ::core::ffi::c_int == SCLASS_EXPR_OP_NOT {
                        ...
                        stack[(sp as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as usize] = (1
                            as ::core::ffi::c_int
                            - stack[(sp as ::core::ffi::c_int - 1 as ::core::ffi::c_int) as usize]
                                as ::core::ffi::c_int)
                            as uint8_t;
