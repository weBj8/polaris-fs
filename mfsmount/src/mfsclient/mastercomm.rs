...
extern "C" {
    ...
    fn stats_counter_add(node: *mut ::core::ffi::c_void, delta: uint64_t);
    fn stats_counter_inc(node: *mut ::core::ffi::c_void);
    fn stats_counter_set(node: *mut ::core::ffi::c_void, value: uint64_t);
    ...
    fn heap_cleanup();
    fn heap_push(element: uint32_t);
    fn heap_pop() -> uint32_t;
    fn heap_elements() -> uint32_t;
    fn heap_term();
    fn ep_chunk_has_changed(
        inode: uint32_t,
        chindx: uint32_t,
        chunkid: uint64_t,
        version: uint32_t,
    ...
    fn ep_fleng_has_changed(inode: uint32_t, fleng: uint64_t);
    fn ep_term();
    fn ep_init();
    fn mfs_log(
        mode: ::core::ffi::c_int,
    ...
    fn chunksdatacache_clear_inode(inode: uint32_t, chindx: uint32_t);
    fn chunksdatacache_cleanup();
    fn read_get_total_bytes() -> uint64_t;
    fn write_get_total_bytes() -> uint64_t;
}
...
pub unsafe extern "C" fn fs_isopen(mut inode: uint32_t) -> ::core::ffi::c_int {
    ...
    while !afptr.is_null() {
        if (*afptr).inode == inode {
            if (*afptr).dentry as ::core::ffi::c_int != 0 || (*afptr).cnt as ::core::ffi::c_int != 0
            {
                pthread_mutex_unlock(&raw mut aflock);
...
pub unsafe extern "C" fn fs_read_notify(mut bytes: uint64_t) {
    ::core::intrinsics::atomic_xadd_seqcst(&raw mut rbyt, bytes);
    ::core::intrinsics::atomic_xadd_seqcst(&raw mut rcnt, 1 as uint32_t);
}
#[no_mangle]
pub unsafe extern "C" fn fs_write_notify(mut bytes: uint64_t) {
    ::core::intrinsics::atomic_xadd_seqcst(&raw mut wbyt, bytes);
    ::core::intrinsics::atomic_xadd_seqcst(&raw mut wcnt, 1 as uint32_t);
}
#[no_mangle]
pub unsafe extern "C" fn fs_fsync_notify() {
    ::core::intrinsics::atomic_xadd_seqcst(&raw mut fcnt, 1 as uint32_t);
}
#[no_mangle]
pub unsafe extern "C" fn fs_init_counters() {
    ::core::intrinsics::atomic_and_seqcst(&raw mut rbyt, 0 as uint64_t);
    ::core::intrinsics::atomic_and_seqcst(&raw mut rcnt, 0 as uint32_t);
    ::core::intrinsics::atomic_and_seqcst(&raw mut wbyt, 0 as uint64_t);
    ::core::intrinsics::atomic_and_seqcst(&raw mut wcnt, 0 as uint32_t);
    ::core::intrinsics::atomic_and_seqcst(&raw mut fcnt, 0 as uint32_t);
}
#[no_mangle]
...
pub unsafe extern "C" fn fs_get_my_threc() -> *mut threc {
    let mut rec: *mut threc = ::core::ptr::null_mut::<threc>();
    let mut rechash: uint32_t = 0;
    rec = pthread_getspecific(reckey) as *mut threc;
    if !rec.is_null() {
        return rec;
    }
    pthread_mutex_lock(&raw mut reclock);
...
unsafe extern "C" fn fs_disconnect() {
    ::core::intrinsics::atomic_or_seqcst(&raw mut disconnect, 1 as ::core::ffi::c_int);
}
#[no_mangle]
        ...
        ) < 0 as ::core::ffi::c_int
        {
            if oninit != 0 {
                mfs_log(
                    ...
                    MFSLOG_WARNING,
                    b"can't resolve source hostname (%s)\0".as_ptr() as *const ::core::ffi::c_char,
                    bindhostname,
                );
            } else {
                mfs_log(
            ...
            if i == 1 as uint32_t {
                if oninit != 0 {
                    mfs_log(
                        MFSLOG_SYSLOG_STDERR,
                        MFSLOG_WARNING,
                        b"mfsmaster register error: %s\0".as_ptr() as *const ::core::ffi::c_char,
    ...
    if oninit as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
        if sessionlost == 2 as ::core::ffi::c_int {
            ...
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_INFO,
                b"registered to master with new session\0".as_ptr() as *const ::core::ffi::c_char,
            );
        }
    }
        ...
        if mintrashretention > 0 as uint32_t || maxtrashretention < 0xffffffff as uint32_t {
            if ibleng < INFOBUFF_SIZE as uint32_t {
                ibleng = ibleng.wrapping_add(snprintf(
                    infobuff.offset(ibleng as isize),
                    (INFOBUFF_SIZE as uint32_t).wrapping_sub(ibleng) as size_t,
                    b" ; settrashretention limited to (\0".as_ptr() as *const ::core::ffi::c_char,
                ) as uint32_t);
            }
    ...
    loop {
        ...
        if i != MATOCL_FUSE_REGISTER as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"master: register error (bad answer: %u)\0".as_ptr() as *const ::core::ffi::c_char,
                i,
            );
            tcpclose(fd);
            fd = -1 as ::core::ffi::c_int;
        ...
        if i != 1 as uint32_t && i != 4 as uint32_t && i != 5 as uint32_t && i != 13 as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"master: register error (bad length: %u)\0".as_ptr() as *const ::core::ffi::c_char,
                i,
            );
            tcpclose(fd);
            fd = -1 as ::core::ffi::c_int;
        ...
        ) != i as int32_t
        {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"master: register error (read data: %s)\0".as_ptr() as *const ::core::ffi::c_char,
                strerr(*__errno_location()),
            );
            tcpclose(fd);
            fd = -1 as ::core::ffi::c_int;
        ...
        if i == 4 as uint32_t {
            ...
            if newmasterip == 0 as uint32_t {
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_NOTICE,
                    b"mfsmaster %s - got empty redirect\0".as_ptr() as *const ::core::ffi::c_char,
                    &raw mut masterstrip as *mut ::core::ffi::c_char,
                );
                tcpclose(fd);
                fd = -1 as ::core::ffi::c_int;
                ...
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_NOTICE,
                    b"mfsmaster %s - got self redirect\0".as_ptr() as *const ::core::ffi::c_char,
                    &raw mut masterstrip as *mut ::core::ffi::c_char,
                );
                tcpclose(fd);
                fd = -1 as ::core::ffi::c_int;
            ...
            })) as uint32_t
    {
        ...
        ) != 9 as int32_t
        {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"master: close session error (read: %s)\0".as_ptr() as *const ::core::ffi::c_char,
                strerr(*__errno_location()),
            );
...
pub unsafe extern "C" fn fs_send_amtime_inodes() {
            ...
            })) as uint32_t
    {
        ...
        while amhash < AMTIME_HASH_SIZE as uint32_t {
            ...
            while !amfptr.is_null() {
                if (*amfptr).atime > 0 as uint64_t || (*amfptr).mtime > 0 as uint64_t {
                    inodesleng =
                        (inodesleng as ::core::ffi::c_int + 12 as ::core::ffi::c_int) as int32_t;
                }
                amfptr = (*amfptr).next as *mut amtime_file;
            }
        ...
        if inodesleng > 0 as int32_t {
            inodesleng = (inodesleng as ::core::ffi::c_int + 8 as ::core::ffi::c_int) as int32_t;
...
pub unsafe extern "C" fn fs_send_opdata() {
    ...
    rbyt_copy = ::core::intrinsics::atomic_and_seqcst(&raw mut rbyt, 0 as uint64_t);
    rcnt_copy = ::core::intrinsics::atomic_and_seqcst(&raw mut rcnt, 0 as uint32_t);
    wbyt_copy = ::core::intrinsics::atomic_and_seqcst(&raw mut wbyt, 0 as uint64_t);
    wcnt_copy = ::core::intrinsics::atomic_and_seqcst(&raw mut wcnt, 0 as uint32_t);
    fcnt_copy = ::core::intrinsics::atomic_and_seqcst(&raw mut fcnt, 0 as uint32_t);
...
pub unsafe extern "C" fn fs_set_working_flags(mut sflags: uint8_t) {
    ::core::intrinsics::atomic_or_seqcst(&raw mut working_flags, sflags);
}
#[no_mangle]
pub unsafe extern "C" fn fs_clr_working_flags(mut cflags: uint8_t) {
    ::core::intrinsics::atomic_and_seqcst(
...
pub unsafe extern "C" fn fs_nop_thread(
    ...
    loop {
        ...
        if ::core::intrinsics::atomic_or_seqcst(&raw mut disconnect, 0 as ::core::ffi::c_int)
            == 0 as ::core::ffi::c_int
...
pub unsafe extern "C" fn fs_receive_thread(
    ...
    loop {
        ...
        if ::core::intrinsics::atomic_and_seqcst(&raw mut disconnect, 0 as ::core::ffi::c_int) != 0
        {
        ...
        if fd == -1 as ::core::ffi::c_int {
            ...
            if r == 0 as int32_t {
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_WARNING,
                    b"master: connection lost (header)\0".as_ptr() as *const ::core::ffi::c_char,
                );
                fs_disconnect();
                ...
                mfs_log(
                    MFSLOG_SYSLOG,
                    MFSLOG_WARNING,
                    b"master: tcp recv error: %s (header)\0".as_ptr() as *const ::core::ffi::c_char,
                    strerr(*__errno_location()),
                );
                fs_disconnect();
            } else {
                            ...
                            if internal != 0 {
                                ...
                                if cmd == MATOCL_FUSE_FLENG_HAS_CHANGED as uint32_t {
                                    ...
                                    if rusectime.wrapping_add(1000000 as uint64_t) < lusectime
                                        || lusectime.wrapping_add(1000000 as uint64_t) < rusectime
                                    {
                                        mfs_log(
                                            MFSLOG_SYSLOG,
                                            MFSLOG_WARNING,
...
pub unsafe extern "C" fn fs_init_master_connection(
    ...
    ::core::intrinsics::atomic_and_seqcst(&raw mut disconnect, 0 as ::core::ffi::c_int);
    donotsendsustainedinodes = 0 as ::core::ffi::c_int;
    if !bindhostname.is_null() {
...
pub unsafe extern "C" fn fs_init_threads(mut retries: uint32_t, mut timeout: uint32_t) {
    ...
    let mut _mfs_assert_ret: ::core::ffi::c_int = pthread_key_create(
        &raw mut reckey,
        Some(fs_free_threc as unsafe extern "C" fn(*mut ::core::ffi::c_void) -> ()),
    );
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                b"/tmp/moosefs-ref/mfsclient/mastercomm.c\0".as_ptr() as *const ::core::ffi::c_char,
                2626 as ::core::ffi::c_int as ::core::ffi::c_uint,
                b"pthread_key_create(&reckey,fs_free_threc)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                _mfs_assert_ret,
                *__errno_location(),
                _mfs_errorstring,
    ...
    if _mfs_assert_ret_3 != 0 as ::core::ffi::c_int {
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"pthread_mutex_init(&amtimelock,NULL)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_3,
                *__errno_location(),
                _mfs_errorstring_7,
            );
    ...
    let mut _mfs_assert_ret_4: ::core::ffi::c_int = pthread_attr_init(&raw mut thattr);
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                b"/tmp/moosefs-ref/mfsclient/mastercomm.c\0".as_ptr() as *const ::core::ffi::c_char,
                2634 as ::core::ffi::c_int as ::core::ffi::c_uint,
    ...
    if _mfs_assert_ret_5 != 0 as ::core::ffi::c_int {
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                b"/tmp/moosefs-ref/mfsclient/mastercomm.c\0".as_ptr() as *const ::core::ffi::c_char,
                2635 as ::core::ffi::c_int as ::core::ffi::c_uint,
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            ...
            let mut _mfs_errorstring_err_5: *const ::core::ffi::c_char =
                strerr(*__errno_location());
            let mut _mfs_errorstring_ret_5: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_5);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s (errno=%d: %s)\0".as_ptr()
    ...
    let mut _mfs_assert_ret_6: ::core::ffi::c_int = pthread_create(
        &raw mut rpthid,
        &raw mut thattr,
        Some(
            fs_receive_thread
    ...
    if _mfs_assert_ret_6 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_6 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_13: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                b"/tmp/moosefs-ref/mfsclient/mastercomm.c\0".as_ptr() as *const ::core::ffi::c_char,
                2636 as ::core::ffi::c_int as ::core::ffi::c_uint,
                b"pthread_create(&rpthid,&thattr,fs_receive_thread,NULL)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                _mfs_assert_ret_6,
                *__errno_location(),
                _mfs_errorstring_13,
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            ...
            let mut _mfs_errorstring_err_6: *const ::core::ffi::c_char =
                strerr(*__errno_location());
            let mut _mfs_errorstring_ret_6: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_6);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s (errno=%d: %s)\0".as_ptr()
    ...
    let mut _mfs_assert_ret_7: ::core::ffi::c_int = pthread_create(
        &raw mut npthid,
        &raw mut thattr,
        Some(
            fs_nop_thread
    ...
    if _mfs_assert_ret_7 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_7 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_15: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                b"/tmp/moosefs-ref/mfsclient/mastercomm.c\0".as_ptr() as *const ::core::ffi::c_char,
                2637 as ::core::ffi::c_int as ::core::ffi::c_uint,
                b"pthread_create(&npthid,&thattr,fs_nop_thread,NULL)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                _mfs_assert_ret_7,
                *__errno_location(),
                _mfs_errorstring_15,
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            ...
            let mut _mfs_errorstring_err_7: *const ::core::ffi::c_char =
                strerr(*__errno_location());
            let mut _mfs_errorstring_ret_7: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_7);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s (errno=%d: %s)\0".as_ptr()
    ...
    let mut _mfs_assert_ret_8: ::core::ffi::c_int = pthread_attr_destroy(&raw mut thattr);
    if _mfs_assert_ret_8 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_8 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_17: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                b"/tmp/moosefs-ref/mfsclient/mastercomm.c\0".as_ptr() as *const ::core::ffi::c_char,
                2638 as ::core::ffi::c_int as ::core::ffi::c_uint,
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            ...
            let mut _mfs_errorstring_err_8: *const ::core::ffi::c_char =
                strerr(*__errno_location());
            let mut _mfs_errorstring_ret_8: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_8);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s (errno=%d: %s)\0".as_ptr()
...
pub unsafe extern "C" fn fs_term() {
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                b"/tmp/moosefs-ref/mfsclient/mastercomm.c\0".as_ptr() as *const ::core::ffi::c_char,
                2653 as ::core::ffi::c_int as ::core::ffi::c_uint,
                b"pthread_join(npthid,NULL)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_1,
                *__errno_location(),
                _mfs_errorstring_3,
            );
    ...
    let mut _mfs_assert_ret_2: ::core::ffi::c_int =
        pthread_join(rpthid, ::core::ptr::null_mut::<*mut ::core::ffi::c_void>());
    if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_2 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                b"/tmp/moosefs-ref/mfsclient/mastercomm.c\0".as_ptr() as *const ::core::ffi::c_char,
                2654 as ::core::ffi::c_int as ::core::ffi::c_uint,
                b"pthread_join(rpthid,NULL)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_2,
                *__errno_location(),
                _mfs_errorstring_5,
            );
    ...
    if _mfs_assert_ret_9 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_9 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_19: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                    as *const ::core::ffi::c_char,
                b"/tmp/moosefs-ref/mfsclient/mastercomm.c\0".as_ptr() as *const ::core::ffi::c_char,
                2692 as ::core::ffi::c_int as ::core::ffi::c_uint,
                b"pthread_key_delete(reckey)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_9,
                *__errno_location(),
                _mfs_errorstring_19,
            );
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            ...
            let mut _mfs_errorstring_err_9: *const ::core::ffi::c_char =
                strerr(*__errno_location());
            let mut _mfs_errorstring_ret_9: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_9);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s (errno=%d: %s)\0".as_ptr()
...
pub unsafe extern "C" fn fs_path_lookup(
    ...
    if rptr.is_null() {
        ...
        ret = *rptr.offset(0 as isize);
    } else if i < (9 as ::core::ffi::c_uint).wrapping_add(asize as ::core::ffi::c_uint) as uint32_t
    {
        fs_disconnect();
        ret = MFS_ERROR_IO as uint8_t;
    } else {
            ...
            if i >= (19 as ::core::ffi::c_int + asize as ::core::ffi::c_int) as uint32_t {
                ...
                *csdatasize = i.wrapping_sub(
                        ...
                        != 0 as uint32_t
                {
                    ...
                    && i != ((19 as ::core::ffi::c_int + asize as ::core::ffi::c_int) as uint32_t)
                        .wrapping_add(
            ...
            *csdataver = get8bit(&raw mut rptr);
            if i < 21 as uint32_t
                || *csdataver as ::core::ffi::c_int == 1 as ::core::ffi::c_int
                    && i.wrapping_sub(21 as uint32_t).wrapping_rem(10 as uint32_t) != 0 as uint32_t
                || *csdataver as ::core::ffi::c_int == 2 as ::core::ffi::c_int
                    && i.wrapping_sub(21 as uint32_t).wrapping_rem(14 as uint32_t) != 0 as uint32_t
                || *csdataver as ::core::ffi::c_int == 3 as ::core::ffi::c_int
