...
extern "C" {
    ...
    pub type _IO_marker;
    fn fuse_reply_err(req: fuse_req_t, err: ::core::ffi::c_int) -> ::core::ffi::c_int;
    fn fuse_reply_entry(req: fuse_req_t, e: *const fuse_entry_param) -> ::core::ffi::c_int;
    fn fuse_reply_attr(
        req: fuse_req_t,
        attr: *const stat,
        attr_timeout: ::core::ffi::c_double,
    ) -> ::core::ffi::c_int;
    fn fuse_reply_open(req: fuse_req_t, fi: *const fuse_file_info) -> ::core::ffi::c_int;
    fn fuse_reply_write(req: fuse_req_t, count: size_t) -> ::core::ffi::c_int;
    fn fuse_reply_buf(
        req: fuse_req_t,
        buf: *const ::core::ffi::c_char,
        size: size_t,
    ) -> ::core::ffi::c_int;
    fn fuse_reply_statfs(req: fuse_req_t, stbuf: *const statvfs) -> ::core::ffi::c_int;
    ...
    fn fs_getmasterlocation(loc: *mut uint8_t);
    fn fs_statfs(
    ...
    fn fs_getsustained(dbuff: *mut *const uint8_t, dbuffsize: *mut uint32_t) -> uint8_t;
    fn fs_gettrash(tid: uint32_t, dbuff: *mut *const uint8_t, dbuffsize: *mut uint32_t) -> uint8_t;
    fn fs_getdetachedattr(inode: uint32_t, attr: *mut uint8_t) -> uint8_t;
    fn fs_gettrashpath(inode: uint32_t, path: *mut *const uint8_t) -> uint8_t;
    fn fs_settrashpath(inode: uint32_t, path: *const uint8_t) -> uint8_t;
    fn fs_undel(inode: uint32_t) -> uint8_t;
    fn fs_purge(inode: uint32_t) -> uint8_t;
    fn master_version() -> uint32_t;
    fn masterproxy_getlocation(masterinfo: *mut uint8_t);
}
...
unsafe extern "C" fn mfs_attr_to_stat(
    ...
    {
        (*stbuf).st_mode =
            (S_IFREG | attrmode as ::core::ffi::c_int & 0o7777 as ::core::ffi::c_int) as __mode_t;
    } else {
        (*stbuf).st_mode = 0 as __mode_t;
    }
    ...
    match ino {
        1 => {
            return ((4 as ::core::ffi::c_int * 6 as ::core::ffi::c_int
                ...
                .wrapping_add(strlen(META_SUSTAINED_NAME.as_ptr())) as uint32_t;
        }
        2147483640 => {
            if master_version()
                >= (3 as ::core::ffi::c_int * 0x10000 as ::core::ffi::c_int
                ...
                && flat_trash == 0 as ::core::ffi::c_int
            {
                ...
                while tid < TRASH_BUCKETS as uint32_t {
                    ...
                    put8bit(
                        ...
                        ::core::mem::transmute::<[u8; 17], [::core::ffi::c_char; 17]>(
                            *b"0123456789ABCDEF\0",
                        )[(tid & 15 as uint32_t) as usize] as uint8_t,
                    );
                    put32bit(
                        &raw mut buff,
...
unsafe extern "C" fn dir_dataentries_size(
    ...
    while dbuff < eptr {
        ...
        if nleng as ::core::ffi::c_int > 255 as ::core::ffi::c_int - 9 as ::core::ffi::c_int {
            eleng = eleng
                .wrapping_add((6 as ::core::ffi::c_int + 255 as ::core::ffi::c_int) as uint32_t);
        } else {
            eleng = eleng.wrapping_add(
                (6 as ::core::ffi::c_int + nleng as ::core::ffi::c_int + 9 as ::core::ffi::c_int)
                    as uint32_t,
            );
        }
    }
            ...
            <= eptr
        {
            ...
            *buff.offset(8 as isize) = '|' as uint8_t;
            if nleng as ::core::ffi::c_int > 255 as ::core::ffi::c_int - 9 as ::core::ffi::c_int {
                ...
                buff =
                    buff.offset((9 as ::core::ffi::c_int + nleng as ::core::ffi::c_int) as isize);
            }
...
pub unsafe extern "C" fn mfs_meta_opendir(
            ...
            && ino <= META_SUBTRASH_INODE_MAX as fuse_ino_t
    {
        ...
        (*fi).fh = dirinfo.expose_addr() as ::core::ffi::c_ulong as uint64_t;
...
pub unsafe extern "C" fn mfs_meta_readdir(
    ...
    let mut dirinfo: *mut dirbuf =
        ::core::ptr::from_exposed_addr_mut::<dirbuf>((*fi).fh as ::core::ffi::c_ulong as usize);
...
pub unsafe extern "C" fn mfs_meta_open(
    ...
    if ino >= MIN_SPECIAL_INODE as fuse_ino_t || ino == META_ROOT_INODE as fuse_ino_t {
        ...
        if status != 0 as ::core::ffi::c_int {
            ...
            (*pathinfo).size = strlen(path as *mut ::core::ffi::c_char).wrapping_add(1 as size_t);
            ...
            *(*pathinfo)
            ...
            (*fi).fh = pathinfo.expose_addr() as ::core::ffi::c_ulong as uint64_t;
            if fuse_reply_open(req, fi) == -ENOENT {
                (*fi).fh = 0 as uint64_t;
...
pub unsafe extern "C" fn mfs_meta_release(
    ...
    let mut pathinfo: *mut pathbuf =
        ::core::ptr::from_exposed_addr_mut::<pathbuf>((*fi).fh as ::core::ffi::c_ulong as usize);
