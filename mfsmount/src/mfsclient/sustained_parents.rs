...
pub unsafe extern "C" fn sparents_add(
    ...
    unsafe {
        ...
        let mut _mfs_assert_ret: ::core::ffi::c_int = pthread_mutex_lock(
        ...
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"pthread_mutex_lock(sparents_lock+hash)\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    _mfs_assert_ret,
                    *__errno_location(),
                    _mfs_errorstring,
        ...
        while !sip.is_null() {
            if (*sip).inode == inode {
                (*sip).parent = parent;
                (*sip).validtime =
                    (monotonic_seconds() + timeout as ::core::ffi::c_double) as uint32_t;
...
unsafe extern "C" fn sparents_cleanupthread(
    ...
    unsafe {
        ...
        loop {
            ...
            i = 0 as uint32_t;
            while i
                < (HASH_SIZE / (10 as ::core::ffi::c_int * 30 as ::core::ffi::c_int)) as uint32_t
            {
