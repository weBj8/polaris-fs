...
pub struct _hashbucket {
    ...
    pub nleng: [uint8_t; 16],
    pub name: [*mut uint8_t; 16],
    pub time: [::core::ffi::c_double; 16],
}
pub type hashbucket = _hashbucket;
pub type C2Rust_Unnamed_0 = ::core::ffi::c_uint;
pub const STATNODES: C2Rust_Unnamed_0 = 5;
pub const ENTRIES: C2Rust_Unnamed_0 = 4;
pub const SEARCH_MISSES: C2Rust_Unnamed_0 = 3;
pub const SEARCH_HITS: C2Rust_Unnamed_0 = 2;
pub const REMOVALS: C2Rust_Unnamed_0 = 1;
...
static mut negentryhash: *mut hashbucket = ::core::ptr::null_mut::<hashbucket>();
static mut lastvalidentry: ::core::ffi::c_double = 0.0f64;
static mut NegEntryTimeOut: ::core::ffi::c_double = 1.0f64;
...
static mut statsptr: [*mut ::core::ffi::c_void; 5] =
    [::core::ptr::null_mut::<::core::ffi::c_void>(); 5];
#[inline]
unsafe extern "C" fn negentry_cache_statsptr_init() {
    ...
    statsptr[REMOVALS as ::core::ffi::c_int as usize] = stats_get_subnode(
        s,
    ...
    statsptr[ENTRIES as ::core::ffi::c_int as usize] = stats_get_subnode(
        s,
...
#[inline]
unsafe extern "C" fn negentry_cache_stats_inc(mut id: uint8_t) {
    if (id as ::core::ffi::c_int) < STATNODES as ::core::ffi::c_int {
        stats_counter_inc(statsptr[id as usize]);
    }
}
#[inline]
unsafe extern "C" fn negentry_cache_stats_dec(mut id: uint8_t) {
    if (id as ::core::ffi::c_int) < STATNODES as ::core::ffi::c_int {
        stats_counter_dec(statsptr[id as usize]);
    }
}
#[inline]
unsafe extern "C" fn negentry_cache_hash(
    mut n: uint8_t,
    mut inode: uint32_t,
    mut nleng: uint8_t,
    ...
    let mut i: uint8_t = 0;
    hash = inode;
    hash = hash.wrapping_mul(primes[n as usize]);
    hash = hash.wrapping_add(nleng as uint32_t);
    i = 0 as uint8_t;
...
pub unsafe extern "C" fn negentry_cache_insert(
    ...
    negentry_cache_stats_inc(INSERTS as ::core::ffi::c_int as uint8_t);
    let mut _mfs_assert_ret: ::core::ffi::c_int = pthread_mutex_lock(&raw mut necachelock);
    if _mfs_assert_ret != 0 as ::core::ffi::c_int {
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"/tmp/moosefs-ref/mfsclient/negentrycache.c\0".as_ptr()
                    as *const ::core::ffi::c_char,
                129 as ::core::ffi::c_int as ::core::ffi::c_uint,
                b"pthread_mutex_lock(&necachelock)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret,
                *__errno_location(),
                _mfs_errorstring,
            );
    ...
    while (h as ::core::ffi::c_int) < HASH_FUNCTIONS {
        hb = negentryhash.offset(
            negentry_cache_hash(h, inode, nleng, name).wrapping_rem(HASH_BUCKETS as uint32_t)
                as isize,
        );
        i = 0 as uint8_t;
        while (i as ::core::ffi::c_int) < HASH_BUCKET_SIZE {
            if (*hb).inode[i as usize] == inode
                && (*hb).nleng[i as usize] as ::core::ffi::c_int == nleng as ::core::ffi::c_int
                && memcmp(
                    (*hb).name[i as usize] as *const ::core::ffi::c_void,
                ...
                if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                        ...
                        && *__errno_location() != 0 as ::core::ffi::c_int
                    {
                        ...
                        mfs_log(
                            ...
                            b"pthread_mutex_unlock(&necachelock)\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            _mfs_assert_ret_0,
                            *__errno_location(),
                            _mfs_errorstring_1,
    ...
    if !fhb.is_null() {
        if (*fhb).time[fi as usize] == 0.0f64 {
            negentry_cache_stats_inc(ENTRIES as ::core::ffi::c_int as uint8_t);
        }
        (*fhb).inode[fi as usize] = inode;
        (*fhb).nleng[fi as usize] = nleng;
        if !(*fhb).name[fi as usize].is_null() {
            free((*fhb).name[fi as usize] as *mut ::core::ffi::c_void);
        }
        (*fhb).name[fi as usize] = malloc(nleng as size_t) as *mut uint8_t;
        if (*fhb).name[fi as usize].is_null() {
            fprintf(
                stderr,
                ...
                b"fhb->name[fi]\0".as_ptr() as *const ::core::ffi::c_char,
            );
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
        ...
        memcpy(
            (*fhb).name[fi as usize] as *mut ::core::ffi::c_void,
            name as *const ::core::ffi::c_void,
            nleng as size_t,
        );
        (*fhb).time[fi as usize] = t;
    }
    let mut _mfs_assert_ret_1: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut necachelock);
    if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"pthread_mutex_unlock(&necachelock)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_1,
                *__errno_location(),
                _mfs_errorstring_4,
            );
...
pub unsafe extern "C" fn negentry_cache_remove(
    ...
    t = monotonic_seconds();
    negentry_cache_stats_inc(REMOVALS as ::core::ffi::c_int as uint8_t);
    let mut _mfs_assert_ret: ::core::ffi::c_int = pthread_mutex_lock(&raw mut necachelock);
    if _mfs_assert_ret != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
    ...
    while (h as ::core::ffi::c_int) < HASH_FUNCTIONS {
        ...
        while (i as ::core::ffi::c_int) < HASH_BUCKET_SIZE {
            ...
            if (*hb).time[i as usize] > 0.0f64
                && ((*hb).time[i as usize] + NegEntryTimeOut < t
                    || (*hb).time[i as usize] < lastvalidentry
                    || f as ::core::ffi::c_int == 2 as ::core::ffi::c_int)
            {
                (*hb).inode[i as usize] = 0 as uint32_t;
                (*hb).nleng[i as usize] = 0 as uint8_t;
                if !(*hb).name[i as usize].is_null() {
                    free((*hb).name[i as usize] as *mut ::core::ffi::c_void);
                }
                (*hb).name[i as usize] = ::core::ptr::null_mut::<uint8_t>();
                (*hb).time[i as usize] = 0.0f64;
                negentry_cache_stats_dec(ENTRIES as ::core::ffi::c_int as uint8_t);
            }
            if f as ::core::ffi::c_int == 2 as ::core::ffi::c_int {
                f = 1 as uint8_t;
            }
            i = i.wrapping_add(1);
        }
...
pub unsafe extern "C" fn negentry_cache_search(
    ...
    while (h as ::core::ffi::c_int) < HASH_FUNCTIONS {
        ...
        while (i as ::core::ffi::c_int) < HASH_BUCKET_SIZE {
                    ...
                    || (*hb).time[i as usize] < lastvalidentry)
            {
                ...
                (*hb).time[i as usize] = 0.0f64;
                negentry_cache_stats_dec(ENTRIES as ::core::ffi::c_int as uint8_t);
            } else if (*hb).inode[i as usize] == inode
                && (*hb).nleng[i as usize] as ::core::ffi::c_int == nleng as ::core::ffi::c_int
                && memcmp(
                    (*hb).name[i as usize] as *const ::core::ffi::c_void,
                    name as *const ::core::ffi::c_void,
        ...
        if f != 0 {
            ...
            negentry_cache_stats_inc(SEARCH_HITS as ::core::ffi::c_int as uint8_t);
            return 1 as uint8_t;
        }
        h = h.wrapping_add(1);
    }
    ...
    if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"/tmp/moosefs-ref/mfsclient/negentrycache.c\0".as_ptr()
                    as *const ::core::ffi::c_char,
                240 as ::core::ffi::c_int as ::core::ffi::c_uint,
                b"pthread_mutex_unlock(&necachelock)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_1,
                *__errno_location(),
                _mfs_errorstring_3,
    ...
    negentry_cache_stats_inc(SEARCH_MISSES as ::core::ffi::c_int as uint8_t);
    return 0 as uint8_t;
}
#[no_mangle]
pub unsafe extern "C" fn negentry_cache_clear() {
    let mut t: ::core::ffi::c_double = monotonic_seconds();
    let mut _mfs_assert_ret: ::core::ffi::c_int = pthread_mutex_lock(&raw mut necachelock);
    if _mfs_assert_ret != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
    ...
    lastvalidentry = t;
    let mut _mfs_assert_ret_0: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut necachelock);
    if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_0 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"/tmp/moosefs-ref/mfsclient/negentrycache.c\0".as_ptr()
                    as *const ::core::ffi::c_char,
                249 as ::core::ffi::c_int as ::core::ffi::c_uint,
                b"pthread_mutex_unlock(&necachelock)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_0,
                *__errno_location(),
                _mfs_errorstring_1,
...
#[no_mangle]
pub unsafe extern "C" fn negentry_cache_init(mut to: ::core::ffi::c_double) {
    let mut hb: *mut hashbucket = ::core::ptr::null_mut::<hashbucket>();
    let mut i: uint8_t = 0;
    ...
    negentryhash = malloc(::core::mem::size_of::<hashbucket>().wrapping_mul(HASH_BUCKETS as size_t))
        as *mut hashbucket;
    if negentryhash.is_null() {
        fprintf(
            stderr,
            b"%s:%u - out of memory: %s is NULL\n\0".as_ptr() as *const ::core::ffi::c_char,
            b"/tmp/moosefs-ref/mfsclient/negentrycache.c\0".as_ptr() as *const ::core::ffi::c_char,
            262 as ::core::ffi::c_int as ::core::ffi::c_uint,
            b"negentryhash\0".as_ptr() as *const ::core::ffi::c_char,
        );
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_ERR,
    ...
    while hi < HASH_BUCKETS as uint32_t {
        hb = negentryhash.offset(hi as isize);
        i = 0 as uint8_t;
        while (i as ::core::ffi::c_int) < HASH_BUCKET_SIZE {
            (*hb).inode[i as usize] = 0 as uint32_t;
            (*hb).nleng[i as usize] = 0 as uint8_t;
...
pub unsafe extern "C" fn negentry_cache_term() {
    ...
    let mut i: uint8_t = 0;
    let mut hi: uint32_t = 0;
    if NegEntryTimeOut <= 0.0f64 || negentryhash.is_null() {
        return;
    }
    ...
    free(negentryhash as *mut ::core::ffi::c_void);
    negentryhash = ::core::ptr::null_mut::<hashbucket>();
    pthread_mutex_unlock(&raw mut necachelock);
}
