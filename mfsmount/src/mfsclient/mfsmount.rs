...
extern "C" {
    ...
    fn fuse_version() -> ::core::ffi::c_int;
    fn fuse_set_signal_handlers(se: *mut fuse_session) -> ::core::ffi::c_int;
    ...
    fn fuse_cmdline_help();
    fn fuse_parse_cmdline(args: *mut fuse_args, opts: *mut fuse_cmdline_opts)
        -> ::core::ffi::c_int;
    fn fuse_session_new_versioned(
        args: *mut fuse_args,
    ...
    fn fuse_session_mount(
        se: *mut fuse_session,
        mountpoint: *const ::core::ffi::c_char,
    ) -> ::core::ffi::c_int;
    fn fuse_session_loop(se: *mut fuse_session) -> ::core::ffi::c_int;
    fn fuse_session_loop_mt_32(
        se: *mut fuse_session,
    ...
    fn mfs_statfs(req: fuse_req_t, ino: fuse_ino_t);
    fn mfs_access(req: fuse_req_t, ino: fuse_ino_t, mask: ::core::ffi::c_int);
    fn mfs_lookup(req: fuse_req_t, parent: fuse_ino_t, name: *const ::core::ffi::c_char);
    fn mfs_getattr(req: fuse_req_t, ino: fuse_ino_t, fi: *mut fuse_file_info);
    fn mfs_setattr(
        req: fuse_req_t,
        ino: fuse_ino_t,
        stbuf: *mut stat,
    ...
    fn mfs_unlink(req: fuse_req_t, parent: fuse_ino_t, name: *const ::core::ffi::c_char);
    fn mfs_mkdir(
        req: fuse_req_t,
        parent: fuse_ino_t,
        name: *const ::core::ffi::c_char,
    ...
    fn mfs_rmdir(req: fuse_req_t, parent: fuse_ino_t, name: *const ::core::ffi::c_char);
    fn mfs_symlink(
        req: fuse_req_t,
    ...
    fn mfs_readlink(req: fuse_req_t, ino: fuse_ino_t);
    fn mfs_rename(
        req: fuse_req_t,
        parent: fuse_ino_t,
        name: *const ::core::ffi::c_char,
    ...
    fn mfs_opendir(req: fuse_req_t, ino: fuse_ino_t, fi: *mut fuse_file_info);
    fn mfs_readdir(
        req: fuse_req_t,
        ino: fuse_ino_t,
        size: size_t,
    ...
    fn mfs_releasedir(req: fuse_req_t, ino: fuse_ino_t, fi: *mut fuse_file_info);
    fn mfs_create(
        req: fuse_req_t,
        parent: fuse_ino_t,
        name: *const ::core::ffi::c_char,
    ...
    fn mfs_open(req: fuse_req_t, ino: fuse_ino_t, fi: *mut fuse_file_info);
    fn mfs_release(req: fuse_req_t, ino: fuse_ino_t, fi: *mut fuse_file_info);
    fn mfs_read(
        req: fuse_req_t,
        ino: fuse_ino_t,
        size: size_t,
    ...
    fn mfs_flush(req: fuse_req_t, ino: fuse_ino_t, fi: *mut fuse_file_info);
    fn mfs_fsync(
        req: fuse_req_t,
        ino: fuse_ino_t,
    ...
    fn mfs_listxattr(req: fuse_req_t, ino: fuse_ino_t, size: size_t);
    fn mfs_removexattr(req: fuse_req_t, ino: fuse_ino_t, name: *const ::core::ffi::c_char);
    fn mfs_getlk(req: fuse_req_t, ino: fuse_ino_t, fi: *mut fuse_file_info, lock: *mut flock);
    fn mfs_setlk(
        req: fuse_req_t,
        ino: fuse_ino_t,
        fi: *mut fuse_file_info,
    ...
    fn mfs_flock(req: fuse_req_t, ino: fuse_ino_t, fi: *mut fuse_file_info, op: ::core::ffi::c_int);
    fn mfs_readdirplus(
        req: fuse_req_t,
        ino: fuse_ino_t,
        size: size_t,
    ...
    fn mfs_setsession(se: *mut fuse_session);
    fn mfs_meta_statfs(req: fuse_req_t, ino: fuse_ino_t);
    fn mfs_meta_lookup(req: fuse_req_t, parent: fuse_ino_t, name: *const ::core::ffi::c_char);
    fn mfs_meta_getattr(req: fuse_req_t, ino: fuse_ino_t, fi: *mut fuse_file_info);
    fn mfs_meta_setattr(
        req: fuse_req_t,
        ino: fuse_ino_t,
        stbuf: *mut stat,
    ...
    fn mfs_meta_unlink(req: fuse_req_t, parent: fuse_ino_t, name: *const ::core::ffi::c_char);
    fn mfs_meta_rename(
        req: fuse_req_t,
        parent: fuse_ino_t,
        name: *const ::core::ffi::c_char,
    ...
    fn mfs_meta_opendir(req: fuse_req_t, ino: fuse_ino_t, fi: *mut fuse_file_info);
    fn mfs_meta_readdir(
        req: fuse_req_t,
        ino: fuse_ino_t,
        size: size_t,
    ...
    fn mfs_meta_releasedir(req: fuse_req_t, ino: fuse_ino_t, fi: *mut fuse_file_info);
    fn mfs_meta_open(req: fuse_req_t, ino: fuse_ino_t, fi: *mut fuse_file_info);
    fn mfs_meta_release(req: fuse_req_t, ino: fuse_ino_t, fi: *mut fuse_file_info);
    fn mfs_meta_read(
        req: fuse_req_t,
        ino: fuse_ino_t,
        size: size_t,
    ...
    fn fs_set_working_flags(sflags: uint8_t);
    fn master_version() -> uint32_t;
    fn fs_get_current_srcstrip() -> *const ::core::ffi::c_char;
    fn fs_get_current_masterstrip() -> *const ::core::ffi::c_char;
    fn fs_get_current_masterport() -> uint16_t;
    fn fs_init_master_connection(
    ...
    fn fs_init_threads(retries: uint32_t, to: uint32_t);
    fn fs_term();
    fn masterproxy_term();
    fn masterproxy_init(masterproxyip: *const ::core::ffi::c_char) -> ::core::ffi::c_int;
    fn csorder_init(labelexpr: *const ::core::ffi::c_char) -> ::core::ffi::c_int;
    fn sparents_term();
    fn sparents_init();
    fn sinodes_term();
    fn sinodes_init(mountpoint: *const ::core::ffi::c_char);
    fn sstats_term();
    fn sstats_init() -> ::core::ffi::c_int;
    fn symlink_cache_init(to: ::core::ffi::c_double);
    fn symlink_cache_term();
    fn negentry_cache_init(to: ::core::ffi::c_double);
    fn negentry_cache_term();
    fn chunksdatacache_term();
    fn chunksdatacache_init();
    fn inoleng_term();
    fn inoleng_init();
    fn conncache_term();
    fn conncache_init(capacity: uint32_t) -> ::core::ffi::c_int;
    fn chunkrwlock_init();
    fn chunkrwlock_term();
    fn read_data_init(
...
unsafe extern "C" fn mfs_opt_proc_stage1(
    ...
    if key == KEY_CFGFILE as ::core::ffi::c_int {
        if memcmp(
            ...
            b"mfscfgfile=\0".as_ptr() as *const ::core::ffi::c_char as *const ::core::ffi::c_void,
            11 as size_t,
        ) == 0 as ::core::ffi::c_int
        {
...
unsafe extern "C" fn mfs_fsinit(
    ...
    (*conn).want = ((*conn).want as ::core::ffi::c_ulong & !FUSE_CAP_AUTO_INVAL_DATA) as uint32_t;
    if mfsopts.meta != 0 {
        (*conn).want = ((*conn).want as ::core::ffi::c_ulong & !FUSE_CAP_READDIRPLUS) as uint32_t;
        (*conn).want =
    ...
    (*conn).want = ((*conn).want as ::core::ffi::c_ulong & !FUSE_CAP_WRITEBACK_CACHE) as uint32_t;
    (*conn).want = ((*conn).want as ::core::ffi::c_ulong | FUSE_CAP_PARALLEL_DIROPS) as uint32_t;
    (*conn).want = ((*conn).want as ::core::ffi::c_ulong & !FUSE_CAP_POSIX_ACL) as uint32_t;
    (*conn).want = ((*conn).want as ::core::ffi::c_ulong & !FUSE_CAP_HANDLE_KILLPRIV) as uint32_t;
    if mfsopts.nobsdlocks == 0 as ::core::ffi::c_int {
        (*conn).want = ((*conn).want as ::core::ffi::c_ulong | FUSE_CAP_FLOCK_LOCKS) as uint32_t;
    } else {
        (*conn).want = ((*conn).want as ::core::ffi::c_ulong & !FUSE_CAP_FLOCK_LOCKS) as uint32_t;
    }
    if mfsopts.noposixlocks == 0 as ::core::ffi::c_int {
        (*conn).want = ((*conn).want as ::core::ffi::c_ulong | FUSE_CAP_POSIX_LOCKS) as uint32_t;
    } else {
        (*conn).want = ((*conn).want as ::core::ffi::c_ulong & !FUSE_CAP_POSIX_LOCKS) as uint32_t;
    }
...
pub unsafe extern "C" fn main_kernelversion() -> uint32_t {
        ...
        && *r as ::core::ffi::c_int <= '9' as ::core::ffi::c_int
    {
        ...
        maj = maj.wrapping_add((*r as ::core::ffi::c_int - '0' as ::core::ffi::c_int) as uint32_t);
        r = r.offset(1);
    }
...
pub unsafe extern "C" fn password_read(
    ...
    let mut fd: *mut FILE = ::core::ptr::null_mut::<FILE>();
    let mut passwordbuff: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
    ...
    while i > 0 as ::core::ffi::c_int {
        ...
        if !(*passwordbuff.offset(i as isize) as ::core::ffi::c_int == '\n' as ::core::ffi::c_int
            || *passwordbuff.offset(i as isize) as ::core::ffi::c_int == '\r' as ::core::ffi::c_int)
        {
            break;
        }
        ...
        if stat(mp, &raw mut st) < 0 as ::core::ffi::c_int {
            ...
            if dd.is_null() {
                ...
                loop {
                    ...
                    if (*de).d_name[0 as usize] as ::core::ffi::c_int == '.' as ::core::ffi::c_int {
                        if (*de).d_name[1 as usize] as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                        {
                            continue;
                        }
            ...
            if colons > 0 as uint32_t {
                ...
                if hostlen > 0 as uint32_t {
                    ...
                    if *c as ::core::ffi::c_int == ':' as ::core::ffi::c_int {
                        ...
                        mfsopts.masterhost = malloc(hostlen.wrapping_add(1 as uint32_t) as size_t)
                        ...
                        *mfsopts.masterhost.offset(hostlen as isize) = 0 as ::core::ffi::c_char;
                        if !portbegin.is_null() && portlen > 0 as uint32_t {
                            ...
                            *mfsopts.masterport.offset(portlen as isize) = 0 as ::core::ffi::c_char;
                        }
