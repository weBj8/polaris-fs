...
extern "C" {
    ...
    fn conncache_insert(ip: uint32_t, port: uint16_t, fd: ::core::ffi::c_int);
    fn conncache_get(ip: uint32_t, port: uint16_t) -> ::core::ffi::c_int;
    fn csorder_sort(
        chain: *mut cspri,
        csdataver: uint8_t,
    ...
    fn csdb_writeinc(ip: uint32_t, port: uint16_t);
    fn csdb_writedec(ip: uint32_t, port: uint16_t);
    fn delay_run(
        r#fn: Option<unsafe extern "C" fn(*mut ::core::ffi::c_void) -> ()>,
        udata: *mut ::core::ffi::c_void,
        useconds: uint64_t,
    );
    fn fs_getsrcip() -> uint32_t;
    fn fs_writechunk(
        inode: uint32_t,
        indx: uint32_t,
    ...
    fn read_inode_clear_cache(inode: uint32_t, offset: uint64_t, leng: uint64_t);
    fn chunkrwlock_wlock(inode: uint32_t, indx: uint32_t);
    fn chunkrwlock_wunlock(inode: uint32_t, indx: uint32_t);
...
unsafe extern "C" fn write_increase_total_bytes(mut v: uint32_t) {
    ::core::intrinsics::atomic_xadd_seqcst(&raw mut total_bytes_sent, v as uint64_t);
}
#[no_mangle]
pub unsafe extern "C" fn write_get_total_bytes() -> uint64_t {
    let mut v: uint64_t = 0;
    v = ::core::intrinsics::atomic_and_seqcst(&raw mut total_bytes_sent, 0 as uint64_t);
    return v;
}
#[no_mangle]
...
pub unsafe extern "C" fn write_find_inodedata(mut inode: uint32_t) -> *mut inodedata {
    ...
    while !ind.is_null() {
        if (*ind).inode == inode {
            ...
            let mut _mfs_assert_ret_0: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut hashlock);
            if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                if _mfs_assert_ret_0 < 0 as ::core::ffi::c_int
                    && *__errno_location() != 0 as ::core::ffi::c_int
                {
    ...
    if _mfs_assert_ret_4 != 0 as ::core::ffi::c_int {
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"pthread_mutex_init(&(ind->lock),NULL)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_4,
                *__errno_location(),
                _mfs_errorstring_10,
            );
...
pub unsafe extern "C" fn write_free_inodedata(mut fid: *mut inodedata) {
    ...
    loop {
        ...
        if ind == fid {
            ...
            let mut _mfs_assert_ret_6: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut hashlock);
...
pub unsafe extern "C" fn write_delayed_enqueue(mut chd: *mut chunkdata, mut usecs: uint32_t) {
    if usecs > 0 as uint32_t {
        delay_run(
            Some(write_delayrun_enqueue as unsafe extern "C" fn(*mut ::core::ffi::c_void) -> ()),
...
unsafe extern "C" fn write_data_spawn_worker() {
    ...
    if workers_total.wrapping_rem(10 as uint32_t) == 0 as uint32_t && workers_total != lastnotify {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_INFO,
            b"write workers: %u+\n\0".as_ptr() as *const ::core::ffi::c_char,
...
pub unsafe extern "C" fn write_worker(
    ...
    loop {
        ...
        let mut _mfs_assert_ret_2: ::core::ffi::c_int = pthread_mutex_lock(&raw mut workerslock);
        if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
            if _mfs_assert_ret_2 < 0 as ::core::ffi::c_int
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
        ...
        let mut _mfs_assert_ret_4: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut workerslock);
        if _mfs_assert_ret_4 != 0 as ::core::ffi::c_int {
            if _mfs_assert_ret_4 < 0 as ::core::ffi::c_int
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
        ...
        let mut _mfs_assert_ret_5: ::core::ffi::c_int = pthread_mutex_lock(&raw mut (*ind).lock);
        if _mfs_assert_ret_5 != 0 as ::core::ffi::c_int {
            if _mfs_assert_ret_5 < 0 as ::core::ffi::c_int
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
        ...
        let mut _mfs_assert_ret_6: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut (*ind).lock);
        if _mfs_assert_ret_6 != 0 as ::core::ffi::c_int {
            if _mfs_assert_ret_6 < 0 as ::core::ffi::c_int
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
        ...
        if status != 0 {
            ...
            if wrstatus as ::core::ffi::c_int != MFS_STATUS_OK {
                    ...
                    && wrstatus as ::core::ffi::c_int != MFS_ERROR_EAGAIN
                {
                        ...
                        || wrstatus as ::core::ffi::c_int == MFS_ERROR_NOCHUNK
                    {
                        mfs_log(
                            MFSLOG_SYSLOG,
                            MFSLOG_WARNING,
                            b"file: %u, index: %u - fs_writechunk returned status: %s\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            inode,
                            chindx,
                            mfsstrerr(wrstatus),
                    ...
                    || chainelements as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                {
                    ...
                    (*chd).trycnt =
                        ((*chd).trycnt as ::core::ffi::c_int + 6 as ::core::ffi::c_int) as uint16_t;
                    ...
                    if fd < 0 as ::core::ffi::c_int {
                        ...
                        connmaxtry = ((*chd).trycnt as ::core::ffi::c_int * 2 as ::core::ffi::c_int
                            + 2 as ::core::ffi::c_int)
                            as uint32_t;
                    ...
                    if fd < 0 as ::core::ffi::c_int {
                        ...
                        if chunkready as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                            ...
                            if (*chd).chunkready as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                        ...
                        loop {
                            ...
                            if _mfs_assert_ret_19 != 0 as ::core::ffi::c_int {
                                    ...
                                    && *__errno_location() == 0 as ::core::ffi::c_int
                                {
                                    ...
                                    let mut _mfs_errorstring_err_19: *const ::core::ffi::c_char =
                                        strerr(*__errno_location());
                                    let mut _mfs_errorstring_ret_19: *const ::core::ffi::c_char =
                                        strerr(_mfs_assert_ret_19);
                                    mfs_log(
                                        MFSLOG_SYSLOG,
                                        MFSLOG_ERR,
                            ...
                            if optimeout > 0.0f64 && now - opbegin > optimeout {
                                ...
                                if lastrcvd == 0.0f64 {
                                    ...
                                    if lrdiff >= CHUNKSERVER_ACTIVITY_TIMEOUT {
                                        ...
                                        if _mfs_assert_ret_21 != 0 as ::core::ffi::c_int {
                                            ...
                                            } else if _mfs_assert_ret_21 > 0 as ::core::ffi::c_int
                                                && *__errno_location() == 0 as ::core::ffi::c_int
                                            {
                                        ...
                                        < 64 as ::core::ffi::c_int
                                {
                                    ...
                                    if sending_mode as ::core::ffi::c_int == 2 as ::core::ffi::c_int
                                    {
                                        ...
                                        chunk_offset_to = chunk_offset_to.wrapping_add((*cb).to);
                                        offset_from =
                                            offset_from.wrapping_add(chunk_offset_from as uint64_t);
                                        offset_to =
                                ...
                                if waitforstatus as ::core::ffi::c_int > 0 as ::core::ffi::c_int {
                                            ...
                                            })
                                    {
                                        ...
                                        if _mfs_assert_ret_22 != 0 as ::core::ffi::c_int {
                                            ...
                                            } else if _mfs_assert_ret_22 > 0 as ::core::ffi::c_int
                                                && *__errno_location() == 0 as ::core::ffi::c_int
                                            {
                                ...
                                if _mfs_assert_ret_24 != 0 as ::core::ffi::c_int {
                                    if _mfs_assert_ret_24 < 0 as ::core::ffi::c_int
                                        && *__errno_location() != 0 as ::core::ffi::c_int
                                    {
                                        let mut _mfs_errorstring_49: *const ::core::ffi::c_char =
                                            strerr(*__errno_location());
                                        mfs_log(
                                            MFSLOG_SYSLOG,
                                            MFSLOG_ERR,
                                        ...
                                        && *__errno_location() == 0 as ::core::ffi::c_int
                                    {
                                        let mut _mfs_errorstring_50: *const ::core::ffi::c_char =
                                            strerr(_mfs_assert_ret_24);
                                        mfs_log(
                                            MFSLOG_SYSLOG,
                                            MFSLOG_ERR,
                                            b"%s:%u - unexpected status, '%s' returned: %d : %s\0"
                                        ...
                                        if sent < hdrtosend {
                                            if cschainsize > 0 as uint32_t {
                                                ...
                                                siov[1 as usize].iov_base = &raw mut cschain
                                                    as *mut uint8_t
                                                    as *mut ::core::ffi::c_void;
                                                siov[1 as usize].iov_len = cschainsize as size_t;
                                                i = writev(
                                                    fd,
                                            ...
                                            i = write(
                                                fd,
                                                (&raw mut cschain as *mut uint8_t)
                                                    .offset(sent.wrapping_sub(hdrtosend) as isize)
                                                    as *const ::core::ffi::c_void,
                                                cschainsize
                                ...
                                if _mfs_assert_ret_25 != 0 as ::core::ffi::c_int {
                                    if _mfs_assert_ret_25 < 0 as ::core::ffi::c_int
                                        && *__errno_location() != 0 as ::core::ffi::c_int
                                    {
                                        let mut _mfs_errorstring_51: *const ::core::ffi::c_char =
                                            strerr(*__errno_location());
                                        mfs_log(
                                            MFSLOG_SYSLOG,
                                            MFSLOG_ERR,
                                        ...
                                        && *__errno_location() == 0 as ::core::ffi::c_int
                                    {
                                        let mut _mfs_errorstring_52: *const ::core::ffi::c_char =
                                            strerr(_mfs_assert_ret_25);
                                        mfs_log(
                                            MFSLOG_SYSLOG,
                                            MFSLOG_ERR,
                                            b"%s:%u - unexpected status, '%s' returned: %d : %s\0"
                                ...
                                if _mfs_assert_ret_26 != 0 as ::core::ffi::c_int {
                                    if _mfs_assert_ret_26 < 0 as ::core::ffi::c_int
                                        && *__errno_location() != 0 as ::core::ffi::c_int
                                    {
                                        let mut _mfs_errorstring_53: *const ::core::ffi::c_char =
                                            strerr(*__errno_location());
                                        mfs_log(
                                            MFSLOG_SYSLOG,
                                            MFSLOG_ERR,
                                        ...
                                        && *__errno_location() == 0 as ::core::ffi::c_int
                                    {
                                        let mut _mfs_errorstring_54: *const ::core::ffi::c_char =
                                            strerr(_mfs_assert_ret_26);
                                        mfs_log(
                                            MFSLOG_SYSLOG,
                                            MFSLOG_ERR,
                                            b"%s:%u - unexpected status, '%s' returned: %d : %s\0"
                                ...
                                if pfd[0 as usize].revents as ::core::ffi::c_int & POLLHUP != 0 {
                                    ...
                                    status = EIO;
                                    break;
                                } else if pfd[0 as usize].revents as ::core::ffi::c_int & POLLERR
                                    != 0
                                {
                                    if (*chd).trycnt as uint32_t >= minlogretry {
                                        univmakestrip(
                                    ...
                                    i = read(
                                        fd,
                                        (&raw mut recvbuff as *mut uint8_t).offset(rcvd as isize)
                                            as *mut ::core::ffi::c_void,
                                    ...
                                    if i == 0 as ::core::ffi::c_int {
                                            ...
                                            || recleng != 13 as uint32_t
                                        {
                                            ...
                                            if recwriteid > 0 as uint32_t {
                                                ...
                                                while !rcb.is_null() && (*rcb).writeid != recwriteid
                                                {
                                                ...
                                                if rcb.is_null() {
                                                    ...
                                                    let mut _mfs_assert_ret_28: ::core::ffi::c_int =
                                                        pthread_mutex_unlock(&raw mut (*ind).lock);
                                                    if _mfs_assert_ret_28 != 0 as ::core::ffi::c_int
                                                    {
                                                    ...
                                                    let mut _mfs_assert_ret_30: ::core::ffi::c_int =
                                                        pthread_mutex_unlock(&raw mut (*ind).lock);
                                                    if _mfs_assert_ret_30 != 0 as ::core::ffi::c_int
                                                    {
                        ...
                        if optimeout > 0.0f64 && monotonic_seconds() - opbegin > optimeout {
                            ...
                            mfs_log(
                                MFSLOG_SYSLOG,
                                MFSLOG_WARNING,
                                b"file: %u, index: %u - fs_writeend returned status: %s\0".as_ptr()
                                    as *const ::core::ffi::c_char,
                                inode,
                                chindx,
                                mfsstrerr(westatus),
...
pub unsafe extern "C" fn write_data_init(
    ...
    if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"pthread_mutex_init(&workerslock,NULL)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_0,
                *__errno_location(),
                _mfs_errorstring_1,
            );
    ...
    cacheblocks = malloc(::core::mem::size_of::<cblock>().wrapping_mul(cacheblockcount as size_t))
        as *mut cblock;
...
pub unsafe extern "C" fn write_data_term() {
    ...
    let mut _mfs_assert_ret_9: ::core::ffi::c_int = pthread_attr_destroy(&raw mut worker_thattr);
    if _mfs_assert_ret_9 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_9 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"pthread_attr_destroy(&worker_thattr)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_9,
                *__errno_location(),
                _mfs_errorstring_19,
            );
    ...
    if _mfs_assert_ret_10 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_10 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_21: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
                ...
                b"pthread_cond_destroy(&worker_term_cond)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_10,
                *__errno_location(),
                _mfs_errorstring_21,
            );
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_22: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_10);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s\0".as_ptr()
    ...
    if _mfs_assert_ret_11 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_11 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_23: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_24: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_11);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s\0".as_ptr()
    ...
    if _mfs_assert_ret_12 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_12 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_25: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_26: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_12);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s\0".as_ptr()
    ...
    let mut _mfs_assert_ret_13: ::core::ffi::c_int = pthread_mutex_destroy(&raw mut workerslock);
    if _mfs_assert_ret_13 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_13 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_27: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_28: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_13);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s\0".as_ptr()
    ...
    if _mfs_assert_ret_14 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_14 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_29: *const ::core::ffi::c_char = strerr(*__errno_location());
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d (errno=%d: %s)\0".as_ptr()
            ...
            && *__errno_location() == 0 as ::core::ffi::c_int
        {
            let mut _mfs_errorstring_30: *const ::core::ffi::c_char = strerr(_mfs_assert_ret_14);
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_ERR,
                b"%s:%u - unexpected status, '%s' returned: %d : %s\0".as_ptr()
...
pub unsafe extern "C" fn write_block(
    ...
    (*ncb).to = to;
    memcpy(
        (&raw mut (*ncb).data as *mut uint8_t).offset(from as isize) as *mut ::core::ffi::c_void,
        data as *const ::core::ffi::c_void,
        to.wrapping_sub(from) as size_t,
    );
    if chd.is_null() {
