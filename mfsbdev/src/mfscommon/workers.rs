...
extern "C" {
    ...
    fn squeue_close(que: *mut ::core::ffi::c_void);
...
unsafe extern "C" fn workers_spawn_worker(mut ws: *mut workers) {
    ...
    if (*ws).total.wrapping_rem(10 as uint32_t) == 0 as uint32_t && (*ws).total != (*ws).lastnotify
    {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_INFO,
...
unsafe extern "C" fn workers_close_worker(mut w: *mut worker) {
    ...
    if (*ws).total == 0 as uint32_t {
        let mut _mfs_assert_ret: ::core::ffi::c_int = pthread_cond_signal(&raw mut (*ws).term_cond);
    ...
    if _mfs_assert_ret != 0 as ::core::ffi::c_int {
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"pthread_mutex_init(&(ws->lock),NULL)\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret,
                *__errno_location(),
                _mfs_errorstring_0,
            );
...
pub unsafe extern "C" fn workers_term(mut wsv: *mut ::core::ffi::c_void) {
    ...
    let mut _mfs_assert_ret_3: ::core::ffi::c_int = pthread_cond_destroy(&raw mut (*ws).term_cond);
    if _mfs_assert_ret_3 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_3 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"pthread_cond_destroy(&(ws->term_cond))\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_3,
                *__errno_location(),
                _mfs_errorstring_7,
            );
