...
extern "C" {
    ...
    fn mfs_fstat(fildes: ::core::ffi::c_int, buf: *mut stat) -> ::core::ffi::c_int;
    fn mfs_open(
    ...
    fn mfs_fsync(fildes: ::core::ffi::c_int) -> ::core::ffi::c_int;
    fn mfs_close(fildes: ::core::ffi::c_int) -> ::core::ffi::c_int;
    fn mfs_flock(fildes: ::core::ffi::c_int, op: ::core::ffi::c_int) -> ::core::ffi::c_int;
    fn mfs_set_defaults(mcfg_0: *mut mfscfg);
    fn mfs_init(mcfg_0: *mut mfscfg, stage: uint8_t) -> ::core::ffi::c_int;
    fn mfs_term();
    ...
    fn squeue_new(length: uint32_t) -> *mut ::core::ffi::c_void;
    fn squeue_delete(que: *mut ::core::ffi::c_void);
    fn squeue_put(que: *mut ::core::ffi::c_void, element: *mut ::core::ffi::c_void);
    fn squeue_get(que: *mut ::core::ffi::c_void, element: *mut *mut ::core::ffi::c_void);
    fn workers_init(
        maxworkers: uint32_t,
    ...
    fn workers_term(w: *mut ::core::ffi::c_void);
    fn workers_newjob(w: *mut ::core::ffi::c_void, data: *mut ::core::ffi::c_void);
    ...
    fn unixtoaccept(sock: ::core::ffi::c_int, msecto: uint32_t) -> ::core::ffi::c_int;
    ...
    loop {
        ...
        if cmd == NBD_CMD_DISC as ::core::ffi::c_int as uint32_t {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_INFO,
                b"receive thread for %s ending (cmd:DISC)\0".as_ptr() as *const ::core::ffi::c_char,
                (*nbdcp).nbddevice,
            );
            return NULL;
        }
    ...
    loop {
        ...
        if data.is_null() {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_WARNING,
                b"send thread for %s ending (data==NULL)\0".as_ptr() as *const ::core::ffi::c_char,
                (*nbdcp).nbddevice,
            );
            return NULL;
        }
        ...
        if (*r).cmd as ::core::ffi::c_int == NBD_CMD_DISC as ::core::ffi::c_int {
            mfs_log(
                MFSLOG_SYSLOG,
                MFSLOG_INFO,
                b"send thread for %s ending (cmd:DISC)\0".as_ptr() as *const ::core::ffi::c_char,
                (*nbdcp).nbddevice,
            );
            return NULL;
        }
...
pub unsafe extern "C" fn nbd_open_device(
    ...
    if err < 0 as ::core::ffi::c_int {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_ERR,
            b"can't obtain size of block device (%s): %s\0".as_ptr() as *const ::core::ffi::c_char,
            (*nbdcp).nbddevice,
            strerror(*__errno_location()),
        );
        if !errmsg.is_null() {
    ...
    if err < 0 as ::core::ffi::c_int {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_ERR,
            b"can't connect socket pair to nbd (%s): %s\0".as_ptr() as *const ::core::ffi::c_char,
            (*nbdcp).nbddevice,
            strerror(*__errno_location()),
        );
        if !errmsg.is_null() {
...
pub unsafe extern "C" fn make_daemon() {
    ...
    if chdir(b"/\0".as_ptr() as *const ::core::ffi::c_char) < 0 as ::core::ffi::c_int {
        mfs_log(
            MFSLOG_SYSLOG_STDERR,
            MFSLOG_WARNING,
            b"can't change working directory to '/': %s\0".as_ptr() as *const ::core::ffi::c_char,
            strerror(*__errno_location()),
        );
    }
    setsid();
...
pub unsafe extern "C" fn nbd_stop(mut nbdcp: *mut nbdcommon) {
    ...
    if err < 0 as ::core::ffi::c_int {
        mfs_log(
            MFSLOG_SYSLOG,
            MFSLOG_WARNING,
            b"can't remove nbd device symlink %s->%s: %s\0".as_ptr() as *const ::core::ffi::c_char,
            (*nbdcp).linkname,
            (*nbdcp).nbddevice,
            strerror(*__errno_location()),
        );
...
pub unsafe extern "C" fn nbd_handle_list_devices(
    ...
    while !bdl.is_null() {
        ...
        memcpy(
            ...
            (*(*bdl).nbdcp)
                .linkname
                .offset(NBD_LINK_PREFIX_LENG as isize) as *const ::core::ffi::c_void,
            nleng as size_t,
        );
                ...
                if mfs_fstat((*(*bdl).nbdcp).mfsfd, &raw mut stbuf) < 0 as ::core::ffi::c_int {
                    msglen = snprintf(
                        (&raw mut ans as *mut uint8_t).offset(10 as ::core::ffi::c_int as isize)
                            as *mut ::core::ffi::c_char,
                        NBD_ERR_SIZE as size_t,
                        b"can't stat MFS file '%s': %s\0".as_ptr() as *const ::core::ffi::c_char,
                        (*(*bdl).nbdcp).mfsfile,
                        strerror(*__errno_location()),
                    ) as uint32_t;
                } else {
            ...
            if size > 0 as uint64_t {
                ...
                ) < 0 as ::core::ffi::c_int
                {
                    ...
                    msglen = snprintf(
                        ...
                        (*(*bdl).nbdcp).fsize as ::core::ffi::c_double
                            / (1024.0f64 * 1024.0f64 * 1024.0f64),
                        size as ::core::ffi::c_double / (1024.0f64 * 1024.0f64 * 1024.0f64),
                    ) as uint32_t;
                    (*(*bdl).nbdcp).fsize = size;
                }
            }
...
pub unsafe extern "C" fn nbd_start_daemon(
    ...
    let mut lsockname: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
    let mut initfname: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<::core::ffi::c_char>();
            ...
            ) != 8 as int32_t
            {
                ...
                ) != 8 as int32_t
                {
                    ...
                    ) != 1 as int32_t
                    {
                        ...
                        close(csock);
                        csock = -1 as ::core::ffi::c_int;
                        if buff[0 as usize] as ::core::ffi::c_int != MFSNBD_OK as ::core::ffi::c_int
                        {
                            fprintf(
                                stderr,
                            ...
                            printf(b"daemon received STOP command\n\0".as_ptr()
                                as *const ::core::ffi::c_char);
                            printf(
                                b"waiting for daemon ...\0".as_ptr() as *const ::core::ffi::c_char
                            );
                            fflush(stdout);
        ...
        match ch {
            ...
            116 => {
                if *optarg.offset(0 as isize) as ::core::ffi::c_int == 'A' as ::core::ffi::c_int
                    || *optarg.offset(0 as isize) as ::core::ffi::c_int == 'a' as ::core::ffi::c_int
                    || *optarg.offset(0 as isize) as ::core::ffi::c_int == 'M' as ::core::ffi::c_int
                    || *optarg.offset(0 as isize) as ::core::ffi::c_int == 'm' as ::core::ffi::c_int
                {
                    displaymode = 1 as uint8_t;
                } else if *optarg.offset(0 as isize) as ::core::ffi::c_int
                    == 'R' as ::core::ffi::c_int
                    || *optarg.offset(0 as isize) as ::core::ffi::c_int == 'r' as ::core::ffi::c_int
                    || *optarg.offset(0 as isize) as ::core::ffi::c_int == 'D' as ::core::ffi::c_int
                    || *optarg.offset(0 as isize) as ::core::ffi::c_int == 'd' as ::core::ffi::c_int
                    || *optarg.offset(0 as isize) as ::core::ffi::c_int == 'U' as ::core::ffi::c_int
                    || *optarg.offset(0 as isize) as ::core::ffi::c_int == 'u' as ::core::ffi::c_int
                {
                    displaymode = 2 as uint8_t;
                } else if *optarg.offset(0 as isize) as ::core::ffi::c_int
                    == 'C' as ::core::ffi::c_int
                    || *optarg.offset(0 as isize) as ::core::ffi::c_int == 'c' as ::core::ffi::c_int
                    || *optarg.offset(0 as isize) as ::core::ffi::c_int == 'I' as ::core::ffi::c_int
                    || *optarg.offset(0 as isize) as ::core::ffi::c_int == 'i' as ::core::ffi::c_int
                {
                ...
                if cmd != MFSNBD_LIST as ::core::ffi::c_int as uint32_t {
                        ...
                        != leng as ssize_t
                    {
                        ...
                        if displaymode as ::core::ffi::c_int == 3 as ::core::ffi::c_int {
                            ...
                            maxsize =
                                strlen(&raw mut formatbuff as *mut ::core::ffi::c_char) as uint64_t;
                            snprintf(
                                &raw mut formatbuff as *mut ::core::ffi::c_char,
                                100 as size_t,
                            ...
                            formatbuff[99 as usize] = 0 as ::core::ffi::c_char;
                            maxbsize =
                                strlen(&raw mut formatbuff as *mut ::core::ffi::c_char) as uint32_t;
                            snprintf(
                                &raw mut formatbuff as *mut ::core::ffi::c_char,
                                100 as size_t,
                                b"%%%ulu %%%uu %%s,%%s\n\0".as_ptr() as *const ::core::ffi::c_char,
                        ...
                        while dcnt as ::core::ffi::c_int > 0 as ::core::ffi::c_int {
                            ...
                            if displaymode as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
                                if displaymode as ::core::ffi::c_int == 3 as ::core::ffi::c_int {
                                    printf(b"%s\0".as_ptr() as *const ::core::ffi::c_char, path);
                                    ...
                                    printf(b"%s\0".as_ptr() as *const ::core::ffi::c_char, device);
                                    ...
                                    if displaymode as ::core::ffi::c_int == 1 as ::core::ffi::c_int
                                    {
                                        printf(
                                        ...
                                        printf(
                                            b"%s unmap\0".as_ptr() as *const ::core::ffi::c_char,
                                            appname,
                                        );
                                    }
                                    if lsockcustom != 0 {
                                        printf(
                                            b" -l '%s'\0".as_ptr() as *const ::core::ffi::c_char,
                                            lsockname,
                                        );
                                    }
                                    if !path.is_null() {
                                    ...
                                    if !linkname.is_null() {
                                        printf(
                                            b" -n '%s'\0".as_ptr() as *const ::core::ffi::c_char,
                                            linkname,
                                        );
                                    }
                                    if displaymode as ::core::ffi::c_int == 1 as ::core::ffi::c_int
                                    {
                                        ...
                                        if flags & FLAG_READONLY as uint32_t != 0 {
                                            printf(b" -r\0".as_ptr() as *const ::core::ffi::c_char);
                                        }
                                        if flags & FLAG_IGNORELOCK as uint32_t != 0 {
                                            printf(b" -i\0".as_ptr() as *const ::core::ffi::c_char);
                                        }
                                    }
                                    printf(b"\n\0".as_ptr() as *const ::core::ffi::c_char);
                                }
