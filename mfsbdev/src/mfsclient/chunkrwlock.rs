...
pub unsafe extern "C" fn chunkrwlock_term() {
    ...
    while !freeblocks.is_null() {
        cr = freeblocks;
        let mut _mfs_assert_ret: ::core::ffi::c_int = pthread_cond_destroy(&raw mut (*cr).rcond);
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"pthread_cond_destroy(&(cr->rcond))\0".as_ptr() as *const ::core::ffi::c_char,
                    _mfs_assert_ret,
                    *__errno_location(),
                    _mfs_errorstring,
                );
        ...
        let mut _mfs_assert_ret_0: ::core::ffi::c_int = pthread_cond_destroy(&raw mut (*cr).wcond);
        if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"pthread_cond_destroy(&(cr->wcond))\0".as_ptr() as *const ::core::ffi::c_char,
                    _mfs_assert_ret_0,
                    *__errno_location(),
                    _mfs_errorstring_1,
                );
        ...
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"pthread_cond_signal(&(cr->wcond))\0".as_ptr() as *const ::core::ffi::c_char,
                    _mfs_assert_ret,
                    *__errno_location(),
                    _mfs_errorstring,
                );
