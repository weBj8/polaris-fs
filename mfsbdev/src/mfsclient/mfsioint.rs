...
extern "C" {
    ...
    fn fs_atime(inode: uint32_t);
    fn fs_mtime(inode: uint32_t);
    fn fs_fix_amtime(inode: uint32_t, atime: *mut uint32_t, mtime: *mut uint32_t);
    fn fs_inc_acnt(inode: uint32_t);
    fn fs_dec_acnt(inode: uint32_t);
    fn fs_read_notify(bytes: uint64_t);
    fn fs_write_notify(bytes: uint64_t);
    fn fs_fsync_notify();
    fn fs_get_cfg(
    ...
    fn fs_readlink(inode: uint32_t, path: *mut *const uint8_t) -> uint8_t;
    fn fs_symlink(
        parent: uint32_t,
        nleng: uint8_t,
        name: *const uint8_t,
    ...
    fn fs_flock(inode: uint32_t, reqid: uint32_t, owner: uint64_t, cmd: uint8_t) -> uint8_t;
    fn fs_posixlock(
        inode: uint32_t,
        reqid: uint32_t,
        owner: uint64_t,
    ...
    fn fs_term();
    fn inoleng_acquire(inode: uint32_t) -> *mut ::core::ffi::c_void;
    fn inoleng_release(ptr: *mut ::core::ffi::c_void);
    fn inoleng_getfleng(ptr: *mut ::core::ffi::c_void) -> uint64_t;
    fn inoleng_setfleng(ptr: *mut ::core::ffi::c_void, fleng: uint64_t);
    fn inoleng_update_fleng(inode: uint32_t, fleng: uint64_t);
    fn inoleng_term();
    fn inoleng_init();
    ...
    fn read_data_free_buff(
        vid: *mut ::core::ffi::c_void,
        vrhead: *mut ::core::ffi::c_void,
        iov: *mut iovec,
    );
    fn read_inode_clear_cache(inode: uint32_t, offset: uint64_t, leng: uint64_t);
    fn read_inode_set_length_active(inode: uint32_t, newlength: uint64_t);
    fn read_inode_set_length_passive(inode: uint32_t, newlength: uint64_t);
    fn read_data_new(inode: uint32_t, fleng: uint64_t) -> *mut ::core::ffi::c_void;
    fn read_data_end(vid: *mut ::core::ffi::c_void);
    fn read_init();
    fn read_term();
    fn write_data_init(
        cachesize: uint32_t,
    ...
    fn write_data_term();
    fn write_data_new(inode: uint32_t, fleng: uint64_t) -> *mut ::core::ffi::c_void;
    fn write_data_end(vid: *mut ::core::ffi::c_void) -> ::core::ffi::c_int;
    fn write_data_flush(vid: *mut ::core::ffi::c_void) -> ::core::ffi::c_int;
    fn write_data_inode_setmaxfleng(inode: uint32_t, maxfleng: uint64_t);
    fn write_data_inode_getmaxfleng(inode: uint32_t) -> uint64_t;
    fn write_data_flush_inode(inode: uint32_t) -> ::core::ffi::c_int;
    fn write_data(
        vid: *mut ::core::ffi::c_void,
        offset: uint64_t,
        size: uint32_t,
    ...
    fn lcache_path_invalidate(base_inode: uint32_t, pleng: uint32_t, path: *const uint8_t);
    fn lcache_inode_invalidate(inode: uint32_t);
    fn lcache_term();
    fn lcache_init(lc_retention: ::core::ffi::c_double) -> ::core::ffi::c_int;
}
...
unsafe extern "C" fn mfs_attr_to_mfsstat(
    ...
    (*stbuf).mode = ((*stbuf).mode as ::core::ffi::c_int & 0xfff as ::core::ffi::c_int) as uint16_t;
...
unsafe extern "C" fn mfs_fi_term(mut fileinfo: *mut file_info) {
    ...
    if _mfs_assert_ret != 0 as ::core::ffi::c_int {
            ...
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"pthread_mutex_lock(&(fileinfo->lock))\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret,
                *__errno_location(),
                _mfs_errorstring,
            );
    ...
    let mut _mfs_assert_ret_0: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut (*fileinfo).lock);
    if _mfs_assert_ret_0 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_0 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
            ...
            mfs_log(
                ...
                b"pthread_mutex_unlock(&(fileinfo->lock))\0".as_ptr() as *const ::core::ffi::c_char,
                _mfs_assert_ret_0,
                *__errno_location(),
                _mfs_errorstring_1,
            );
...
unsafe extern "C" fn mfs_resize_fd() {
    ...
    if fdtabsize & 0x1f as uint32_t != 0 as uint32_t {
        *fdtabusemask.offset(i.wrapping_sub(1 as uint32_t) as isize) =
            (*fdtabusemask.offset(i.wrapping_sub(1 as uint32_t) as isize) as ::core::ffi::c_uint
...
pub unsafe extern "C" fn mfs_int_fsetwinattr(
    ...
    let mut _mfs_assert_ret_1: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut (*fileinfo).lock);
    if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_1 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
...
pub unsafe extern "C" fn mfs_int_truncate(
    ...
    return mfs_int_truncate_common(cr, inode, 0 as uint8_t, size, &raw mut attr as *mut uint8_t);
}
#[no_mangle]
...
pub unsafe extern "C" fn mfs_int_lseek(
    ...
    *offset = (*fileinfo).offset as int64_t;
    let mut _mfs_assert_ret_2: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut (*fileinfo).lock);
    if _mfs_assert_ret_2 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_2 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
...
unsafe extern "C" fn mfs_int_pread_common(
    ...
    let mut _mfs_assert_ret_3: ::core::ffi::c_int = pthread_mutex_lock(&raw mut (*fileinfo).lock);
    ...
    let mut _mfs_assert_ret_5: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut (*fileinfo).lock);
...
pub unsafe extern "C" fn mfs_int_read(
    ...
    *rsize += rsize_part as int64_t;
    ...
    (*fileinfo).offset = offset;
    let mut _mfs_assert_ret_4: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut (*fileinfo).lock);
    if _mfs_assert_ret_4 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_4 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
...
unsafe extern "C" fn mfs_int_pwrite_common(
    ...
    if appendonly != 0 {
                ...
                })) as uint32_t
        {
            ...
            status = do_truncate(
                inode,
                (TRUNCATE_FLAG_OPENED | TRUNCATE_FLAG_UPDATE | TRUNCATE_FLAG_RESERVE) as uint8_t,
                0 as uint32_t,
                1 as uint32_t,
                &raw mut gid,
                nbyte as uint64_t,
    ...
    let mut _mfs_assert_ret_8: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut (*fileinfo).lock);
...
pub unsafe extern "C" fn mfs_int_write(
    ...
    *rsize = 0 as int64_t;
    ...
    offset = offset.wrapping_add(rsize_part as uint64_t);
    *rsize += rsize_part as int64_t;
    let mut _mfs_assert_ret_1: ::core::ffi::c_int = pthread_mutex_lock(&raw mut (*fileinfo).lock);
    if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_1 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
...
pub unsafe extern "C" fn mfs_int_close(mut fildes: ::core::ffi::c_int) -> uint8_t {
    ...
    while (*fileinfo).writing as uint32_t | (*fileinfo).writers_cnt | (*fileinfo).readers_cnt != 0 {
        let mut _mfs_assert_ret_1: ::core::ffi::c_int =
            pthread_cond_wait(&raw mut (*fileinfo).rwcond, &raw mut (*fileinfo).lock);
        if _mfs_assert_ret_1 != 0 as ::core::ffi::c_int {
            if _mfs_assert_ret_1 < 0 as ::core::ffi::c_int
...
pub unsafe extern "C" fn mfs_int_fcntl_locks(
    ...
    if (*fl).whence as ::core::ffi::c_int == MFS_SEEK_CUR {
        ...
        if (*fl).start > inoleng_getfleng((*fileinfo).flengptr) as int64_t {
            ...
            start = inoleng_getfleng((*fileinfo).flengptr).wrapping_add((*fl).start as uint64_t);
        }
    } else {
        return MFS_ERROR_EINVAL as uint8_t;
    }
...
pub unsafe extern "C" fn mfs_int_readdir(
    ...
    let mut _mfs_assert_ret_6: ::core::ffi::c_int = pthread_mutex_unlock(&raw mut (*fileinfo).lock);
    if _mfs_assert_ret_6 != 0 as ::core::ffi::c_int {
        if _mfs_assert_ret_6 < 0 as ::core::ffi::c_int
            && *__errno_location() != 0 as ::core::ffi::c_int
        {
...
pub unsafe extern "C" fn mfs_int_init(
        ...
        || stage as ::core::ffi::c_int == 1 as ::core::ffi::c_int
    {
        ...
        if fs_init_master_connection(
            ...
            1 as uint8_t,
            0 as uint8_t,
            ((*mcfg).master_min_version_maj as ::core::ffi::c_int * 0x10000 as ::core::ffi::c_int
                + (*mcfg).master_min_version_mid as ::core::ffi::c_int
                    * 0x100 as ::core::ffi::c_int
                + (if (*mcfg).master_min_version_maj as ::core::ffi::c_int > 1 as ::core::ffi::c_int
                {
                    0 as ::core::ffi::c_int * 2 as ::core::ffi::c_int
                } else {
                    0 as ::core::ffi::c_int
        ...
        || stage as ::core::ffi::c_int == 2 as ::core::ffi::c_int
    {
        ...
        if _mfs_assert_ret != 0 as ::core::ffi::c_int {
                ...
                && *__errno_location() != 0 as ::core::ffi::c_int
            {
                ...
                mfs_log(
                    ...
                    b"pthread_mutex_init(&fdtablock,NULL)\0".as_ptr() as *const ::core::ffi::c_char,
                    _mfs_assert_ret,
                    *__errno_location(),
                    _mfs_errorstring,
                );
        ...
        fdtab = malloc(::core::mem::size_of::<file_info>().wrapping_mul(FDTABSIZE_INIT as size_t))
            as *mut file_info;
